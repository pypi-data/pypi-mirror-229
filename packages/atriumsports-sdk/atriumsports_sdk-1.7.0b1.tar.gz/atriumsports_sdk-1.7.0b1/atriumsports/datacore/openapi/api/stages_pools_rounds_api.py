...
class StagesPoolsRoundsApi(object):
    ...
    def season_pool_list(
        ...
        **kwargs
        ...
        >>> thread = api.season_pool_list(organization_id, season_id, sport, added, external, fields, hide_null, include, limit, offset, stage_code, updated, async_req=True)
        >>> result = thread.get()
    ...
    def season_stage_list(
        ...
        **kwargs
        ...
        >>> thread = api.season_stage_list(organization_id, season_id, sport, added, external, fields, hide_null, include, limit, offset, updated, async_req=True)
        >>> result = thread.get()
