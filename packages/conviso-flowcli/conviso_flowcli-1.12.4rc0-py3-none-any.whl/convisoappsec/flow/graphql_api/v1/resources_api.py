...
class AssetsAPI(object):
    ...
    def get_by_company_id(self, company_id, page=1, limit=32):
        graphql_variables = {
            "id": company_id,
            "page": page,
            "limit": limit
...
class ProjectsApi(object):
    ...
    def get_by_code_or_label(self, project_code, project_label, page=1, limit=32):
        graphql_variables = {
...
class CompaniesApi(object):
    ...
    def get_companies(self, page=1, limit=1):
        graphql_variables = {
            "page": page,
            "limit": limit
        }
