...
def tensorflow_data(train_dataset=None, val_dataset=None, test_dataset=None, dataset_name="", label_index=1,
  ...
  if newest_data_folder == None:
      ...
      if (train_dataset != None) and (len(train_dataset) > 0) and (os.path.exists(newest_data_folder + '/train_dataset.pkl')): #Both exist
          ...
          with open(newest_data_folder + '/train_dataset.pkl', 'rb') as f:
              print("d")
      ...
      if ((os.path.exists(newest_data_folder + '/val_dataset.pkl')) and (save_new_data_flag == 0) and (val_dataset != None) and (len(val_dataset) > 0)):
          print("f")
          with open(newest_data_folder + '/val_dataset.pkl', 'rb') as f:
      ...
      if (os.path.exists(newest_data_folder + '/test_dataset.pkl')) and (save_new_data_flag == 0) and (test_dataset != None) and (len(test_dataset) > 0):
          print("i")
          with open(newest_data_folder + '/test_dataset.pkl', 'rb') as f:
