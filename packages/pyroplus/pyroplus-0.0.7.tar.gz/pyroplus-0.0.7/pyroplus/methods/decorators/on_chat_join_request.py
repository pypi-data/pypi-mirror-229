...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~pyroplus.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroplus.Client):
                self.add_handler(pyroplus.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroplus.handlers.ChatJoinRequestHandler(func, self),
