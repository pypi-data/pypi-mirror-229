...
class PlatformSession(Session):
    ...
    def __init__(
        ...
        if signon_control is None:
            ...
            warnings.warn(
                "Define explicitly signon_control argument, in a future version signon_control=False by default.",
    ...
    def __eq__(self, other: "Session"):
        if self.type != other.type:
            return False
        other: "PlatformSession"
        return (
            self._grant.get_username() == other._grant.get_username()
            and self._grant.get_password() == other._grant.get_password()
