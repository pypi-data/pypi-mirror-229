...
from ..models.guide_folder_mgr import eb_guide_create


def _usage(error: str):
    if error != "":
        print(error)
    print("eb_guide [-c|--cfg name][-h|-help]")
    print("Create EB Guide Configuration folder structure")
