...
class SqlHandler(DatabaseEngine):
    ...
    def upload_df(self, dataframe, table_name, if_exists='replace', index=False, dtype=None, conn_success_msg: bool = True, sql_success_msg: bool = True):
        """
        ...
        Notes:
            ...
            The automatic conversion is based on the dataframe's datatypes. Hence, if a date field is listed as an object data
            type in the dataframe the auto-conversion will set it as a VARCHAR.  To rectify this, please cast your dataframe columns to the desired data types 
            prior to using this function or override the auto-conversion using the dtype argument.  In the example given if the auto-conversion is overridden
            and a date (which is an object datatype in the df) is set to a sqlalchemy date then it will upload as a date.
        """
        try:
    ...
    def drop_table(self, table_name, conn_success_msg: bool = True, sql_success_msg: bool = True):
        ...
        Note:
            ...
            - The `dtype` parameter can be used to specify the data type of the table.
              It is not used in the function body and is provided for documentation purposes.
