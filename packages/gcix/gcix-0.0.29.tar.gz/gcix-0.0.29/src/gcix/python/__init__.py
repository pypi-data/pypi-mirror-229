...
@jsii.data_type(
    jsii_type="@gcix/gcix.python.EvaluateGitTagPep440ConformityProps",
    jsii_struct_bases=[],
    name_mapping={"job_name": "jobName", "job_stage": "jobStage"},
)
class EvaluateGitTagPep440ConformityProps:
    def __init__(
        self,
        *,
        job_name: typing.Optional[builtins.str] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__23b1a58231a4e79ebd3bd55d862a4a9e2102f88327c836c7ebd0447979cf4df1)
            check_type(argname="argument job_name", value=job_name, expected_type=type_hints["job_name"])
            check_type(argname="argument job_stage", value=job_stage, expected_type=type_hints["job_stage"])
        self._values: typing.Dict[builtins.str, typing.Any] = {}
        if job_name is not None:
    ...
    def __repr__(self) -> str:
        return "EvaluateGitTagPep440ConformityProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
@jsii.interface(jsii_type="@gcix/gcix.python.IEvaluateGitTagPep440Conformity")
class IEvaluateGitTagPep440Conformity(typing_extensions.Protocol):
    pass


class _IEvaluateGitTagPep440ConformityProxy:
    __jsii_type__: typing.ClassVar[str] = "@gcix/gcix.python.IEvaluateGitTagPep440Conformity"
    pass

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IEvaluateGitTagPep440Conformity).__jsii_proxy_class__ = lambda : _IEvaluateGitTagPep440ConformityProxy
...
@jsii.interface(jsii_type="@gcix/gcix.python.IPytest")
class IPytest(typing_extensions.Protocol):
    @builtins.property
    @jsii.member(jsii_name="pipenvVersionSpecifier")
...
class _IPytestProxy:
    __jsii_type__: typing.ClassVar[str] = "@gcix/gcix.python.IPytest"
    ...
    def pipenv_version_specifier(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__98be099366b6998e110cded321f70044d7bf9e9a31e60ee4e72a8aadf0f99e4e)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def pytest_command(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__03ff5872e32ec056641fe865f3e60d88a07cefba1bfbe5783140c65d3eede7d8)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "pytestCommand", value)

# Adding a "__jsii_proxy_class__(): typing.Type" function to the interface
typing.cast(typing.Any, IPytest).__jsii_proxy_class__ = lambda : _IPytestProxy
...
@jsii.implements(IPytest)
class Pytest(
    _Job_20682b42,
    metaclass=jsii.JSIIMeta,
    jsii_type="@gcix/gcix.python.Pytest",
):
    ...
    def pipenv_version_specifier(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__6d1caf33b0e71f1e0d77852af84e2426692e14c5fe11844a42d7b12ae6022c16)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "pipenvVersionSpecifier", value)
    ...
    def pytest_command(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__3510accd8096800ada16a0b1e918b8a3479fb389d41e0c8c96c41126ac790992)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "pytestCommand", value)


@jsii.data_type(
    jsii_type="@gcix/gcix.python.PytestProps",
    jsii_struct_bases=[],
    name_mapping={
        "job_name": "jobName",
        "job_stage": "jobStage",
...
class PytestProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__dc5323068b765ef80c5322681976f76f02046afbd5df39246061b31ae548e464)
            check_type(argname="argument job_name", value=job_name, expected_type=type_hints["job_name"])
            check_type(argname="argument job_stage", value=job_stage, expected_type=type_hints["job_stage"])
            check_type(argname="argument pipenv_version_specifier", value=pipenv_version_specifier, expected_type=type_hints["pipenv_version_specifier"])
...
@jsii.implements(IEvaluateGitTagPep440Conformity)
class EvaluateGitTagPep440Conformity(
    _Job_20682b42,
    metaclass=jsii.JSIIMeta,
    jsii_type="@gcix/gcix.python.EvaluateGitTagPep440Conformity",
):
    ...
    def __init__(
        ...
        *,
        ...
        :param job_stage: The stage of the Bootstrap job.
        '''
        props = EvaluateGitTagPep440ConformityProps(
...
__all__ = [
    ...
    "Flake8Props",
    "IBdistWheel",
    "IEvaluateGitTagPep440Conformity",
    "IFlake8",
    "IIsort",
    "IMyPy",
    "IPytest",
...
def _typecheckingstub__23b1a58231a4e79ebd3bd55d862a4a9e2102f88327c836c7ebd0447979cf4df1(
    *,
    job_name: typing.Optional[builtins.str] = None,
    job_stage: typing.Optional[builtins.str] = None,
) -> None:
...
def _typecheckingstub__98be099366b6998e110cded321f70044d7bf9e9a31e60ee4e72a8aadf0f99e4e(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__03ff5872e32ec056641fe865f3e60d88a07cefba1bfbe5783140c65d3eede7d8(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass
...
def _typecheckingstub__6d1caf33b0e71f1e0d77852af84e2426692e14c5fe11844a42d7b12ae6022c16(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__3510accd8096800ada16a0b1e918b8a3479fb389d41e0c8c96c41126ac790992(
    value: builtins.str,
) -> None:
    """Type checking stubs"""
    pass

def _typecheckingstub__dc5323068b765ef80c5322681976f76f02046afbd5df39246061b31ae548e464(
    *,
    job_name: typing.Optional[builtins.str] = None,
    job_stage: typing.Optional[builtins.str] = None,
    pipenv_version_specifier: typing.Optional[builtins.str] = None,
