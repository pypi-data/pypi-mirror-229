...
gopy build -no-make -dynamic-link=True -symbols=False -output /project/build/lib.linux-x86_64-cpython-38/dither_go/bindings -vm /tmp/build-env-k5_sno_w/bin/python ./dither_go github.com/tfuxu/dither-gopy
*/
