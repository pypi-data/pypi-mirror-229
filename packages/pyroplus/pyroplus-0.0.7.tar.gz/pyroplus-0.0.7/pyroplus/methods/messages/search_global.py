...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~pyroplus.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~pyroplus.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~pyroplus.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "pyroplus". Get the first 50 results
                async for message in app.search_global("pyroplus", limit=50):
                    print(message.text)
