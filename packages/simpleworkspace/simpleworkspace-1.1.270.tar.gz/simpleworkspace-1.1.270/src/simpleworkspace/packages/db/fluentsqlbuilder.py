...
class FluentSqlBuilder:
    ...
    def __init__(self, connection: 'MySQLConnection|MsSqlConnection|Sqlite3Connection'):
        ...
        self._IsStatement_Delete = False
        self._IsStatement_Insert = False
        self._IsStatement_Update = False
        self._HasClause_Where = False
    ...
    def OnDuplicateKeyUpdate(self):
        ...
        if not self._IsStatement_Insert:
    ...
    def OnDuplicateKeyIgnore(self):
        ...
        self._segments[0] = replacement + self._segments[0][6:]
        return self
    ...
    def Execute(self):
        ...
        if(self._IsStatement_Delete or self._IsStatement_Insert or self._IsStatement_Update):
    ...
    def _ValidateBuiltQuery(self):
        ...
        if self._IsStatement_Update or self._IsStatement_Delete:
