...
class Object:
    def __init__(self, client: "melvan.Client" = None):
        self._client = client

    def bind(self, client: "melvan.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~melvan.types.Client`):
