...
import pov
from pov import raw
from pov.connection import Connection
from pov.crypto import aes, rsa, prime
from pov.errors import SecurityCheckMismatch
from pov.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pov.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
