...
from ...types.user_result import UserResult
from ...types.users_paginated import UsersPaginated
...
class UsersClient:
    ...
    def ats_users_list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "unified/ats/users"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(UsersPaginated, _response.json())  # type: ignore
    ...
    def ats_users_get(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"unified/ats/users/{id}"),
            params=remove_none_from_dict(
                {
                    "page": page,
                    "page_size": page_size,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(UserResult, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
        if _response.status_code == 403:
            raise ForbiddenError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
