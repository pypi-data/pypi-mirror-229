...
1. Input genomes need to be provided as in genbank format (previously in fasta format), 
   you can use [Prokka](https://github.com/tseemann/prokka) or [Prodigal](https://github.com/hyattpd/Prodigal) to produce them.
   please not that the contig id still need to be shorter than 18? bp.

1. You need to provide a species tree for your input genome.
...
1. Now you can used `mmseqs linclust` to speed-up all-vs-all blastn. It's magnitudes faster than MetaCHIP1.
...
* v2.0.0 (2023-07-03) - Initial release
