...
class PackageBuild:
    ...
    def git_build(self, *args, multi=False, **kwargs):
        """
        git build
        """
        print(multi)
...
def pull():
    PackageBuild().git_pull()


def push():
    PackageBuild().git_push()


def build():
    PackageBuild().git_build()


def install():
    PackageBuild().git_install()


def clear():
    PackageBuild().git_clean()


def tags():
    PackageBuild().git_tags()


def clean_history():
    PackageBuild().git_clean_history()
