...
class MaProtocolCls:
	...
	def set(self, controler: str = None) -> None:
		"""SCPI: ROUTe:NIOT:MEASurement<Instance>:SCENario:MAPRotocol \n
		Snippet: driver.route.niotMeas.scenario.maProtocol.set(controler = '1') \n
		...
		self._core.io.write(f'ROUTe:NIOT:MEASurement<Instance>:SCENario:MAPRotocol {param}'.strip())
