...
class RequestUtils:
    ...
    def requestExecute(method,session,url,datas,headers,cookies):
        ...
        print("requestExecute,data:" + formData)
    ...
    def processFormData(datas,headers):
        ...
        contentTypeEnum = ContentTypeEnum.getEnum(headers.get("Content-Type","application/json"))
        if contentTypeEnum == ContentTypeEnum.ApplicationJson:
            return json.dumps(datas)

        # application/x-www-form-urlencoded
        elif contentTypeEnum == ContentTypeEnum.FormUrlencoded:
            return urllib.parse.urlencode(formValues)
