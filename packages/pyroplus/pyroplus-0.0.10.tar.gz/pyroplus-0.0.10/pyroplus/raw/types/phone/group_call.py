...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <pyroplus.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <pyroplus.raw.base.GroupCallParticipant>`):
            N/A
