...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <pyroplus.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <pyroplus.raw.base.Message>`):
            N/A
