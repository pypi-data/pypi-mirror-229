...
class piclock(generic.FhemModule):
    ...
    def __init__(self, logger):
        ...
        set_config = {
            ...
            "brightness": {"args": ["contrast"], "options": "slider,0,1,255,0"},
        }
    ...
    async def run_piclock(self):
        ...
        await self.display_text(
            "Time update running..."
            + "please wait a minute for the correct time to be displayed...",
        )
    ...
    async def show_current_time_loop(self):
        try:
            while True:
                ...
                next_change = 60 - datetime.datetime.now().second
    ...
    async def show_current_weather(self):
        ...
        weather = await fhem.ReadingsVal(
            self.weather_dev, self.weather_reading, "No weather data available"
        )
