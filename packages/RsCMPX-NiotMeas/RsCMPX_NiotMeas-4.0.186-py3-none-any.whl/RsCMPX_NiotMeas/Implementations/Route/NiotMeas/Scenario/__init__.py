...
class ScenarioCls:
	...
	def get_value(self) -> enums.Scenario:
		"""SCPI: ROUTe:NIOT:MEASurement<Instance>:SCENario \n
		Snippet: value: enums.Scenario = driver.route.niotMeas.scenario.get_value() \n
		No command help available \n
			:return: scenario: No help available
		"""
		response = self._core.io.query_str('ROUTe:NIOT:MEASurement<Instance>:SCENario?')
