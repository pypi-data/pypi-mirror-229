...
HTTP_OUT_TIME = '%s.%s,code=%d,hostname=%s,tm_direction=%s,json_code=%s'
...
class StatsD:
    ...
    @run_later_if_enabled
    def http_out_time_glork(self, rsp_status, rq_hostname, tm_direction, json_response_code, secundos):
