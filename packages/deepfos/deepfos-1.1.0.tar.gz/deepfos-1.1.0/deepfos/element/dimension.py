...
from .datatable import AsyncDataTableMySQL, AsyncDataTableClickHouse
...
# -----------------------------------------------------------------------------
# core
class AsyncDimension(ElementBase):
    """维度
    ...
    def _datatable_class(
        self,
    ) -> Union[Type[AsyncDataTableMySQL], Type[AsyncDataTableClickHouse]]:
    ...
    def reorder_members(self, memo: CIMultiDict[DimMember], complete: bool)-> List[DimMember]:
        """成员重排序
...
class Dimension(AsyncDimension, metaclass=SyncMeta):
    ...
    if TYPE_CHECKING:
        ...
        def query(
            ...
            role_name: str = None,
            role_group: str = None
        ) -> Union[List[DimensionMemberBean], List[Dict[str, Any]]]:  # pragma: no cover
            ...
