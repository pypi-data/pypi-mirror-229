...
from melvan.errors import AuthBytesInvalid
from melvan.session import Session
from melvan.session.auth import Auth


async def get_session(client: "melvan.Client", dc_id: int):
