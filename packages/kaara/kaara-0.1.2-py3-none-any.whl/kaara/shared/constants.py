...
DOCS_BASE_URL = "https://kaara.com/docs/kaara"
LEGACY_DOCS_BASE_URL = "https://legacy-docs-v1.kaara.com"
...
DOCS_URL_MIGRATION_GUIDE_MD_DEPRECATION = (
    f"{DOCS_URL_MIGRATION_GUIDE}#kaara-21-to-kaara-22"
)
DOCS_URL_TELEMETRY = DOCS_BASE_URL + "/telemetry/telemetry"
DOCS_BASE_URL_kaara_X = "https://kaara.com/docs/kaara-enterprise"
DOCS_BASE_URL_ACTION_SERVER = "https://kaara.com/docs/action-server"
...
# Constants for default kaara Open Source project layout
