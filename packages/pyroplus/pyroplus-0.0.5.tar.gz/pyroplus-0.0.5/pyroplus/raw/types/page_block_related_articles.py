...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <pyroplus.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <pyroplus.raw.base.PageRelatedArticle>`):
            N/A
