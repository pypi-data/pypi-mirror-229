...
# Get the absolute path to the 'client_data' directory and 
# set the client_data directory to the root directory of the project
current_dir = os.path.dirname(os.path.abspath(__file__))
client_data_dir = os.path.abspath(os.path.join(current_dir, '..', 'client_data'))
...
def result():
    ...
    # Define the path to save the collated data CSV file
    output_path = os.path.join(client_data_dir, 'collated_data.csv')
