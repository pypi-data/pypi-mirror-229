...
# %% auto 0
__all__ = ['AttrLvl', 'ArgsTuple', 'isp', 'iscls', 'isint', 'isstr', 'islist', 'isdict', 'istuple', 'islistordict', 'isdundstr',
           'isself', 'ispself', 'ispcls', 'isempty', 'ispempty', 'iskwotype', 'iskwonly', 'ispkwonly', 'isargvalnil',
           'isdefarg']
