...
class APIMethods:
    ...
    async def unpin_all_general_forum_topic_messages(
        ...
        """
        Use this method to clear the list of pinned messages in a General forum topic. The
        bot must be an administrator in the chat for this to work and must have the
        can_pin_messages administrator right in the supergroup. Returns True on success.
        """
        response = await self.api.request(
            "unpinAllGeneralForumTopicMessages", self.get_params(locals())
        )
        return response
    ...
    async def set_my_name(
        self, name: Optional[str] = None, language_code: Optional[str] = None, **kwargs
    ) -> bool:
        """
        Use this method to change the bot's name. Returns True on success.
        """
        response = await self.api.request("setMyName", self.get_params(locals()))
        return response
    ...
    async def get_my_name(
        ...
        BotName on success.
        """
        response = await self.api.request("getMyName", self.get_params(locals()))
