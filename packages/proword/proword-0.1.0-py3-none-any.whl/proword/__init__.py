...
class LocalData:
    """
    Local data solution to saving values and more onto a local user's hard drive. (BETA)
    ...
    def serialize(self, key: str, value: any):
        """
        Adds a identifiable key to a value given by the developer in a proword runtime.
