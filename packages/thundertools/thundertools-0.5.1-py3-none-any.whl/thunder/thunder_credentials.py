...
from thunder import boolpicker, stringpicker, get_shell_type
...
class ThunderCredentials:
    def __init__(self, creds_name: str, to_env=False):
        ...
        if not creds_path.is_file():
            ...
            if not make_creds_file:
                return
            variable_name = stringpicker('New variable name', '')
            variable_value = stringpicker('New variable value', '')
    ...
    def __str__(self):
        ...
        longest_var = max([len(v) for v in vars(self)])
