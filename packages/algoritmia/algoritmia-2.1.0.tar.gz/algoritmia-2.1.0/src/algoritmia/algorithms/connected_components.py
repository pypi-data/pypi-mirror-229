...
from algoritmia.algorithms.traversers import TTraverser
...
def connected_components(g: UndirectedGraph[TVertex],
                         vertex_traverser: TTraverser) -> Iterator[TCC]:
...
if __name__ == '__main__':
    ...
    ccs_bf = list(connected_components(my_graph, traverser_bf))
    print("Breath first::", ccs_bf)

    ccs_df = list(connected_components(my_graph, traverser_df))
