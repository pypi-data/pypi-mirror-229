...
from datetime import datetimej
...
QUERY = f"""
query GetInferenceBill($orgId: String!, $unitPriceCents: Int!) {
  getInferenceBill(orgId: $orgId, unitPriceCents: $unitPriceCents) {
    amountCents
    endDate
    inferenceDeployment {
      id
...
query GetStarterTierInferenceBill($orgId: String!, $unitPriceCentsPerInputToken: Int!, $unitPriceCentsPerOutputToken: Int!, $startDate: Date!, $endDate: Date!) {
  getStarterTierInferenceBill(orgId: $orgId, unitPriceCentsPerInputToken: $unitPriceCentsPerInputToken, unitPriceCentsPerOutputToken: $unitPriceCentsPerOutputToken, startDate: $startDate, endDate: $endDate) {
    totalInputTokens
    totalOutputTokens
    startDate
    endDate
