...
class ImageBackupFS(pyfuse3.Operations):
    ...
    :type image: partclone.imagebackup.ImageBackup
...
def mntType(fsType: str) -> str:
    ...
    :param fsType: string obtained from method *partclone.imagebackup.fsType()*
    :type fsType: str
...
def assertRegularFile(file: io.BufferedIOBase, filename: str) -> None:
    ...
    :type filename: str
    :returns: nothing
    :raises partclone.imagebackup.ImageBackupException: if the file is not a regular file.
    """
