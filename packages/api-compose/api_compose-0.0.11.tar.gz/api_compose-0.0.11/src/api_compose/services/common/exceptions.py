...
class YamlFileException(Exception):
    ...
    def __str__(self):
        return f"Error - Error reading yaml file at {self.env_file_path.absolute()}"
...
class ModelNotFoundException(Exception):
    ...
    def __str__(self):
        return f'No model is found with {self.target_model}. {self.available_models=}'
...
class ManifestModelNotFoundException(Exception):
    def __init__(self,
...
class ManifestIdNotFoundException(Exception):
    ...
    def __str__(self):
        return f"No manifest with id **{self.manifest_id}** is found in Path **{self.manifest_folder_path}**"
...
class ManifestDeserialisationException(Exception):
    ...
    def __str__(self):
        return (f"Error - Cannot deserialise manifest at path {self.manifest_file_path} with context \n"
