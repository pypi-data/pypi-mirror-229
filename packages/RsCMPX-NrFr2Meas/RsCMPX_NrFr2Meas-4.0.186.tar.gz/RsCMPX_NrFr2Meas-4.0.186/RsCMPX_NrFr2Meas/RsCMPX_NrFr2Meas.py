...
class RsCMPX_NrFr2Meas:
	...
	_driver_options = "SupportedInstrModels = CMX/CMP/CMW, SupportedIdnPatterns = CMX/CMP/CMW, SimulationIdnString = 'Rohde&Schwarz,CMP200,100001,4.0.186.0013'"
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsCMPX_NrFr2Meas version failed. Current version: '4.0.186.0013', minimum required version: '{min_version}'")
