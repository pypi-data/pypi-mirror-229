...
from melvan.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "melvan.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~melvan.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~melvan.handlers.MessageHandler` the *update* argument will be a :obj:`~melvan.types.Message`; in a :obj:`~melvan.handlers.CallbackQueryHandler` the *update* will be a :obj:`~melvan.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~melvan.filters.command` or :meth:`~melvan.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~melvan.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Document` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Game` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Video` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~melvan.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Location` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~melvan.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~melvan.types.Message`.
    ...
    async def func(flt, client: melvan.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~melvan.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~melvan.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~melvan.types.InlineQuery`: The filter will match ``query``.
