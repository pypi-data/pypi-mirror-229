...
class ChainCombiner(ChainTreeBuilder):
    ...
    def _initialize_and_process_tree(
        ...
        tree_docs, relationship_df, embeddings = self.process_coordinates_and_features(
            tetra, use_graph, animate, pre_computed_embeddings
        )
        return tetra, tree_docs, relationship_df, embeddings
    ...
    def process_trees(
        ...
        main_dfs = self._process_individual_trees(
            filtered_trees, use_graph, animate, pre_computed_embeddings, start
        )
