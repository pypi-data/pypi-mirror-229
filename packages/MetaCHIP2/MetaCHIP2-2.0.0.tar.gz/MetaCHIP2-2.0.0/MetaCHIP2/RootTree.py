...
def concat_trees(tree_file_1, tree_file_2, concatenated_tree):
    ...
    concat_tree = Tree()
    concat_tree.add_child(tree1)
    concat_tree.add_child(tree2)
    concat_tree.write(format=1, outfile=concatenated_tree)
...
def RootTree(args):
    ...
    gtdb_ref_tree_ar    = '%s/ar53_r214.tree'           % gtdb_dir
    gtdb_ref_tree_bac   = '%s/bac120_r214.tree'         % gtdb_dir
    gtdb_gnm_meta_ar    = '%s/ar53_metadata_r214.tsv'   % gtdb_dir
    gtdb_gnm_meta_bac   = '%s/bac120_metadata_r214.tsv' % gtdb_dir
