...
"""
    ...
    The version of the OpenAPI document: 1.0.784
...
class ApplicationChatResponse(object):
    ...
    def __init__(self, query=None, retriever_top_k=10, reader_top_k=5, answers=None, documents=None, supporting_content=None, local_vars_configuration=None):  # noqa: E501
