...
from ...types.interviews_paginated import InterviewsPaginated
from ...types.interviews_result import InterviewsResult
...
class InterviewsClient:
    ...
    def ats_interviews_list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "unified/ats/interviews"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(InterviewsPaginated, _response.json())  # type: ignore
    ...
    def ats_interviews_get(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"unified/ats/interviews/{id}"),
            params=remove_none_from_dict(
                {
                    "page": page,
                    "page_size": page_size,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(InterviewsResult, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
        if _response.status_code == 403:
            raise ForbiddenError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
