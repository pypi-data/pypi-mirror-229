...
from .baseline import EncoderModel, EncoderPooler
...
class RetrieveModel(EncoderModel):
    ...
    def load_pooler(model_weights_file, **config):
        pooler = RetrievalPooler(**config)
        pooler.load(model_weights_file)
        return pooler

    @staticmethod
    def build_pooler(model_args):
        pooler = RetrievalPooler(
