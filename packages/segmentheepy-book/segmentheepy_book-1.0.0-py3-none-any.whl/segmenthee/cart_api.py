...
sort_dict = {'default':0, 'status_orders':1, 'type':2, 'fullauthor':3, 'fulltitle':4, 'year_inc':5, 'year_dec':6,
             'pricedischuf_inc':7, 'pricedischuf_dec':8, 'rate':9, 'orders':10, 'transit_time':11}
