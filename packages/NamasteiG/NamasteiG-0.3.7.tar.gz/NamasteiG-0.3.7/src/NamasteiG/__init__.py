...
class Instagram:
    ...
    def __init__(self,User,Password,Proxy=None):
        ...
        self.UserAgent = "Instagram 299.0.0.34.111 Android (" + ["23/6.0", "24/7.0", "25/7.1.1", "26/8.0", "27/8.1", "28/9.0"][random.randint(0, 5)] + "; " + str(random.randint(100, 1300)) + "dpi; " + str(random.randint(200, 2000)) + "x" + str(random.randint(200, 2000)) + "; " + ["SAMSUNG", "HUAWEI", "LGE/lge", "HTC", "ASUS", "ZTE", "ONEPLUS", "XIAOMI", "OPPO", "VIVO", "SONY", "REALME"][random.randint(0, 11)] + "; SM-T" + rnd + "; SM-T" + rnd + "; qcom; en_US; 512770474)"
        self.Blockversion = '93e51d7224a695442aeb940f479e4a368947071436a5ef706b9ae7e0dd3382c3'
        self.proxy = Proxy
