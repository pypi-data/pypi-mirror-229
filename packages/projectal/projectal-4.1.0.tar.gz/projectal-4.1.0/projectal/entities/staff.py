...
class Staff(Entity, LocationLinker, ResourceLinker, SkillLinker, FileLinker,
            CompanyLinker, DepartmentLinker, TaskLinker, TaskTemplateLinker,
            NoteLinker, CalendarLinker, TagLinker):
    """
    Implementation of the [Staff](https://projectal.com/docs/latest/#tag/Staff) API.
    """
    _path = 'staff'
    _name = 'staff'
    _links = [LocationLinker, ResourceLinker, SkillLinker, FileLinker, NoteLinker,
              CalendarLinker, TagLinker]
