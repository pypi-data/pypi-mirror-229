...
class FileSearchResultsMeta(BaseModel):
    """
    Metadata about the search results.
    """
    results: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The total number of results.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FileSearchResultsMeta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FileSearchResultsMeta:
        """Create an instance of FileSearchResultsMeta from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FileSearchResultsMeta.parse_obj(obj)

        _obj = FileSearchResultsMeta.parse_obj({
