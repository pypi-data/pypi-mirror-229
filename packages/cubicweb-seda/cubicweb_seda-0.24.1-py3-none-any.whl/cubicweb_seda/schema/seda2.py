...
"""THIS FILE IS GENERATED FROM SEDA 2.1 XSD FILES, DO NOT EDIT"""
...
class physical_data_object_data_object_system_id(RelationDefinition):
    name = "seda_data_object_system_id"
    subject = "SEDADataObjectSystemId"
...
class physical_data_object_data_object_group_system_id(RelationDefinition):
    name = "seda_data_object_group_system_id"
    subject = "SEDADataObjectGroupSystemId"
    object = "SEDAPhysicalDataObject"
    cardinality = "1?"
...
class SEDAAgentAbstract(EntityType):
    """"""


class seq_alt_archive_unit_archive_unit_ref_id_management_agent_abstract(
    RelationDefinition
):
    name = "seda_agent_abstract"
    subject = "SEDAAgentAbstract"
    object = "SEDASeqAltArchiveUnitArchiveUnitRefIdManagement"
    cardinality = "1*"
    composite = fulltext_container = "object"
    inlined = True
...
@seda_profile_element(cardinalities=["1"], default_cardinality="1", annotable=False)
class SEDAAltAgentAbstractCorpname(EntityType):
    """"""


class agent_abstract_alt_agent_abstract_corpname(RelationDefinition):
    name = "seda_alt_agent_abstract_corpname"
    subject = "SEDAAgentAbstract"
    object = "SEDAAltAgentAbstractCorpname"
    cardinality = "11"
    composite = fulltext_container = "subject"
    inlined = False
    constraints = []
...
class agent_abstract_identifier(RelationDefinition):
    name = "seda_identifier"
    subject = "SEDAIdentifier"
    object = "SEDAAgentAbstract"
    cardinality = "1*"
    composite = fulltext_container = "object"
    inlined = True
    constraints = []
...
class agent_abstract_function(RelationDefinition):
    name = "seda_function"
...
class agent_abstract_activity(RelationDefinition):
    name = "seda_activity"
...
class agent_abstract_position(RelationDefinition):
    name = "seda_position"
...
class agent_abstract_role(RelationDefinition):
    name = "seda_role"
    subject = "SEDARole"
    object = "SEDAAgentAbstract"
    cardinality = "1*"
...
class agent_abstract_mandate(RelationDefinition):
    name = "seda_mandate"
    subject = "SEDAMandate"
    object = "SEDAAgentAbstract"
    cardinality = "1*"
...
class transmitter_identifier(RelationDefinition):
    name = "seda_identifier"
    subject = "SEDAIdentifier"
...
class sender_identifier(RelationDefinition):
    name = "seda_identifier"
    subject = "SEDAIdentifier"
    object = "SEDASender"
    cardinality = "1*"
...
class alt_agent_abstract_corpname_corpname(RelationDefinition):
    name = "seda_corpname"
...
@seda_profile_element(cardinalities=["1"], default_cardinality="1", annotable=False)
class SEDASeqAltAgentAbstractCorpnameFirstName(EntityType):
    """"""


class alt_agent_abstract_corpname_seq_alt_agent_abstract_corpname_first_name(
    RelationDefinition
):
    name = "seda_seq_alt_agent_abstract_corpname_first_name"
    subject = "SEDAAltAgentAbstractCorpname"
    object = "SEDASeqAltAgentAbstractCorpnameFirstName"
    cardinality = "?1"
    composite = fulltext_container = "subject"
    inlined = False
    constraints = []
...
class seq_alt_agent_abstract_corpname_first_name_first_name(RelationDefinition):
...
class seq_alt_agent_abstract_corpname_first_name_birth_name(RelationDefinition):
...
class seq_alt_agent_abstract_corpname_first_name_full_name(RelationDefinition):
    name = "seda_full_name"
...
class seq_alt_agent_abstract_corpname_first_name_given_name(RelationDefinition):
...
class seq_alt_agent_abstract_corpname_first_name_gender(RelationDefinition):
    name = "seda_gender"
    subject = "SEDAGender"
    object = "SEDASeqAltAgentAbstractCorpnameFirstName"
    cardinality = "1?"
...
class seq_alt_agent_abstract_corpname_first_name_birth_date(RelationDefinition):
...
class seq_alt_agent_abstract_corpname_first_name_birth_place(RelationDefinition):
...
class seq_alt_agent_abstract_corpname_first_name_death_date(RelationDefinition):
...
class seq_alt_agent_abstract_corpname_first_name_death_place(RelationDefinition):
...
class seq_alt_agent_abstract_corpname_first_name_nationality(RelationDefinition):
...
class seq_alt_transmitter_corpname_first_name_gender(RelationDefinition):
    name = "seda_gender"
    subject = "SEDAGender"
    object = "SEDASeqAltTransmitterCorpnameFirstName"
    cardinality = "1?"
...
class seq_alt_transmitter_corpname_first_name_nationality(RelationDefinition):
    name = "seda_nationality"
    subject = "SEDANationality"
    object = "SEDASeqAltTransmitterCorpnameFirstName"
    cardinality = "1*"
...
class seq_alt_sender_corpname_first_name_gender(RelationDefinition):
    name = "seda_gender"
    subject = "SEDAGender"
    object = "SEDASeqAltSenderCorpnameFirstName"
    cardinality = "1?"
...
class seq_alt_sender_corpname_first_name_nationality(RelationDefinition):
    name = "seda_nationality"
    subject = "SEDANationality"
    object = "SEDASeqAltSenderCorpnameFirstName"
    cardinality = "1*"
...
class alt_replaces_archive_unit_ref_id_external_reference(RelationDefinition):
    name = "seda_external_reference"
    subject = "SEDAExternalReference"
    object = "SEDAAltReplacesArchiveUnitRefId"
    cardinality = "1?"
...
class alt_requires_archive_unit_ref_id_external_reference(RelationDefinition):
    name = "seda_external_reference"
    subject = "SEDAExternalReference"
    object = "SEDAAltRequiresArchiveUnitRefId"
    cardinality = "1?"
...
class alt_is_part_of_archive_unit_ref_id_external_reference(RelationDefinition):
    name = "seda_external_reference"
    subject = "SEDAExternalReference"
    object = "SEDAAltIsPartOfArchiveUnitRefId"
    cardinality = "1?"
...
class alt_references_archive_unit_ref_id_external_reference(RelationDefinition):
    name = "seda_external_reference"
    subject = "SEDAExternalReference"
    object = "SEDAAltReferencesArchiveUnitRefId"
    cardinality = "1?"
