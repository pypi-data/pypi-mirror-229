...
class GitRepository:
    ...
    def GetIsOwn(self, loginName: str) -> bool:
        if self.Remote is None:
            ...
            return self.Remote.owner.login is loginName
    ...
    def GetRemoteOnly(items: List["GitRepository"]) -> List["GitRepository"]:
        return list(filter(lambda r: r.Local is None, items))
    ...
    def SetLocal(self, local: Repo) -> None:
        ...
        if local is not None:
            ...
            if self.Local.remotes.origin is not None:
    ...
    def __str__(self) -> str:
        ...
        if self.Local is None:
            ...
            if self.Local.remotes is not None:
