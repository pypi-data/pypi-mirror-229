...
class GroupCls:
	...
	def set(self, connector_name: str, signal_path: str) -> None:
		...
		Assigns a signal path to an output connector. The path is used if you activate the connector for signal output via a
		connector group. This command is only relevant if you create your own signal paths (see base manual) . The default signal
		paths have the same name as the assigned connector. \n
			:param connector_name: Name of the output connector.
			:param signal_path: Signal path to be assigned to the connector.
		"""
	...
	def get(self, connector_name: str) -> str:
		...
		paths have the same name as the assigned connector. \n
			:param connector_name: Name of the output connector.
			:return: signal_path: Signal path to be assigned to the connector."""
