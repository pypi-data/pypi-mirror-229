...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~pyroplus.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~pyroplus.Client.sign_in` or :meth:`~pyroplus.Client.sign_up`).

        next_type (:obj:`~pyroplus.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~pyroplus.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~pyroplus.Client.resend_code`.
    """
