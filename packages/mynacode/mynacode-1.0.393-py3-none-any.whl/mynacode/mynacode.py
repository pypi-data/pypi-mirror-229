...
def create_run(project_id = None, sweep = False, sweep_name = ""):
    ...
    data = {'project_id': project_id, 'username': uname, 'key': ky, 'sweep': sweep, 'sweep_name': sweep_name}
...
def init(sweep = False, sweep_name = "", save_files = False):
    ...
    if sweep == True:
      ...
      run_id_global = r_id
      run_dir_global = project_dir_global+'/SWP_'+sweep_name+'_'+str(r_id)+'_'+str(datetime.now())[:10]
...
def data(train_set=[], train_labels=[], val_set=[], val_labels=[], test_set=[], test_labels=[], dataset_name="", #checks if data is same as prev
  ...
  if save_new_data_flag == 1:
      ...
      if sweep_global == True:
          temp = "SWP_"+str(run_id_global)+"_"+dataset_name+"_" + ''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase + string.digits) for _ in range(6))
          while os.path.exists(current_dir+'/data/'+temp):
              temp = "SWP_"+str(run_id_global)+"_"+dataset_name+"_" + ''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase + string.digits) for _ in range(6))
      else:
          temp = "Run_"+str(run_id_global)+"_"+dataset_name+"_" + ''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase + string.digits) for _ in range(6))
          while os.path.exists(current_dir+'/data/'+temp):
              temp = "Run_"+str(run_id_global)+"_"+dataset_name+"_" + ''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase + string.digits) for _ in range(6))
      ...
      if len(train_labels) > 0:
        ...
        config_dict.update({'train_labels': current_dir+'/data/'+dataset_name+'/train_labels.pkl'})
      ...
      if len(val_labels) > 0:
        ...
        config_dict.update({'val_labels': current_dir+'/data/'+dataset_name+'/val_labels.pkl'})
      ...
      if len(test_labels) > 0:
        ...
        config_dict.update({'test_labels': current_dir+'/data/'+dataset_name+'/test_labels.pkl'})

      config_dict.update({'prev_saved_data': False})
  else:
      print("The current datasets are already saved locally.")
      config_dict.update({'prev_saved_data': True})
...
def torch_data(train_dataloader=None, val_dataloader=None, test_dataloader=None, dataset_name="", label_index=1,
  ...
  if sweep_global == True:
    if len(str(dataset_name)) == 0:
      dataset_name = "Run_"+str(run_id_global)+"_dataset"
    else:
      dataset_name = "Run_"+str(run_id_global)+"_"+dataset_name
  else:
    if len(str(dataset_name)) == 0:
      dataset_name = "SWP_"+str(run_id_global)+"_dataset"
    else:
      dataset_name = "SWP_"+str(run_id_global)+"_"+dataset_name
  ...
  if save_new_data_flag == 1:
      ...
      temp = dataset_name+"_" + ''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase + string.digits) for _ in range(6))
      while os.path.exists(current_dir+'/data/'+temp):
          temp = dataset_name+"_" + ''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase + string.digits) for _ in range(6))
...
def tensorflow_data(train_dataset=None, val_dataset=None, test_dataset=None, dataset_name="", label_index=1,
         problem_type = 'binary classification',  node_name="Datasets", if_sweep_save_once = True, run_id = None):
  ...
  if newest_data_folder == None:
      ...
      if (train_dataset != None) and (len(train_dataset) > 0) and (os.path.exists(newest_data_folder + '/train_dataset.pkl')): #Both exist
          print("c")
          ...
          if not np.array_equal(b1, b2):
              print(b1, b2)
              save_new_data_flag = 1
      elif (~(os.path.exists(newest_data_folder + '/train_dataset.pkl'))) and (train_dataset == None): #Both don't exist
          print("d")
          pass
      else: #One exists, one doesn't
          print("e")
      ...
      if ((os.path.exists(newest_data_folder + '/val_dataset.pkl')) and (save_new_data_flag == 0) and (val_dataset != None) and (len(val_dataset) > 0)):
          print("f")
          ...
          if not np.array_equal(b1, b2):
              print(b1, b2)
              save_new_data_flag = 1
      elif ((~(os.path.exists(newest_data_folder + '/val_dataset.pkl'))) and (save_new_data_flag == 0) and (val_dataset == None)):
          print("g")
          pass  
      else:
          print("h")
      ...
      if (os.path.exists(newest_data_folder + '/test_dataset.pkl')) and (save_new_data_flag == 0) and (test_dataset != None) and (len(test_dataset) > 0):
          print("i")
          ...
          if not np.array_equal(b1, b2):
              print(b1, b2)
              save_new_data_flag = 1
      elif ((~(os.path.exists(newest_data_folder + '/test_dataset.pkl'))) and (save_new_data_flag == 0) and (test_dataset == None)):
          print("j")
          pass
      else:
          print("k")
  ...
  if save_new_data_flag == 1:
      ...
      if train_dataset:                
        tf.data.Dataset.save(train_dataset, current_dir+'/data/'+dataset_name+'/train_dataset.pkl')
        config_dict.update({'train_dataset': current_dir+'/data/'+dataset_name+'/train_dataset.pkl'})

      if val_dataset:                
        tf.data.Dataset.save(val_dataset, current_dir+'/data/'+dataset_name+'/val_dataset.pkl')
        config_dict.update({'val_dataset': current_dir+'/data/'+dataset_name+'/val_dataset.pkl'})

      if test_dataset:                
        tf.data.Dataset.save(test_dataset, current_dir+'/data/'+dataset_name+'/test_dataset.pkl')
        config_dict.update({'test_dataset': current_dir+'/data/'+dataset_name+'/test_dataset.pkl'})
