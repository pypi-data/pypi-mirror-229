...
INTERFACE_SCAN_HEADLESS_OUTPUT_REPORT_HELP = (
    "On headless mode, the report will be printed only at the end in the terminal output, not in realtime."
)
INTERFACE_SCAN_NO_FILE_FOUND_MSG = "For the given path no file was found to be scanned."
INTERFACE_SCAN_EXCLUDE_PATHS_HELP = (
    "Exclude paths from being scanned by adding them to the exclude_paths argument comma separated."
)
...
The given compare_branch should exists in the repository. If you run this locally, make sure your have pulled the branch and it's up-to-date.\n
Example:\n\n
...
INTERFACE_SCAN_PR_GIT_BRANCH_NOT_FOUND_MSG = "The branch {branch} isn't not found in the repository."
