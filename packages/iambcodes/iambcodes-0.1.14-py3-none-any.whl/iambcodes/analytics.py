...
class MultiCondition():
    ...
    def export2Excel(self):
        ...
        data = {}
        for condition in multi_condition.Conditions:
            condition_data = {}
            for fragment in multi_condition.__dict__[condition].List:
                fragment_data = {}
                fragment_data['MDV'] = multi_condition.__dict__[condition].__dict__[fragment].MDV
                fragment_data['AvgMDV'] = multi_condition.__dict__[condition].__dict__[fragment].AvgMDV
                fragment_data['RSD'] = multi_condition.__dict__[condition].__dict__[fragment].RSD
                fragment_data['AvgMDVrsd'] = multi_condition.__dict__[condition].__dict__[fragment].AvgMDVrsd
