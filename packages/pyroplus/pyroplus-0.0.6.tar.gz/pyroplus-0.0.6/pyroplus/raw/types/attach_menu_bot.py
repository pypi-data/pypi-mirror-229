...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <pyroplus.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <pyroplus.raw.base.AttachMenuBotIcon>`):
            N/A
