...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~melvan.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~melvan.Client.sign_in` or :meth:`~melvan.Client.sign_up`).

        next_type (:obj:`~melvan.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~melvan.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~melvan.Client.resend_code`.
    """
