...
def data(train_set=[], train_labels=[], val_set=[], val_labels=[], test_set=[], test_labels=[], dataset_name="", #checks if data is same as prev
  ...
  if save_new_data_flag == 1:
      ...
      while os.path.exists(current_dir+'/data/'+dataset_name):
          dataset_name = "RunID_"+str(run_id_global)+"_"+dataset_name+"_" + ''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase + string.digits) for _ in range(6))
