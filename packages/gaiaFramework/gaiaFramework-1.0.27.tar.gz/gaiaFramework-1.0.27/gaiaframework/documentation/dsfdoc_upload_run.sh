#!/bin/bash
echo ""
echo "*** Uploading gaiaframework documentation to google storage bucket ***"
echo ""
echo "Reading doxygen config..."
# Get documentation folder
doc_folder="not_found_yet"
html_folder_name="html"
google_gs_doc_folder="gs://gaia-ds-documentation/documentation/gaiaframework"
google_gs_backup_folder="gs://gaia-ds-documentation/documentation/backups"
google_storage_path='https://storage.cloud.google.com/gaia-ds-documentation/documentation/gaiaframework/'
...
if [ ! -d "$doc_folder/$html_folder_name" ]; then
  echo "DSF Documentation location not found, run the script from gaiaframework/documentation/ folder or "
...
backup_folder_name+="_gaiaframework"
