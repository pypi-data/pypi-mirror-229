...
import melvan
from melvan.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~melvan.Client.start`, :meth:`~melvan.idle` and :meth:`~melvan.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`melvan.compose`.
