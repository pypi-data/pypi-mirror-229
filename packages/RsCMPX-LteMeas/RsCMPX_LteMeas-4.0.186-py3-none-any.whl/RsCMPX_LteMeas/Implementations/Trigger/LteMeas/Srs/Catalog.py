...
class CatalogCls:
	...
	def get_source(self) -> List[str]:
		...
		Snippet: value: List[str] = driver.trigger.lteMeas.srs.catalog.get_source() \n
		Lists all trigger source values that can be set using method RsCMPX_LteMeas.Trigger.LteMeas.Srs.source. \n
