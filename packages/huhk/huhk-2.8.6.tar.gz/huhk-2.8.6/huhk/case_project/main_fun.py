...
if __name__ == '__main__':
    install_project('67ee0022-acb1-43ea-8ccf-ef4d2398b374')
    # running_testcase(['ddzx/web\r\nyhzx/web/circlelayer'], case_path=r"D:\projects\python_test\ardar_test\autotest\codes\1\testcase",
    #                  report_path=r"D:\projects\python_test\ardar_test\static\media\report\29")