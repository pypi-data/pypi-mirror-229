...
class Datacleaning:
    ...
    def cat_dist(self):
        ...
        if num_columns == 1:
            ...
            axs = axs.flatten()  # Flattening the axs to ensure it is  1D array
    ...
    def rename(self, old_name, new_name):
        if isinstance(old_name, str) and isinstance(new_name, str):
            self.dataframe = self.dataframe.rename(columns={old_name: new_name}, inplace=True)
            ...
            self.dataframe = self.dataframe.rename(columns=rename_dict, inplace=True)
        else:
...
## removing outliers for a specific column
    def remove_outliers_single(self,column):
        ...
        if isinstance(column, str):
            ...
            print("Enter a string or a list as parameter")
