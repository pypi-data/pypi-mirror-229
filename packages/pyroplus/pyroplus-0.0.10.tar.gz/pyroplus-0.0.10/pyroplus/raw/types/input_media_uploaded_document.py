...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <pyroplus.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <pyroplus.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <pyroplus.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <pyroplus.raw.base.InputDocument>`, *optional*):
            N/A
