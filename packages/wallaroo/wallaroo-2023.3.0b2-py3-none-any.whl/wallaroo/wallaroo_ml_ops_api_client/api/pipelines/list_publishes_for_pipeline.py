...
def _get_kwargs(
    *,
    ...
    url = "{}/v1/api/pipelines/list_publishes_for_pipeline".format(
        client.base_url)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[ListResponse]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ListResponse]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        json_body (ListRequest): Request to list published pipelines.
