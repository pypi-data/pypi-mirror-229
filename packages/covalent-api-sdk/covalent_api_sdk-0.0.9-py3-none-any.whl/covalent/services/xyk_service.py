...
class XykService:
    ...
    def get_dex_for_pool_address(self, chain_name: chains, pool_address: str) -> Response[PoolToDexResponse]:
        """
        Parameters:
    ...
    def get_pools_for_token_address(self, chain_name: chains, token_address: str, quote_currency: Optional[quotes] = None) -> Response[PoolsDexDataResponse]:
        """
        Parameters:
        ...
        while not success:
            try:
                ...
                response = requests.get(f"https://api.covalenthq.com/v1/{chain_name}/xy=k/address/{token_address}/pools/", params=url_params, headers={
                    "Authorization": f"Bearer {self.__api_key}",
                    "X-Requested-With": user_agent
                })
