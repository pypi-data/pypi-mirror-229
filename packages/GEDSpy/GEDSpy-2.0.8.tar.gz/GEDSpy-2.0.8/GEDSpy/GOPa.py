   ...
   """
    ...
    try:
        ...
        if species == 'human':
            ...
            founded = [str(y) + str(1) for y in gene_list if str(y) + str(1)  in not_found]
            
            not_found = [y for y in gene_list if str(y) + str(1)  not in not_found]

            genes_list = genes_list + founded
            
            synonymes_list = synonymes_list + founded
...
def gene_interactions_network_vis(GOPa_data, GOPa_metadata, target_interaction = None, n_min = 2, top_n = 50, species = None, display_name = 'human', color = 'darkviolet', path = _path_tmp):
