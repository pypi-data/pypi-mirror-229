...
import melvan
from melvan import StopTransmission, enums
from melvan import raw
from melvan import types
from melvan import utils
from melvan.errors import FilePartMissing
from melvan.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~melvan.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~melvan.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~melvan.Client.stop_transmission`, None is returned.
