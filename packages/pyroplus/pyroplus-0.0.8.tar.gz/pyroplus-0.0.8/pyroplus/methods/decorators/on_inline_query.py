...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~pyroplus.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroplus.Client):
                self.add_handler(pyroplus.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroplus.handlers.InlineQueryHandler(func, self),
