...
class HelpStyles(Styles):
    ...
    TEXT_ABBREV = FS(fg=pt.cv.YELLOW, bold=True)           # &p &(gre)p    |&()| highlighed part of abbrev       # noqa
...
class HelpMarkup:
    ...
    def __init__(self):
        ...
        #  =>  |  FIXED RRSULT WIDTH  |  (post-markup-removing width compensation)
...
class CliGroup(click.Group, CliBaseCommand):
    ...
    def __init__(self, **kwargs):
        ...
        super().__init__(**kwargs)
        AutoDiscover.run(self, self._filepath, autodiscover_extras)
