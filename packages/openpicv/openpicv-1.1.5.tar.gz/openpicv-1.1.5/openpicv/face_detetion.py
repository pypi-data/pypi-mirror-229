...
while True:
    ...
    for (x, y, w, h) in filtered_faces:
        cv2.rectangle(frame, (x, y), (x + w, y + h), (255, 0, 0), 2)
            ...
            # # 如果识别到的眼睛数量超过2个，选择中心点纵坐标最相近的两个眼睛
            # if len(eyes) > 2:
            #     eye_centers = []
            ...
            #     eye_centers.sort(key=lambda c: c[1])  # 按纵坐标排序
            #     eyes = [(eye_centers[0][0] - x, eye_centers[0][1] - y, ew, eh),
            #             (eye_centers[1][0] - x, eye_centers[1][1] - y, ew, eh)]
