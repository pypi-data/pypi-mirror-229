...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <pyroplus.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <pyroplus.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <pyroplus.raw.base.messages.Messages>`
    """
