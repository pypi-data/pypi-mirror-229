...
_UnionType = type(int | str) | type(Union[int, str])
...
@dataclass(slots=True)
class ModelInfo:
    fields: dict[_FieldName, tuple[type[BaseModel], ModelField | ModelFieldImposter]]
...
) -> dict[_FieldName, tuple[type[BaseModel], ModelField | ModelFieldImposter]]:
    actual_fields: dict[_FieldName, tuple[type[BaseModel], ModelField | ModelFieldImposter]] = {}
...
def _get_attribute_from_field_info(field: ModelField | ModelFieldImposter, attr: str) -> Any:
