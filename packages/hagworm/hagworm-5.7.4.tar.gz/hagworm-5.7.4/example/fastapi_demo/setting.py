...
if cluster:
    ConfigStatic.read(os.path.join(current_path, f'./config/static.{cluster}.conf'))
    ConfigDynamic.read(os.path.join(current_path, f'./config/dynamic.{cluster}.conf'))
else:
    ConfigStatic.read(os.path.join(current_path, r'./config/static.conf'))
    ConfigDynamic.read(os.path.join(current_path, r'./config/dynamic.conf'))
