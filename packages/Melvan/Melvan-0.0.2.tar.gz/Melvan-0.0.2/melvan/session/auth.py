...
from melvan.crypto import aes, rsa, prime
from melvan.errors import SecurityCheckMismatch
from melvan.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "melvan.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
