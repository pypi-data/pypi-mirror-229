...
class Project():
  ...
  def get_priority_list(self,priority_rule='SPT',verbose=False,save=False):
    ...
    priority_rules = {'LPT':['D',False], # Longest processing time
                      ...
                      'LIS':['IS',True], # Least inmediate succesors
                      'MIS':['IS',False], # Most inmediate succesor
                      'LTS':['TS',True], # Least total succesors
                      'MTS':['TS',False], # Most total succesors
  ...
  # no necesariamente tiene que estar adentro de la clase
  def generate_datetime_schedule(self,solution,start_date = None,date_format = '%Y-%m-%d',weekends_work = False,max_resources = None,verbose=False,save=False):
  ...
  def plot_date_gantt(self,solution):
  ...
  def run_all_pl_heuristics(self,max_resources = None):
  ...
  def genetic_algorithm_optimization(self,max_resources = None, popSize = 40,elite_percentage = 0.2, crossover_rate = 0.2, mutationRate = 0.05, generations = 100,show=False):
    ...
    solution_pl = geneticAlgorithm(PROJECT, popSize, elite_percentage, crossover_rate, mutationRate, generations,show)
    ...
    best = {'PR':'GENETIC ALGORITHM','schedule_method':mthd,'solution':schedule,'makespan':dur}
