    ...
    try:
         ...
         if(model.modelType=="ratings"):
             ...
             for ind,my_crit in enumerate(model.rateModel.ratCriteria):
                 ...
                 len_rat_tbl=3+len(model.rateModel.ratCriteria)
                 col+=1
                 #the criterion name as a title
                 ...
                 set_cell_value_and_style(worksheet.cell(in_row+4,col), "value",res_cr_fill,border, "ff000000" ,True)
                 #the criterion name as a title
                 set_cell_value_and_style(worksheet.cell(in_row+4,col), my_crit.name,res_hd_fill,border, "ff000000" ,True)
             col=1
             row+=1   
