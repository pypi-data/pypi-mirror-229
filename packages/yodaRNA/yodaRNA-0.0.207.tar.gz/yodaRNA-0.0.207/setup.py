...
def update_version_py():
    ...
    try:
        ...
        print("unable to run git, leaving yoda/__version__.py alone")
        return
    ...
    f = open("yoda/__version__.py", "w")
    f.write(VERSION_PY % ver)
    f.close()
    print("set yoda/__version__.py to '%s'" % ver)


def get_version():
    try:
        f = open("yoda/__version__.py")
    except EnvironmentError:
        return None
...
setup(
    ...
    author_email='myl4stn4m3@cs.uni-freiburg.de',
        packages=['yoda', 'yoda.alignments', 'yoda.graphs', 'yoda.ml', 'yoda.scripts'],
    scripts=[ ],
    include_package_data=True,
    package_data={},
    url='https://github.com/smautner/pig',
    license='LICENSE',
    description='rna alignmnent something something',
