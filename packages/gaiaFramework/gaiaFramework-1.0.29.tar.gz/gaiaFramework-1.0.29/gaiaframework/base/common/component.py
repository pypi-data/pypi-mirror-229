...
##
# @file
# @brief DS_Component base class for all pipeline components.

from typing import List, Any


class DS_Component:
    """! DS_Component is the base class for the pipeline components:

    DS_Preprocessor, Predictor, Forcer and DS_Postprocessor.
    ...
    **Important note:**
    ...
    def __init__(self, artifacts=None) -> None:
        """DS_Component class initializer, runs during __init__.
