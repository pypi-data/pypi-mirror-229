...
class ActorNetworkRNN(nn.Module):
    ...
    def __init__(self, input_shape, output_shape, input_shape_RNN, n_features, input_processor = None, **kwargs):
    ...
    def forward(self, state):
        ...
        h0 = torch.zeros(1 , state_ts.size(0), self._n_features).requires_grad_()
...
class ActorNetworkRNN_MLP_hybrid(nn.Module):
    ...
    def __init__(self, input_shape, output_shape, input_shape_RNN, input_shape_MLP, n_features, input_processor = None, **kwargs):
        super(ActorNetworkRNN, self).__init__()
    ...
    def forward(self, state):
        ...
        h0 = torch.zeros(1 , state_ts.size(0), int(self._n_features/2)).requires_grad_()
