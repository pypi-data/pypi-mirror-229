...
class ParseReference:
    @staticmethod
    def _parse_wos_ref(ref: str, doc_index: Optional[int] = None) -> Optional[WosField]:
        """Parse reference of Web of Science.

        Args:
            ref: A reference string. e.g. `CORTES C, 1995, MACH LEARN, V20, P273, DOI 10.1007/BF00994018`
            doc_index: doc_index to which the reference belongs. Default None.
        ...
        return WosField(FAU, PY, J9, VL, BP, DI, doc_index)
        ...
        if re.search(r"[\u4e00-\u9fa5]", ref):
            ...
            # Dissertation
                ...
                try:
                    ...
                    SO, PY = other.split(",")
                    PY = PY.split(":")[0]
                    return CssciField(FAU, TI, SO, PY, None, doc_index)
            ...
            # Country standard
                ...
                if ref[-3:] == "出版社":
                    ...
                    return CssciField(FAU, TI, SO, None, None, doc_index)
                else:
                    _, FAU, TI = ref.split(".", 2)
                    return CssciField(FAU, TI, None, None, None, doc_index)
            ...
            # Standard
                ...
                return CssciField(FAU, TI, None, PY, None, doc_index)
            ...
            # Patent1
                ...
                return None
                TI = ref.split(".", 1)[1]
                return CssciField(None, TI, None, None, None, doc_index)
            # Patent2
                ...
                return CssciField(None, TI, None, PY, None, doc_index)
            ...
            # Journal1
                ...
                return CssciField(FAU, TI, SO, PY, VL, doc_index)
            # Journal2
            elif dot_count == 4:
        ...
        if ref != "":
            ...
            if comma_count == 0:
                ...
                # Match title
                    ...
                    return None
        return ScopusField(FAU, TI, SO, VL, IS, BP, EP, PY, doc_index)
    ...
    def parse_one_ref(
        ...
        Returns:
            Parsed reference as a namedtuple.
        ...
        Example:
            ...
            >>> print(parsed_ref)
            WosField(FAU='Bengio Y', PY='2001', J9='ADV NEUR IN', VL='13', BP='932', DI=None, doc_index=None)
        """
        if source == "wos":
    ...
    def parse_ref_cell(
        ...
        Args:
            ...
            source: Data source. `wos`, `cssci` or `scopus`.
            doc_index: doc_index to which the reference cell belongs. Default None.

        Returns:
            List of parsed references with same source.
        ...
        Example:
            ...
            [WosField(FAU='Bengio Y', PY='2001', J9='ADV NEUR IN', VL='13', BP='932', DI=None, doc_index=None), WosField(FAU='CORTES C', PY='1995', J9='MACH LEARN', VL='20', BP='273', DI='10.1007/bf00994018', doc_index=None)]
        """
        sep = "; "
        try:
        ...
        parsed_ref_list = [
            self.parse_one_ref(ref, source, doc_index) for ref in ref_list
        ]
