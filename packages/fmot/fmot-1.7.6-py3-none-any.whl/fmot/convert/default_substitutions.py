...
def from_torchmodule_template(cls, parent, toplevel=None, inherited_name="", inherited_dict=SubstDict):
...
def follows_template(func):
    try:
        ...
        raise Exception("{} is a substitution module but has no `_from_torchmodule`. Refer to"
