...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <pyroplus.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <pyroplus.raw.base.auth.CodeType>`, *optional*):
            N/A
