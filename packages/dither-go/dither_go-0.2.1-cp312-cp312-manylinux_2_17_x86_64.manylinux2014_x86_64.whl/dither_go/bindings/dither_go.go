...
gopy build -no-make -dynamic-link=True -symbols=False -output /project/build/lib.linux-x86_64-cpython-312/dither_go/bindings -vm /tmp/build-env-0csujd55/bin/python ./dither_go github.com/tfuxu/dither-gopy
*/
