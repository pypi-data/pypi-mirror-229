...
class MetaRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Optional[Union[Dict[str, Any], str]] = None) -> None:
        ...
        """
        super().__init__(request_adapter, "{+baseurl}/groups/{groupId}/artifacts/{artifactId}/versions/{version}/meta", path_parameters)
    ...
    async def get(self,request_configuration: Optional[MetaRequestBuilderGetRequestConfiguration] = None) -> Optional[VersionMetaData]:
        """
    ...
    @dataclass
    class MetaRequestBuilderDeleteRequestConfiguration(BaseRequestConfiguration):
        from kiota_abstractions.base_request_configuration import BaseRequestConfiguration
