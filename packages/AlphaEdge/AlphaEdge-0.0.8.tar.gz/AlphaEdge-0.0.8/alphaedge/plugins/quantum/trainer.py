...
class Trainer(Base):
    ...
    def __init__(self, directory, policy_id, is_groups=1, offset=1):
    ...
    def groups_train(self, policy_desc, total_data, is_log=True):
    ...
    def main_train(self, model_desc, total_data, is_log=True):
        desc_dir = os.path.join(self.category_directory, "desc")
