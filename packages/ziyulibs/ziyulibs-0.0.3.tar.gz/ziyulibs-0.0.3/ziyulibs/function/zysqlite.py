...
import json
import sqlite3
from ziyulibs.base.zyarr import mergearray
from ziyulibs.base.zydict import mergedict
from ziyulibs.function.zylog import console, consoleReq, consoleErr, consoleSql, LOGTYPE
...
#             ','.join(valuelist),
#         )
#         # console(sqlstr, list, position='c:/0000/47python/ziyulibs/ziyulibs/function/zysqlite.py:341')
...
#             console(execsql, params, position='c:/0000/47python/ziyulibs/ziyulibs/function/zysqlite.py:356')
#             conn.execute(execsql, params)
#         cursor = conn.commit()
#         # return cursor.rowcount
#     except Exception as ex:
#         console(ex, 'insertdb报错', sqlstr, position='c:/0000/47python/ziyulibs/ziyulibs/function/zysqlite.py:361')
#         return False
#     finally:
#         conn.close()
...
class zysqlite(unittest.TestCase):
    ...
    def setUp(self) -> None:
        # print('构建')
        console(label=LOGTYPE.无, value=True, position='c:/0000/47python/ziyulibs/ziyulibs/function/zysqlite.py:460')
        console(label=LOGTYPE.调试, value=True, position='c:/0000/47python/ziyulibs/ziyulibs/function/zysqlite.py:461')
        console(label=LOGTYPE.链接, value=True, position='c:/0000/47python/ziyulibs/ziyulibs/function/zysqlite.py:462')
        console(label=LOGTYPE.配置, value=True, position='c:/0000/47python/ziyulibs/ziyulibs/function/zysqlite.py:463')
        console(label=LOGTYPE.请求, value=True, position='c:/0000/47python/ziyulibs/ziyulibs/function/zysqlite.py:464')
        console(label=LOGTYPE.语句, value=True, position='c:/0000/47python/ziyulibs/ziyulibs/function/zysqlite.py:465')
        console(label=LOGTYPE.异常, value=True, position='c:/0000/47python/ziyulibs/ziyulibs/function/zysqlite.py:466')
        return super().setUp()
    ...
    #    # console(isprintdebug=True, position='c:/0000/47python/ziyulibs/ziyulibs/function/zysqlite.py:480')
    #     # 测试in语句
