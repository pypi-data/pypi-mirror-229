...
from pyroplus.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~pyroplus.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <pyroplus.api.types.messages.BotResults>`: On Success.
