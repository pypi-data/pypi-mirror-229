...
class QilecaiNumber(Base):
    """ number_qlc """
    __tablename__ = 'number_qlc'
    ...
    num8 = Column(Integer, nullable=False)

    def __init__(self, data_list: list):
        self.issue, self.num1, self.num2, self.num3, self.num4, self.num5, self.num6, self.num7, self.num8 = data_list
    ...
    def get_all(cls):
        ...
        session.close()
        return [[x.issue, x.num1, x.num2, x.num3, x.num4, x.num5, x.num6, x.num7, x.num8] for x in data]
    ...
    def get_one(cls, issue_number: int):
        ...
        session.close()
        return [data.issue, data.num1, data.num2, data.num3, data.num4, data.num5, data.num6, data.num7, data.num8]
    ...
    def add_number(cls, p_issue: str, p_numbers: list):
        ...
        session.commit()
        session.close()
        print(f">>> QLC merge:{p_issue} - {p_numbers}")
