...
class UserApplyRecord(models.Model):
    ...
    # user = models.ForeignKey(BaseInfo, verbose_name='发起审批用户', blank=True, null=True, help_text='', db_constraint=False, on_delete=models.DO_NOTHING)
    # verify_user = models.ForeignKey(BaseInfo, verbose_name='审批用户', on_delete=models.DO_NOTHING, db_constraint=False, blank=True, null=True, help_text='')
