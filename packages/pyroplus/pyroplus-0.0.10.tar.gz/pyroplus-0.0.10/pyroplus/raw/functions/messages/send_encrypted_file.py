...
class SendEncryptedFile(TLObject):  # type: ignore
    ...
    Parameters:
        peer (:obj:`InputEncryptedChat <pyroplus.raw.base.InputEncryptedChat>`):
            N/A
        ...
        file (:obj:`InputEncryptedFile <pyroplus.raw.base.InputEncryptedFile>`):
            N/A
    ...
    Returns:
        :obj:`messages.SentEncryptedMessage <pyroplus.raw.base.messages.SentEncryptedMessage>`
    """
