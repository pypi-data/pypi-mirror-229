...
class DialogFilter(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.DialogFilter`.
    ...
    Parameters:
        ...
        pinned_peers (List of :obj:`InputPeer <pyroplus.raw.base.InputPeer>`):
            N/A

        include_peers (List of :obj:`InputPeer <pyroplus.raw.base.InputPeer>`):
            N/A

        exclude_peers (List of :obj:`InputPeer <pyroplus.raw.base.InputPeer>`):
            N/A
