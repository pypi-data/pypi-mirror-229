...
class MerrorCls:
	...
	def fetch(self, xvalue: int or bool, trace_select: enums.TraceSelect, deltaMarker=repcap.DeltaMarker.Default) -> float:
		...
		Snippet: value: float = driver.lteMeas.multiEval.dmarker.merror.fetch(xvalue = 1, trace_select = enums.TraceSelect.AVERage, deltaMarker = repcap.DeltaMarker.Default) \n
