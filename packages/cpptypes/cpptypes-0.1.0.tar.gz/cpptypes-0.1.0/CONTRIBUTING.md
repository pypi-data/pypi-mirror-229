...
Welcome to `cpptypes` contributor's guide.
...
If you experience bugs or general issues with `cpptypes`, please have a look
...
You can help improve `cpptypes` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`cpptypes` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `cpptypes`'s files. While this mechanism can
...
```
conda create -n cpptypes python=3 six virtualenv pytest pytest-cov
conda activate cpptypes
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/cpptypes.git
   cd cpptypes
   ```
...
5. Install [pre-commit]:
   ...
   `cpptypes` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/cpptypes
[issue tracker]: https://github.com/<USERNAME>/cpptypes/issues
