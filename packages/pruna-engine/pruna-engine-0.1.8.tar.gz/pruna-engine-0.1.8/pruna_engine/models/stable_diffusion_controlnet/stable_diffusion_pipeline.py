...
from .utilities import DDIMScheduler
...
class StableDiffusionPipeline:
    ...
    def denoise_latent(self, img, latents, text_embeddings, timesteps=None, step_offset=0, mask=None, masked_image_latents=None):
        ...
        for step_index, timestep in enumerate(timesteps):
            ...
            # noise_pred = self.runEngine('unet', {"sample": sample_inp, "timestep": timestep_inp})['latent']
            noise_pred = self.runEngine('unet', {"sample": sample_inp, "timestep": timestep_inp,
