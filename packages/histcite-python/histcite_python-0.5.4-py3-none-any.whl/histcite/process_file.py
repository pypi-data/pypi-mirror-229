    ...
    def _concat_refs(
        ...
        for idx in cr_field_series.index:
            ...
            if isinstance(cell, str):
                parse_result = ParseReference().parse_ref_cell(cell, source, idx)
    ...
    def process_citation(self, refs_df: pd.DataFrame) -> pd.DataFrame:
        ...
        if self._source == "wos":
            ...
            (
                ...
                local_refs_series,
            ) = RecognizeReference.recognize_wos_reference(self._docs_df, refs_df)
            ...
            (
                cited_doc_index_series,
                local_refs_series,
            ) = RecognizeReference.recognize_cssci_reference(self._docs_df, refs_df)
            ...
            (
                cited_doc_index_series,
                local_refs_series,
            ) = RecognizeReference.recognize_scopus_reference(self._docs_df, refs_df)
        else:
            raise ValueError("Invalid source type")
