...
class ModelMetaclass(pydantic.main.ModelMetaclass):
    ...
    def __init__(cls, _what, _bases=None, _dict=None):
        ...
        if cls.__fields__:
            ...
            _dict.setdefault(r'__annotations__', {})

            # 原始参数类型清单
            annotations = {}

            for _cls in _bases:
                annotations.update(_cls.__dict__.get(r'__annotations__', {}))
            else:
                annotations.update(_dict[r'__annotations__'])

            _dict[r'__annotations__'].clear()
            _dict[r'__annotations__'].update(annotations)
