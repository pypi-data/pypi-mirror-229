...
class MessageEntity(Object):
    ...
    Parameters:
        type (:obj:`~pov.enums.MessageEntityType`):
            Type of the entity.
        ...
        url (``str``, *optional*):
            For :obj:`~pov.enums.MessageEntityType.TEXT_LINK` only, url that will be opened after user taps on the text.

        user (:obj:`~pov.types.User`, *optional*):
            For :obj:`~pov.enums.MessageEntityType.TEXT_MENTION` only, the mentioned user.

        language (``str``, *optional*):
            For "pre" only, the programming language of the entity text.

        custom_emoji_id (``int``, *optional*):
            For :obj:`~pov.enums.MessageEntityType.CUSTOM_EMOJI` only, unique identifier of the custom emoji.
            Use :meth:`~pov.Client.get_custom_emoji_stickers` to get full information about the sticker.
    """
