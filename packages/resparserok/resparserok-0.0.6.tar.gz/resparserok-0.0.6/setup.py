...
setup(
    ...
    packages=find_packages(where="pyresparser"),
    package_dir={"": "pyresparser"},
    install_requires=['attrs==23.1.0', 'blis==0.7.8', 'catalogue==2.0.6', 'certifi==2023.7.22', 'cffi==1.15.1', 'chardet==5.2.0', 'charset-normalizer==3.2.0', 'click==8.1.7', 'confection==0.1.1', 'cryptography==41.0.3', 'cymem==2.0.7', 'docx2txt==0.8', 'en-core-web-sm @ https://github.com/explosion/spacy-models/releases/download/en_core_web_sm-3.6.0/en_core_web_sm-3.6.0-py3-none-any.whl#sha256=83276fc78a70045627144786b52e1f2728ad5e29e5e43916ec37ea9c26a11212', 'idna==3.4', 'Jinja2==3.1.2', 'joblib==1.3.2', 'jsonschema==4.19.0', 'langcodes==3.3.0', 'MarkupSafe==2.1.3', 'murmurhash==1.0.9',
