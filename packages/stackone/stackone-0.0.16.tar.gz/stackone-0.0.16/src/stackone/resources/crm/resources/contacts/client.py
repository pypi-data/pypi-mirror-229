...
from ...types.contact_result import ContactResult
from ...types.contacts_paginated import ContactsPaginated
from ...types.crm_create_contact_request_dto import CrmCreateContactRequestDto
...
class ContactsClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "unified/crm/contacts"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(ContactsPaginated, _response.json())  # type: ignore
    ...
    def crm_contact_post(self, *, request: CrmCreateContactRequestDto, account_id: str) -> ContactResult:
        """
        Parameters:
            - request: CrmCreateContactRequestDto.
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(ContactResult, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
        if _response.status_code == 403:
            raise ForbiddenError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
    ...
    def crm_contacts_get(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"unified/crm/contacts/{id}"),
            params=remove_none_from_dict(
                {
                    "page": page,
                    "page_size": page_size,
    ...
    def crm_contact_patch(self, id: str, *, request: CrmCreateContactRequestDto, account_id: str) -> ContactResult:
        """
        Parameters:
            - id: str.
...
class AsyncContactsClient:
    ...
    async def crm_contact_post(self, *, request: CrmCreateContactRequestDto, account_id: str) -> ContactResult:
        """
        Parameters:
            - request: CrmCreateContactRequestDto.
    ...
    async def crm_contact_patch(
        self, id: str, *, request: CrmCreateContactRequestDto, account_id: str
    ) -> ContactResult:
        """
        Parameters:
            - id: str.
