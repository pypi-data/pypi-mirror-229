...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~pyroplus.types.InputMediaPhoto`, :obj:`~pyroplus.types.InputMediaVideo`, :obj:`~pyroplus.types.InputMediaAudio` and :obj:`~pyroplus.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~pyroplus.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from pyroplus.types import InputMediaPhoto, InputMediaVideo
