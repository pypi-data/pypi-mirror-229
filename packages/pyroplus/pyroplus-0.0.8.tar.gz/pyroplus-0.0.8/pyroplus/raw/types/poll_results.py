...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <pyroplus.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <pyroplus.raw.base.MessageEntity>`, *optional*):
            N/A
