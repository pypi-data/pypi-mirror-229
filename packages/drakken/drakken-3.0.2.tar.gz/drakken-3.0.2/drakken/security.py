...
def create_session_cookie(token):
    ...
    Returns:
        dict: For webob.Response.set_cookie().
    """
...
def create_session_token():
    ...
    return secrets.token_urlsafe(
        config.get('SESSION_TOKEN_BYTES'))
...
def slow_hash(s, salt):
    ...
    Note:
        Uses scrypt: designed to read and write randomly to a lot of memory,
        This kills the advantage ASICs have in cracking passwords and makes
