...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <pyroplus.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <pyroplus.raw.base.Reaction>`, *optional*):
            N/A
