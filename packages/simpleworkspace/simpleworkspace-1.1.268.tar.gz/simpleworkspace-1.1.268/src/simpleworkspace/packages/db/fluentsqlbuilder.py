...
class FluentSqlBuilder:
    ...
    def __init__(self, connection: 'MySQLConnection|MsSqlConnection|Sqlite3Connection'):
        ...
        self._IsStatementDelete = False
        self._IsStatementInsert = False
        self._IsStatementUpdate = False
        self._HasClauseWhere = False
    ...
    def OnDuplicateKeyIgnore(self):
        ...
        if(self._connection_is_SQLITE3):
