...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~pyroplus.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroplus.Client):
                self.add_handler(pyroplus.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroplus.handlers.EditedMessageHandler(func, self),
