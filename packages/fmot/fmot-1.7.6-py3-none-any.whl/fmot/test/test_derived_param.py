...
def base_test_run(model: nn.Module, shape: Tuple[int], batch_dim=0, seq_dim=None, fp_tol=1e-6):
    ...
    if diff > fp_tol:
        raise ValueError(f'Full-precision diff {diff:.3E} was above tolerance {fp_tol:.3E}')
