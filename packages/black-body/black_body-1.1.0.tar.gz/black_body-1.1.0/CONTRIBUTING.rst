...
**black_body** could always use more documentation, whether as
part of the official **black_body** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `black_body` for local
development.

1. Fork the `black_body` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/black_body.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd black_body
    (dvlpt) black_body$ flake8
    (dvlpt) black_body$ pytest
    
    (dvlpt) black_body$ tox
...
Before you submit a pull request, check that it meets these guidelines:
  ...
  3. The pull request should work for Python 3.9, 3.10, 3.11.
...
.. _issues: https://gitlab.com/revesansparole/black_body/issues
