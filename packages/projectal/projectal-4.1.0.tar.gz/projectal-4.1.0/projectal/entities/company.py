...
class Company(Entity, LocationLinker, StaffLinker, CompanyLinker, DepartmentLinker,
              ProjectLinker, FileLinker, ContactLinker, NoteLinker, TagLinker):
    """
    ...
    _links = [LocationLinker, StaffLinker, CompanyLinker, DepartmentLinker,
              ProjectLinker, FileLinker, ContactLinker, NoteLinker, TagLinker]
