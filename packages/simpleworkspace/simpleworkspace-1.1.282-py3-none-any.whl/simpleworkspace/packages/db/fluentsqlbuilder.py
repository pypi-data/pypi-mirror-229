...
class FluentSqlBuilder:
    ...
    def Select(self, *column_names: str):
        ...
        self.Append(f"SELECT " + ', '.join(column_names))
    ...
    def OrderByAscending(self, column_name: str):
        ...
        '''
        return self._OrderBy(column_name, "ASC")
    ...
    def OrderByDescending(self, column_name: str):
        ...
        with more OrderBy* methods.
        '''
        return self._OrderBy(column_name, "DESC")

    def _OrderBy(self, column_name: str, direction: str):
