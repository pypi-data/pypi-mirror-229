...
class RfSettingsCls:
	...
	def get_connector(self) -> enums.RxConnector:
		"""SCPI: ROUTe:LTE:MEASurement<Instance>:RFSettings:CONNector \n
		Snippet: value: enums.RxConnector = driver.route.lteMeas.rfSettings.get_connector() \n
		No command help available \n
			:return: connector: No help available
		"""
		response = self._core.io.query_str('ROUTe:LTE:MEASurement<Instance>:RFSettings:CONNector?')
		return Conversions.str_to_scalar_enum(response, enums.RxConnector)

	def set_connector(self, connector: enums.RxConnector) -> None:
		"""SCPI: ROUTe:LTE:MEASurement<Instance>:RFSettings:CONNector \n
		Snippet: driver.route.lteMeas.rfSettings.set_connector(connector = enums.RxConnector.I11I) \n
		No command help available \n
			:param connector: No help available
		"""
		param = Conversions.enum_scalar_to_str(connector, enums.RxConnector)
		self._core.io.write(f'ROUTe:LTE:MEASurement<Instance>:RFSettings:CONNector {param}')
