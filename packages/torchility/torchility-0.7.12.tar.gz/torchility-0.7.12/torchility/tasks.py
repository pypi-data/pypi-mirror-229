...
class GeneralTaskModule(LightningModule):
    def __init__(self, model, loss=None, optimizer=None, metrics=None, **kwargs):
        ...
        if loss is not None:
            ...
            print("\033[0;34;mThe default loss function is used. Make sure the model returns a loss value.\033[0m")
        if optimizer is not None:
            self.opt = optimizer
        else:
            self.opt = Adam(model.parameters(), lr=0.001)
            print("\033[0;34;mThe Adam optimizer is used with learning rate of 0.001.\033[0m")
