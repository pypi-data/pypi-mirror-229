...
setup(
  ...
  download_url = 'https://github.com/keanteng/blueautomata/archive/refs/tags/v_0.5.tar.gz',    # I explain this later on
  keywords = ['automation', 'vba', 'reporting', 'automate'],   # Keywords that define your package best
  install_requires=['pandas','win32com.client','fuzzywuzzy','python-Levenshtein'],
  classifiers=[
