...
gopy build -no-make -dynamic-link=True -symbols=False -output /project/build/lib.linux-aarch64-cpython-310/dither_go/bindings -vm /tmp/build-env-1m3lqi77/bin/python ./dither_go github.com/tfuxu/dither-gopy
*/
