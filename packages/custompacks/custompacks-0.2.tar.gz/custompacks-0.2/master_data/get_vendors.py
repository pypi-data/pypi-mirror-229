from custompacks import TxtParser
class GetVendors:
...
if __name__ == '__main__':
    parse_data = GetVendors(filepath=r'V:\Findep\Incoming\test\DevOps\References\LFA1 22082023.txt',
                            value='LIFNR').further_process().set_index("LIFNR").T.to_dict()

    print(parse_data.get("101555"))
