...
class Project(Entity,  LocationLinker, CustomerLinker, FileLinker, StageLinker,
              RebateLinker, StageListLinker, CompanyLinker, NoteLinker, TagLinker,
              TaskInProjectLinker):
    """
    ...
    _path = 'project'
    _name = 'project'
    _links = [LocationLinker, CustomerLinker, FileLinker, StageLinker,
              RebateLinker, StageListLinker, NoteLinker, TagLinker,
              TaskInProjectLinker]
