...
if __name__ == '__main__':
    ...
    headers = {'Authorization': 'Bearer dba3a982082980f9df86ad02c77f58e0'}
    ics = IcsInterface('liwei@inhand.com.cn', '123456', 'beta.inconnect.design', proxy=True, headers=headers)
    devices = ics.find_device(connected=False, online=1)
    print([device.get('serialNumber') for device in devices])
