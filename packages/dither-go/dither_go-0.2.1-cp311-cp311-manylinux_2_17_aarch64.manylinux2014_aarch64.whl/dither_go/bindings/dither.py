...
# gopy build -no-make -dynamic-link=True -symbols=False -output /project/build/lib.linux-aarch64-cpython-311/dither_go/bindings -vm /tmp/build-env-n0zk6rku/bin/python ./dither_go github.com/tfuxu/dither-gopy
