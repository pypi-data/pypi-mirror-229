...
from glean.api.analytics import track
from glean.api.analytics.cli_with_tracking import (
    CommandWithTracking,
    GroupWithTracking,
    set_raw_command,
)
from glean.api.analytics.events import (
...
def main():
    ...
    with cli_error_boundary(debug=GLEAN_DEBUG):
        ...
        click.echo(
            click.style(
            "🚨 Glean is now Hashboard!\nGlean CLI is now deprecated. Please install our new hashboard-cli package instead!\n", fg="red"
            )
            )
