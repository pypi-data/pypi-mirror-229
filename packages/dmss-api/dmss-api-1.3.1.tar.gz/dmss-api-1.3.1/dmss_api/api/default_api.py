...
class DefaultApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __validate_existing_entity(
            self,
            address,
            **kwargs
        ):
        ...
        self.validate_existing_entity = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [
                    'APIKeyHeader',
            ...
            api_client=api_client,
            callable=__validate_existing_entity
        )
