...
def getheaders(host,method="GET",params={},headers={},timeout=15):
...
def history(host,method="GET",params={},headers={},timeout=15):
    path = urllib.parse.urlparse(host).scheme + "://" + urllib.parse.urlparse(host).netloc
    path = host.replace(path, "")
...
def status_code(host,method="GET",params={},headers={},timeout=15):
    path = urllib.parse.urlparse(host).scheme + "://" + urllib.parse.urlparse(host).netloc
    path = host.replace(path, "")
...
def text(host,method="GET",params={},headers={},timeout=15):
    path = urllib.parse.urlparse(host).scheme + "://" + urllib.parse.urlparse(host).netloc
    path = host.replace(path, "")
