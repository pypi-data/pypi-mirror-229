   ...
   if select_all_len > 0:
      ...
      for index in range(select_all_len):
         ...
         if status == "true" and chek == "false":
               ...
               print("plan 111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111")
       
               point_open = mt5.copy_rates_from(self.symbol_EURUSD, mt5.TIMEFRAME_M1, timestamp_pulback , 1)
               point_open = "{:.5f}".format(point_open[0][1])
               point_open = float(point_open)
               # print ("point_open:" , point_open)

               point_close = mt5.copy_rates_from(self.symbol_EURUSD, mt5.TIMEFRAME_M1, timestamp_pulback , 1)
               point_close = "{:.5f}".format(point_close[0][4])
               point_close = float(point_close)
               # print ("point_close:" , point_close)
       
               point_high = mt5.copy_rates_from(self.symbol_EURUSD, mt5.TIMEFRAME_M1, timestamp_pulback , 1)
               point_high = "{:.5f}".format(point_high[0][2])
               point_high = float(point_high)
               # print ("point_high:" , point_high)
       
               point_low = mt5.copy_rates_from(self.symbol_EURUSD, mt5.TIMEFRAME_M1, timestamp_pulback , 1)
               point_low = "{:.5f}".format (point_low[0][3])
               point_low = float(1.07989)
                     ...
                     if (point_close != point_high and candel_statess == "green") or (point_open != point_low and candel_statess == "red"):
                         ...
                         if point_high == cal_point and type == "Two_TOP" and chek == "false":
                                 ...
                                 if status_trade == True:
                                     print("shakhes: True" )
                                     rec_pos = BUY_SELL.pos_sell( shakhes , lot , self.symbol_EURUSD , commands)
                                     execution = rec_pos.comment
                                     if execution == 'Request executed':
                                            ticket =  rec_pos.order
                                            print("rec_pos:" , rec_pos)
                                            print("ticket:" , ticket)
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(High:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'
                                 ...
                                 if status_trade == True:
                                     ...
                                     if execution == 'Request executed':
                                            ...
                                            print("rec_pos:" , rec_pos)
                                            print("ticket:" , ticket)
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(telo_add_high:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'
                                 ...
                                 if status_trade == True:
                                     ...
                                     if execution == 'Request executed':
                                            ...
                                            print("rec_pos:" , rec_pos)
                                            print("ticket:" , ticket)
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(telo_sub_high:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'
                                 ...
                                 if status_trade == True:
                                     print("shakhes: True" )
                                     rec_pos = BUY_SELL.pos_buy( shakhes , lot , self.symbol_EURUSD , commands)
                                     execution = rec_pos.comment
                                     if execution == 'Request executed':
                                            ticket =  rec_pos.order
                                            print("rec_pos:" , rec_pos)
                                 ...
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(Sub:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'
                                 ...
                                 if status_trade == True:
                                     ...
                                     if execution == 'Request executed':
                                            ...
                                            print("rec_pos:" , rec_pos)
                                            print("ticket:" , ticket)
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(telo_sub_low:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'
                                 ...
                                 if status_trade == True:
                                     ...
                                     if execution == 'Request executed':
                                            ...
                                            print("rec_pos:" , rec_pos)
                                            print("ticket:" , ticket)
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(telo_add_low:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'
       ...
       if select_all_len > 0:
          ...
          for index in range(select_all_len):
                    ...
                    if status == "true" and chek == "false":
                        ...
                        inputs_close = mt5.copy_rates_range(self.symbol_EURUSD, mt5.TIMEFRAME_M1, time_start_search, timestamp_pulback)
                    ...
                    #     list_timestamp_plan2 = [1693473300, 1693473360, 1693473420, 1693473480, 1693473540, 1693473600, 1693473660, 1693473720, 1693473780, 1693473840, 1693473900]   
                        ...
                        #    try:            
                               ...
                               print("plan 222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222")
                                                 ...
                                                 if close_plan2 == cal_point and (candel_state_plan2 == "green" or  candel_state_plan2 == "doji") and close_plan2 > left_candel_plan2 and close_plan2 > right_candel_plan2 and type == "Two_TOP":
                                                            ...
                                                            if status_trade == True:
                                                                 ...
                                                                 if execution == 'Request executed':
                                                                        ...
                                                                        print("rec_pos:" , rec_pos)
                                                                        print("ticket:" , ticket)
                                                            command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{2})'+ " _ " + "(Point5:" + f'{close_plan2})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' 
                                                            ...
                                                            if status_trade == True:
                                                                 ...
                                                                 if execution == 'Request executed':
                                                                        ...
                                                                        print("rec_pos:" , rec_pos)
                                                                        print("ticket:" , ticket)
                                                            command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{2})'+ " _ " + "(Point5:" + f'{telo_add_close_high})' + " _ " + "(Time:" + f'{time_command})'+ " _ " + "(telo_high:" + f'{tel})' + "_" + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' 
                                                            ...
                                                            command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{2})'+ " _ " + "(Point5:" + f'{telo_sub_close_low})' + " _ " + "(Time:" + f'{time_command})'+ " _ " + "(telo_low:" + f'{tel})' + "_" + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' 
                                                            ...
                                                            if status_trade == True:
                                                                 ...
                                                                 if execution == 'Request executed':
                                                                        ...
                                                                        print("rec_pos:" , rec_pos)
                                                                        print("ticket:" , ticket)
                                                            command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{2})'+ " _ " + "(Point5:" + f'{telo_add_close_high})' + " _ " + "(Time:" + f'{time_command})'+ " _ " + "(Telo_high-1-2:" + f'{tel})' + "_" + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'
                                                            Database.update_table_chek(telo_sub_close_low , timestamp_pulback , command , "true" , ticket , candel_num)     
                                                            ...
                                                            if status_trade == True:
                                                                 ...
                                                                 if execution == 'Request executed':
                                                                        ...
                                                                        print("rec_pos:" , rec_pos)
                                                                        print("ticket:" , ticket)
                                                            command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{2})'+ " _ " + "(Point5:" + f'{telo_add_close_high})' + " _ " + "(Time:" + f'{time_command})'+ " _ " + "(Telo_high-2-1:" + f'{tel})' + "_" + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'
                                                            Database.update_table_chek(telo_add_close_high , timestamp_pulback , command , "true" , ticket , candel_num)     
                                      ...
                                      if point_close_3 == cal_point and point_close_3 > left_candel and point_close_3 > right_candel and type == "Two_TOP" and chek == "false":
                                           ...
                                           if status_trade == True:
                                                ...
                                                if execution == 'Request executed':
                                                   ...
                                                   print("rec_pos:" , rec_pos)
                                                   print("ticket:" , ticket)
                                           command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{3})'+ " _ " + "(Point5:" + f'{point_close_3})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' 
 ...
 def pullback_4 (self , tel , status_tel , timestamp_pulback , lot):
           ...
           if select_all_len > 0:
              ...
              for index in range(select_all_len):
                 ...
                 timestamp_pulback_p = timestamp_pulback - 60
                 timestamp_pullback_n = timestamp_pulback + 60
                                    ...
                                    if point_open == cal_point:
                                           ...
                                           if status_trade == True:
                                                ...
                                                if execution == 'Request executed':
                                                   ...
                                                   print("rec_pos:" , rec_pos)
                                                   print("ticket:" , ticket)
                                           command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{4})'+ " _ " + "(Point5:" + f'{point_open})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(candel_state: red" + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' 
                                    ...
                                    if point_open == cal_point:
                                           ...
                                           if status_trade == True:
                                                ...
                                                if execution == 'Request executed':
                                                   ...
                                                   print("rec_pos:" , rec_pos)
                                                   print("ticket:" , ticket)
                                           command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{4})'+ " _ " + "(Point5:" + f'{point_open})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(candel_state: green" + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' 
                                           Database.update_table_chek(point_open , timestamp_pulback , command , "true" , ticket , candel_num)     
                                    ...
                                    if point_open == cal_point:
                                           ...
                                           if status_trade == True:
                                                ...
                                                if execution == 'Request executed':
                                                   ...
                                                   print("rec_pos:" , rec_pos)
                                                   print("ticket:" , ticket)
                                           command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{4})'+ " _ " + "(Point5:" + f'{point_open})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(candel_state: doji"  + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' 
                                           Database.update_table_chek(point_open , timestamp_pulback , command , "true" , ticket , candel_num)        
