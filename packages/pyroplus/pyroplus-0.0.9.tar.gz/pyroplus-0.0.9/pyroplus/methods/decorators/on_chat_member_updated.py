...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~pyroplus.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroplus.Client):
                self.add_handler(pyroplus.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroplus.handlers.ChatMemberUpdatedHandler(func, self),
