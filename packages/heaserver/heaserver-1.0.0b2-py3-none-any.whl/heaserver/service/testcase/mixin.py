...
class _ActivityCheckerMixin(_CheckerMixin):
    ...
    async def check_activity(self):
        ...
        await self._check(image_substring='heaserver-activity', path='desktopobjectactions', check_fn=check_fn)
...
class DeleteActivityMixin(_ActivityCheckerMixin):
    ...
    async def test_delete_check_activity(self):
        async with self.client.request('DELETE', (self._href / self.expected_one_id()).path, headers=self._headers):
            pass
