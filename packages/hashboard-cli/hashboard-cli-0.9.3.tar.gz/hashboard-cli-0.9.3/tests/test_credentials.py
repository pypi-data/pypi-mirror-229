...
def test_get_valid_credentials_using_env(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setenv("HB_PROJECT_ID", "test-project-from-env")
    monkeypatch.setenv("HB_ACCESS_KEY_ID", "test-access-key-id-from-env")
    monkeypatch.setenv("HB_SECRET_ACCESS_KEY_TOKEN", "test-access-key-token-from-env")
