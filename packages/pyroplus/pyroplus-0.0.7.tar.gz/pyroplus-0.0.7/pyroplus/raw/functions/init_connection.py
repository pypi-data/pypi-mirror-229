...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~pyroplus.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <pyroplus.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <pyroplus.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~pyroplus.raw.types`
    """
