...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <pyroplus.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <pyroplus.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <pyroplus.raw.base.PremiumSubscriptionOption>`):
            N/A
