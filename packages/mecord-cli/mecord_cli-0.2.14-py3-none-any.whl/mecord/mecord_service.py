    ...
    def executeLocalPython(self, taskUUID, cmd, param):
        ...
        try:
            ...
            if process.returncode == 0:
                ...
                print(f"{o1}\n{o2}")
                print("======================     end      ======================")
                utils.notifyScriptError(taskUUID, cmd, f"{o1}\n{o2}")
        except subprocess.CalledProcessError as e:
            print("====================== process error ======================")
            print(e)
            print("======================      end      ======================")
            utils.notifyScriptError(taskUUID, cmd, e)
        ...
        try:
            ...
            for it in datas:
                ...
                if xy_pb.TaskNotify(taskUUID, 
                    ...
                    print(f"task : {taskUUID} notify server success")
                else:
                    print(f"task : {taskUUID} server fail~~")
