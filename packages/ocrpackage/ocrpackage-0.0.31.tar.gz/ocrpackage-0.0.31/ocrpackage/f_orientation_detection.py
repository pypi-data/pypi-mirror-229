...
def import_haarcascade():
    detect_frontal_face = resource_filename('ocrpackage', 'haarcascades/haarcascade_frontalface_alt.xml')
    detect_perfil_face = resource_filename('ocrpackage', 'haarcascades//haarcascade_profileface.xml')
