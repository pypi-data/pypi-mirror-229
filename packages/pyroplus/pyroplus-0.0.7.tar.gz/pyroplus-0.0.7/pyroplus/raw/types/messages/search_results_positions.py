...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <pyroplus.raw.base.SearchResultsPosition>`):
            N/A
