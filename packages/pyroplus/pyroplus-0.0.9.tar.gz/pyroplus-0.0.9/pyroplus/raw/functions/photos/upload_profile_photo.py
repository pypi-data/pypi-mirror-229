...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <pyroplus.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <pyroplus.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <pyroplus.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <pyroplus.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <pyroplus.raw.base.photos.Photo>`
    """
