...
# gopy build -no-make -dynamic-link=True -symbols=False -output /project/build/lib.linux-x86_64-cpython-311/dither_go/bindings -vm /tmp/build-env-aaqdz7uh/bin/python ./dither_go github.com/tfuxu/dither-gopy
