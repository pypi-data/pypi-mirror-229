...
BYTES_PER_ELEMENT = dict(fqint4=0.5, fqint8=1, fqint16=2, 
    fqint4_fp=0.5, fqint8_fp=1, fqint16_fp=2)
...
class TensorProto(VariableBase):
    ...
    """
    def __init__(self, name, dtype, shape, avg_sparsity=None, value=None,
        quanta=None, density_per_element=None, named_dims=None):
    ...
    def from_tensor(cls, x, name, store_value=False):
        ...
        proto = cls(name, dtype, list(x.shape), avg_sparsity, val, quanta,
            density_per_element, named_dims)
        return proto