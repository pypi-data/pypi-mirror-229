...
import pyroplus
from pyroplus.methods.utilities.idle import idle
...
class Run:
    def run(
        ...
        :meth:`~pyroplus.Client.start`, :meth:`~pyroplus.idle` and :meth:`~pyroplus.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`pyroplus.compose`.
