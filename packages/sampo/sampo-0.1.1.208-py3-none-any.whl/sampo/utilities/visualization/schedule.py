...
def schedule_gant_chart_fig(schedule_dataframe: pd.DataFrame,
    ...
    schedule_dataframe['vis_start'] = schedule_dataframe['start'] - timedelta(1)
    ...
    fig = px.timeline(schedule_dataframe, x_start='vis_start', x_end='finish', y='idx', hover_name='task_name',
