...
class PersonFixtureStatisticsApi(object):
    ...
    def fps_list(
        ...
        **kwargs
        ...
        >>> thread = api.fps_list(fixture_id, organization_id, sport, added, entity_id, external, fields, hide_null, include, is_player, is_team_official, limit, offset, person_id, starter, updated, async_req=True)
        >>> result = thread.get()
    ...
    def fps_listlive(
        ...
        **kwargs
        ...
        >>> thread = api.fps_listlive(fixture_id, organization_id, sport, added, entity_id, external, fields, hide_null, include, is_player, is_team_official, limit, offset, person_id, starter, updated, async_req=True)
        >>> result = thread.get()
