...
from process_twarc.util import  load_dict, load_tokenizer, load_model, concat_dataset, get_all_files
...
def MLM_sweep(
    ...
    raw_datasets = concat_dataset(get_all_files(data_dir), output_type="Dataset")
    splits = generate_splits(raw_datasets)
