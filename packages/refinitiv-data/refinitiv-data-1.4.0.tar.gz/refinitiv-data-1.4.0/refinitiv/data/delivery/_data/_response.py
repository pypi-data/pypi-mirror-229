...
class Response(Generic[TypeData]):
    ...
    def request_message(self):
        warnings.warn(
            "The request_message property will be removed in future versions of the library (2.x). "
    ...
    def http_response(self):
        warnings.warn(
            "The http_response property will be removed in future versions of the library (2.x). "
            "Please use raw instead.",
            category=DeprecationWarning,
        )
    ...
    def http_headers(self):
        warnings.warn(
            "The http_headers property will be removed in future versions of the library (2.x). "
    ...
    def http_status(self):
        warnings.warn(
            "The http_status property will be removed in future versions of the library (2.x). "
