...
class WriteAccessAllowed(BaseModel):
    ...
    messages after adding the bot to the attachment menu or launching a Web App from a
    link.
    """
...
class KeyboardButtonRequestUser(BaseModel):
    ...
    pressed. More about requesting users »
    """
...
class KeyboardButtonRequestChat(BaseModel):
    ...
    pressed. More about requesting chats »
    """
