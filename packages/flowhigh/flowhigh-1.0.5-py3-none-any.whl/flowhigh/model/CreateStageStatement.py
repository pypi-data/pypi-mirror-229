...
class CreateStageStatement(Statement, TypeCast):
    dialExt: DbExt = None
    type_: str = None
...
class CreateStageStatementBuilder (object):
    construction: CreateStageStatement
    

    def __init__(self) -> None:
        super().__init__()
        self.construction = CreateStageStatement()
