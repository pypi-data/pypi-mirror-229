...
def get_transform(train, weights=None, test_only=False):
    if train:
        return SegmentationPresetTrain(base_size=520, crop_size=480)
        ...
        return SegmentationPresetEval(base_size=520)
