...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <pyroplus.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <pyroplus.raw.base.MessagePeerReaction>`, *optional*):
            N/A
