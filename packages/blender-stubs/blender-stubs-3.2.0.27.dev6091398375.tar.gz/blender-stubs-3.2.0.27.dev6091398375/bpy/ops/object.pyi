...
def geometry_nodes_input_attribute_toggle(input_name: str = '', modifier_name: str = '') -> None:
...
def modifier_add_asset(asset_library_type: str = 'LOCAL', asset_library_identifier: str = '', relative_asset_identifier: str = '') -> None:
