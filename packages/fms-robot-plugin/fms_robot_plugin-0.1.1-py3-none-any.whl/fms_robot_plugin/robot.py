...
from fms_robot_plugin.typings import LaserScan, Twist, CompressedImage
...
class Robot:
    ...
    def set_camera_feed(self, data: CompressedImage):
        self.mqtt.publish(f"robots/{self.robot_key}/camera", data.dict())
