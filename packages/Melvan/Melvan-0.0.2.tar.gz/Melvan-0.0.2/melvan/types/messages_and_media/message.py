...
import melvan
from melvan import raw, enums
from melvan import types
from melvan import utils
from melvan.errors import MessageIdsEmpty, PeerIdInvalid
from melvan.parser import utils as parser_utils, Parser
...
class Message(Object, Update):
    ...
    Parameters:
        ...
        from_user (:obj:`~melvan.types.User`, *optional*):
            Sender, empty for messages sent to channels.

        sender_chat (:obj:`~melvan.types.Chat`, *optional*):
        ...
        chat (:obj:`~melvan.types.Chat`, *optional*):
            Conversation the message belongs to.

        forward_from (:obj:`~melvan.types.User`, *optional*):
        ...
        forward_from_chat (:obj:`~melvan.types.Chat`, *optional*):
        ...
        reply_to_message (:obj:`~melvan.types.Message`, *optional*):
        ...
        service (:obj:`~melvan.enums.MessageServiceType`, *optional*):
        ...
        media (:obj:`~melvan.enums.MessageMediaType`, *optional*):
        ...
        entities (List of :obj:`~melvan.types.MessageEntity`, *optional*):
            For text messages, special entities like usernames, URLs, bot commands, etc. that appear in the text.

        caption_entities (List of :obj:`~melvan.types.MessageEntity`, *optional*):
            For messages with a caption, special entities like usernames, URLs, bot commands, etc. that appear
            in the caption.

        audio (:obj:`~melvan.types.Audio`, *optional*):
            Message is an audio file, information about the file.

        document (:obj:`~melvan.types.Document`, *optional*):
            Message is a general file, information about the file.

        photo (:obj:`~melvan.types.Photo`, *optional*):
            Message is a photo, information about the photo.

        sticker (:obj:`~melvan.types.Sticker`, *optional*):
            Message is a sticker, information about the sticker.

        animation (:obj:`~melvan.types.Animation`, *optional*):
            Message is an animation, information about the animation.

        game (:obj:`~melvan.types.Game`, *optional*):
            Message is a game, information about the game.

        video (:obj:`~melvan.types.Video`, *optional*):
            Message is a video, information about the video.

        voice (:obj:`~melvan.types.Voice`, *optional*):
            Message is a voice message, information about the file.

        video_note (:obj:`~melvan.types.VideoNote`, *optional*):
        ...
        contact (:obj:`~melvan.types.Contact`, *optional*):
            Message is a shared contact, information about the contact.

        location (:obj:`~melvan.types.Location`, *optional*):
            Message is a shared location, information about the location.

        venue (:obj:`~melvan.types.Venue`, *optional*):
            Message is a venue, information about the venue.

        web_page (:obj:`~melvan.types.WebPage`, *optional*):
            Message was sent with a webpage preview.

        poll (:obj:`~melvan.types.Poll`, *optional*):
            Message is a native poll, information about the poll.

        dice (:obj:`~melvan.types.Dice`, *optional*):
            A dice containing a value that is randomly generated by Telegram.

        new_chat_members (List of :obj:`~melvan.types.User`, *optional*):
            New members that were added to the group or supergroup and information about them
            (the bot itself may be one of these members).

        left_chat_member (:obj:`~melvan.types.User`, *optional*):
            A member was removed from the group, information about them (this member may be the bot itself).

        new_chat_title (``str``, *optional*):
            A chat title was changed to this value.

        new_chat_photo (:obj:`~melvan.types.Photo`, *optional*):
        ...
        pinned_message (:obj:`~melvan.types.Message`, *optional*):
            Specified message was pinned.
            Note that the Message object in this field will not contain further reply_to_message fields even if it
            is itself a reply.

        game_high_score (:obj:`~melvan.types.GameHighScore`, *optional*):
	...
	forwards (``int``, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the text of this message. Only applicable when using :obj:`Filters.regex <melvan.Filters.regex>`.

        command (List of ``str``, *optional*):
            A list containing the command and its arguments, if any.
            E.g.: "/start 1 2 3" would produce ["start", "1", "2", "3"].
            Only applicable when using :obj:`~melvan.filters.command`.

        video_chat_scheduled (:obj:`~melvan.types.VideoChatScheduled`, *optional*):
            Service message: voice chat scheduled.

        video_chat_started (:obj:`~melvan.types.VideoChatStarted`, *optional*):
            Service message: the voice chat started.

        video_chat_ended (:obj:`~melvan.types.VideoChatEnded`, *optional*):
            Service message: the voice chat has ended.

        video_chat_members_invited (:obj:`~melvan.types.VoiceChatParticipantsInvited`, *optional*):
            Service message: new members were invited to the voice chat.

        web_app_data (:obj:`~melvan.types.WebAppData`, *optional*):
            Service message: web app data sent to the bot.

        reply_markup (:obj:`~melvan.types.InlineKeyboardMarkup` | :obj:`~melvan.types.ReplyKeyboardMarkup` | :obj:`~melvan.types.ReplyKeyboardRemove` | :obj:`~melvan.types.ForceReply`, *optional*):
            Additional interface options. An object for an inline keyboard, custom reply keyboard,
            instructions to remove reply keyboard or to force a reply from the user.

        reactions (List of :obj:`~melvan.types.Reaction`):
    ...
    async def get_media_group(self) -> List["types.Message"]:
        """Bound method *get_media_group* of :obj:`~melvan.types.Message`.
        ...
        Returns:
            List of :obj:`~melvan.types.Message`: On success, a list of messages of the media group is returned.
    ...
    async def reply_text(
        ...
        """Bound method *reply_text* of :obj:`~melvan.types.Message`.
        ...
        Parameters:
            ...
            parse_mode (:obj:`~melvan.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            entities (List of :obj:`~melvan.types.MessageEntity`):
    ...
    async def reply_animation(
        ...
        """Bound method *reply_animation* :obj:`~melvan.types.Message`.
        ...
        Parameters:
            ...
            caption_entities (List of :obj:`~melvan.types.MessageEntity`):
        ...
        Returns:
            On success, the sent :obj:`~melvan.types.Message` is returned.
            In case the upload is deliberately stopped with :meth:`~melvan.Client.stop_transmission`, None is returned
            instead.
    ...
    async def reply_audio(
        ...
        """Bound method *reply_audio* of :obj:`~melvan.types.Message`.
    ...
    async def reply_cached_media(
        ...
        """Bound method *reply_cached_media* of :obj:`~melvan.types.Message`.
    ...
    async def reply_chat_action(self, action: "enums.ChatAction") -> bool:
        """Bound method *reply_chat_action* of :obj:`~melvan.types.Message`.

        Use as a shortcut for:

        .. code-block:: python

            from melvan import enums
        ...
        Parameters:
            action (:obj:`~melvan.enums.ChatAction`):
    ...
    async def reply_contact(
        ...
        """Bound method *reply_contact* of :obj:`~melvan.types.Message`.
    ...
    async def reply_document(
        ...
        """Bound method *reply_document* of :obj:`~melvan.types.Message`.
    ...
    async def reply_game(
        ...
        """Bound method *reply_game* of :obj:`~melvan.types.Message`.
        ...
        Parameters:
            ...
            reply_markup (:obj:`~melvan.types.InlineKeyboardMarkup`, *optional*):
    ...
    async def reply_inline_bot_result(
        ...
        """Bound method *reply_inline_bot_result* of :obj:`~melvan.types.Message`.
    ...
    async def reply_location(
        ...
        """Bound method *reply_location* of :obj:`~melvan.types.Message`.
    ...
    async def reply_media_group(
        ...
        """Bound method *reply_media_group* of :obj:`~melvan.types.Message`.
        ...
        Parameters:
            media (``list``):
                A list containing either :obj:`~melvan.types.InputMediaPhoto` or
                :obj:`~melvan.types.InputMediaVideo` objects
        ...
        Returns:
            On success, a :obj:`~melvan.types.Messages` object is returned containing all the
    ...
    async def reply_photo(
        ...
        """Bound method *reply_photo* of :obj:`~melvan.types.Message`.
    ...
    async def reply_poll(
        ...
        """Bound method *reply_poll* of :obj:`~melvan.types.Message`.
        ...
        Parameters:
            ...
            type (:obj`~melvan.enums.PollType`, *optional*):
                Poll type, :obj:`~melvan.enums.PollType.QUIZ` or :obj:`~melvan.enums.PollType.REGULAR`.
                Defaults to :obj:`~melvan.enums.PollType.REGULAR`.
            ...
            explanation_parse_mode (:obj:`~melvan.enums.ParseMode`, *optional*):
                By default, texts are parsed using both Markdown and HTML styles.
                You can combine both syntaxes together.

            explanation_entities (List of :obj:`~melvan.types.MessageEntity`):
    ...
    async def reply_sticker(
        ...
        """Bound method *reply_sticker* of :obj:`~melvan.types.Message`.
    ...
    async def reply_venue(
        ...
        """Bound method *reply_venue* of :obj:`~melvan.types.Message`.
    ...
    async def reply_video(
        ...
        """Bound method *reply_video* of :obj:`~melvan.types.Message`.
    ...
    async def reply_video_note(
        ...
        """Bound method *reply_video_note* of :obj:`~melvan.types.Message`.
    ...
    async def reply_voice(
        ...
        """Bound method *reply_voice* of :obj:`~melvan.types.Message`.
    ...
    async def edit_text(
        ...
        """Bound method *edit_text* of :obj:`~melvan.types.Message`.
        ...
        Returns:
            On success, the edited :obj:`~melvan.types.Message` is returned.
    ...
    async def edit_caption(
        ...
        """Bound method *edit_caption* of :obj:`~melvan.types.Message`.
    ...
    async def edit_media(
        ...
        """Bound method *edit_media* of :obj:`~melvan.types.Message`.
        ...
        Parameters:
            media (:obj:`~melvan.types.InputMedia`):
    ...
    async def edit_reply_markup(self, reply_markup: "types.InlineKeyboardMarkup" = None) -> "Message":
        """Bound method *edit_reply_markup* of :obj:`~melvan.types.Message`.
        ...
        Parameters:
            reply_markup (:obj:`~melvan.types.InlineKeyboardMarkup`):
                An InlineKeyboardMarkup object.

        Returns:
            On success, if edited message is sent by the bot, the edited
            :obj:`~melvan.types.Message` is returned, otherwise True is returned.
    ...
    async def forward(
        ...
        """Bound method *forward* of :obj:`~melvan.types.Message`.
    ...
    async def copy(
        ...
        """Bound method *copy* of :obj:`~melvan.types.Message`.
        ...
        Returns:
            :obj:`~melvan.types.Message`: On success, the copied message is returned.
    ...
    async def delete(self, revoke: bool = True):
        """Bound method *delete* of :obj:`~melvan.types.Message`.
    ...
    async def click(self, x: Union[int, str] = 0, y: int = None, quote: bool = None, timeout: int = 10):
        """Bound method *click* of :obj:`~melvan.types.Message`.
        ...
        Returns:
            -   The result of :meth:`~melvan.Client.request_callback_answer` in case of inline callback button clicks.
    ...
    async def react(self, emoji: str = "", big: bool = False) -> bool:
        """Bound method *react* of :obj:`~melvan.types.Message`.
    ...
    async def retract_vote(
        ...
        """Bound method *retract_vote* of :obj:`~melvan.types.Message`.
        ...
        Returns:
            :obj:`~melvan.types.Poll`: On success, the poll with the retracted vote is returned.
    ...
    async def download(
        ...
        """Bound method *download* of :obj:`~melvan.types.Message`.
    ...
    async def vote(
        ...
        """Bound method *vote* of :obj:`~melvan.types.Message`.
        ...
        Returns:
            :obj:`~melvan.types.Poll`: On success, the poll with the chosen option is returned.
    ...
    async def pin(self, disable_notification: bool = False, both_sides: bool = False) -> "types.Message":
        """Bound method *pin* of :obj:`~melvan.types.Message`.
        ...
        Returns:
            :obj:`~melvan.types.Message`: On success, the service message is returned.
    ...
    async def unpin(self) -> bool:
        """Bound method *unpin* of :obj:`~melvan.types.Message`.
    ...
    async def ask(
        ...
        """Bound method *ask* of :obj:`~melvan.types.Message`.
        ...
        Parameters:
            ...
            timeout (``int``, *optional*):
                Timeout in seconds.
        Returns:
            :obj:`~melvan.types.Message`: On success, the reply message is returned.
        Raises:
            RPCError: In case of a Telegram RPC error.
