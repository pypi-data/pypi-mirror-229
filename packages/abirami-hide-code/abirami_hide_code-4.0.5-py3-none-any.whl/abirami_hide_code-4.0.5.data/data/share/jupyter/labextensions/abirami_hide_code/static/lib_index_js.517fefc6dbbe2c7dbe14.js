"use strict";
(self["webpackChunkabirami_hide_code"] = self["webpackChunkabirami_hide_code"] || []).push([["lib_index_js"],{
...
.fontawesome-colors:hover {
  color: white;
}`, "",{"version":3,"sources":["webpack://./style/base.css"],"names":[],"mappings":"AAAA;;;;CAIC;;AAED;EACE,uBAAuB;EACvB,YAAY;AACd;;AAEA;EACE,YAAY;AACd","sourcesContent":["/*\n    See the JupyterLab Developer Guide for useful CSS Patterns:\n\n    https://jupyterlab.readthedocs.io/en/stable/developer/css.html\n*/\n\n.fontawesome-colors {\n  background-color: white;\n  color: white;\n}\n\n.fontawesome-colors:hover {\n  color: white;\n}"],"sourceRoot":""}]);
// Exports
...
class ButtonExtension {
    createNew(panel, context) {
        ...
        const buttonHideInput = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ToolbarButton({
            className: 'myButton',
            iconClass: 'fa fa-xl fa-eye-slash fontawesome-colors fa-inverse',
            onClick: hideInputCode,
            tooltip: 'Hide Input'
        });
        const buttonShowInput = new _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ToolbarButton({
            className: 'myButton',
            iconClass: 'fa fa-xl fa-eye fontawesome-colors fa-inverse',
...
//# sourceMappingURL=lib_index_js.517fefc6dbbe2c7dbe14.js.map