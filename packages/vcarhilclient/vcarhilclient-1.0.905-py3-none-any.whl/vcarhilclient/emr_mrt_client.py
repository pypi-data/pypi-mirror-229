...
class Emr_mrt_client(mrt_client):
    ...
    def write_input_port_value(self, env_name, instance_name, port_name, signal_value,**sub_struct_detail):
        pro = hil_project(mrt_client.get_ipr_by_emr_envName(env_name))
        env_pro_name = mrt_client.get_env_by_emr_envName(env_name)
        signal_type,item_count,st_id,struct_name = pro.get_dataType_itemcount(instance_name,"inputport",port_name)
    ...
    def read_input_port_value(self, env_name, instance_name, port_name,**sub_struct_detail):
        pro = hil_project(mrt_client.get_ipr_by_emr_envName(env_name))
        env_pro_name = mrt_client.get_env_by_emr_envName(env_name)
        signal_type, item_count, st_id, struct_name = pro.get_dataType_itemcount(instance_name, "inputport", port_name)
        struct_detail = pro.get_struct_detail(instance_name, struct_name)
