...
def create_iplist(quant):
    ...
    print(f" IPs... with {str(os.cpu_count())} CPU(s)")
    return a_list
...
if __name__ == "__main__":
    ...
    print("It is normal to have 0.5% to 1% of divergence. Remembering that the source of GeoIP2Fast ")
