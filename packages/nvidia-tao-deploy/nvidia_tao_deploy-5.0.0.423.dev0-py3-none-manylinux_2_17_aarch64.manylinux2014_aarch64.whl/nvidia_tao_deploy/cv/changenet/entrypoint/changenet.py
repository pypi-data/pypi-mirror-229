...
import argparse
from nvidia_tao_deploy.cv.changenet import scripts
...
def main():
    ...
    parser = argparse.ArgumentParser(
        "changenet",
        add_help=True,
        description="Train Adapt Optimize Deploy entrypoint for ChangeNet"
    )
    ...
    launch(parser, subtasks, network="changenet")
