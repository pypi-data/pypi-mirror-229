...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <pyroplus.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <pyroplus.raw.base.VideoSize>`, *optional*):
            N/A
