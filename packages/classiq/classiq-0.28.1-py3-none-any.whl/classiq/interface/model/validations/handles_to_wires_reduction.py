...
class HandleReducer:
    ...
    def reduce_call(
        ...
        unique_handles = get_unique_handle_names(call.inouts) | get_unique_handle_names(
            call.outputs
        )
        ...
        inputs = self._handle_inputs(call.inputs)
        outputs = self._handle_outputs(call.outputs, handles_to_out_wires)
        inouts = self._handle_inouts(call.inouts, handles_to_out_wires)
