...
from es7s.cli._base_opts_params import EpilogPart
...
@cli_command(
    ...
    epilog=[
        EpilogPart("There is a support for result filtering; by default FILTERs are treated as extended regular "
                   "expressions, but this can be altered with '--literal' option. Considerations:",
                   "Filters:"),
        EpilogPart("⏺ When there are two or more FILTERs specified, a key is considered matching if *any* of these "
        ...
        EpilogPart("⏺ Search is case-insensitive unless any of filters contain one or more capital letters, in which "
