...
def build_spark_operation_spec(operation_alias, spark_discovery, config,
    ...
    environment["LIVY_HOME"] = "$HOME/{}/livy".format(spark_home)
    ...
    environment["SPARK_YT_LIVY_PORT"] = "27105"
    ...
    if "livy" in job_types:
        builder.begin_task("livy") \
            ...
            .memory_limit(_parse_memory('4gb')) \
            .cpu_limit(2) \
            .spec(common_task_spec) \
...
def start_spark_cluster(worker_cores, worker_memory, worker_num,
                        ...
                        autoscaler_slot_increment_step=None, enable_livy=False):
    """Start Spark cluster
