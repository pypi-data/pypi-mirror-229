...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <pyroplus.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <pyroplus.raw.base.PhoneConnection>`):
            N/A
