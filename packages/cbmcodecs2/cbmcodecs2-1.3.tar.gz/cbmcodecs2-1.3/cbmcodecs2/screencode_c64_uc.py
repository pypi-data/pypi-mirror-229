...
decoding_table = (
    ...
    '\u25cf'    #  0x51 -> BLACK CIRCLE
    '\uf125'    #  0x52 -> BOX DRAWINGS LIGHT HORIZONTAL TWO EIGHTHS DOWN (CUS)
    '\u2665'    #  0x53 -> BLACK HEART SUIT
    '\uf127'    #  0x54 -> BOX DRAWINGS LIGHT VERTICAL THREE EIGHTHS LEFT (CUS)
    '\u256d'    #  0x55 -> BOX DRAWINGS LIGHT ARC DOWN AND RIGHT
    '\u2573'    #  0x56 -> BOX DRAWINGS LIGHT DIAGONAL CROSS
    '\u25cb'    #  0x57 -> WHITE CIRCLE
    '\u2663'    #  0x58 -> BLACK CLUB SUIT
    '\uf129'    #  0x59 -> BOX DRAWINGS LIGHT VERTICAL TWO EIGHTHS RIGHT (CUS)
