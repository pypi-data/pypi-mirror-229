...
import pyroplus
from pyroplus import StopTransmission, enums
from pyroplus import raw
from pyroplus import types
from pyroplus import utils
from pyroplus.errors import FilePartMissing
from pyroplus.file_id import FileType


class SendAudio:
    async def send_audio(
        self: "pyroplus.Client",
        ...
        For sending voice messages, use the :meth:`~pyroplus.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~pyroplus.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~pyroplus.Client.stop_transmission`, None is returned.
