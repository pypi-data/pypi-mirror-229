...
class input_Tarif:
    def __init__(self, 
                 ...
                 c_euro_kWh_HCH=0.0, 
                 c_euro_kWh_TCFE=0.0, 
                 c_euro_kWh_certif_capacite=0.0, 
                 c_euro_kWh_ENR=0.0, 
        ...
        self.c_euro_kWh_certif_capacite = c_euro_kWh_certif_capacite
...
######################Fonctions pour le calcul du TURPE#######################################""
    ...
    def calculate_montant(self):
        ...
        self.euro_capacite_pointe = round(self.facture.kWh_pointe * self.tarif.c_euro_kWh_certif_capacite, 2)
        print("euro_capacite_pointe = ",self.euro_capacite_pointe)
        self.euro_capacite_HPH = round(self.facture.kWh_HPH * self.tarif.c_euro_kWh_certif_capacite, 2)
        print("euro_capacite_HPH = ",self.euro_capacite_HPH)
        self.euro_capacite_HCH = round(self.facture.kWh_HCH * self.tarif.c_euro_kWh_certif_capacite, 2)
        print("euro_capacite_HCH = ",self.euro_capacite_HCH)
        self.euro_capacite_HPB = round(self.facture.kWh_HPB * self.tarif.c_euro_kWh_certif_capacite, 2)
        print("euro_capacite_HPB = ",self.euro_capacite_HPB)
        self.euro_capacite_HCB = round(self.facture.kWh_HCB * self.tarif.c_euro_kWh_certif_capacite, 2)
