...
class Option:
    ...
    def simulate_price(
        ...
        original_spot = self.underlying_ltp()
        original_iv = self.fetch_iv(
            S=original_spot,
            t=original_time_to_expiry,
        )
