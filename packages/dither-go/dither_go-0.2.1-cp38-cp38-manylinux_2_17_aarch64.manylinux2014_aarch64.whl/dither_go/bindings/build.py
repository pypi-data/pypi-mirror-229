...
# gopy build -no-make -dynamic-link=True -symbols=False -output /project/build/lib.linux-aarch64-cpython-38/dither_go/bindings -vm /tmp/build-env-lnonf4s9/bin/python ./dither_go github.com/tfuxu/dither-gopy
