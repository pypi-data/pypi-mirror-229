...
class AlterTableStatement(Statement, TypeCast):
    dialExt: DbExt = None
    type_: str = None
...
class AlterTableStatementBuilder (object):
    construction: AlterTableStatement
    

    def __init__(self) -> None:
        super().__init__()
        self.construction = AlterTableStatement()
