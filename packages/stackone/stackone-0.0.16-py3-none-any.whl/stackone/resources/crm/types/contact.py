...
class Contact(pydantic.BaseModel):
    id: typing.Optional[str] = pydantic.Field(description="The contact ID")
    ...
    created_at: typing.Optional[str] = pydantic.Field(description="Timestamp when the contact was created")
    updated_at: typing.Optional[str] = pydantic.Field(description="Timestamp when the contact was last updated")
