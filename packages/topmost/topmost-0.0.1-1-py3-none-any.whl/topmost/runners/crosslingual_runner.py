...
class CrosslingualRunner:
    ...
    def export_top_words(self, num_top=15):
        beta_en, beta_cn = self.export_beta()
        top_words_en = static_utils.print_topic_words(beta_en, vocab=self.dataset_handler.vocab_en, num_top=num_top)
        top_words_cn = static_utils.print_topic_words(beta_cn, vocab=self.dataset_handler.vocab_cn, num_top=num_top)
