...
def report_f_vnd(symbol,types,year_f,timely):
    ...
    if timely=='YEAR' or timely=='NAM':
        url_y=f'https://finfo-api.vndirect.com.vn/v4/financial_statements?q=code:SSI~reportType:ANNUAL~modelType:{modelType}~fiscalDate:{year_f-1}-12-31,{year_f-2}-12-31,{year_f-3}-12-31,{year_f-4}-12-31,{year_f-5}-12-31,{year_f-6}-12-31,{year_f-7}-12-31,{year_f-8}-12-31,{year_f-9}-12-31&sort=fiscalDate&size=2000'        
    elif timely=='QUARTER' or timely=='QUY':
        url_y=f'https://finfo-api.vndirect.com.vn/v4/financial_statements?q=code:SSI~reportType:QUARTER~modelType:{modelType}~fiscalDate:{year_f}-12-31,{year_f}-09-30,{year_f}-06-30,{year_f}-03-31,{year_f-1}-12-31,{year_f-1}-09-30,{year_f-1}-06-30,{year_f-1}-03-31,{year_f-2}-12-31&sort=fiscalDate&size=2000'       
