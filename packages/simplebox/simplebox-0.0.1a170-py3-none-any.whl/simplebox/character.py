# !/usr/bin/env python
# -*- coding:utf-8 -*-
from typing import Optional, Callable, Union, Tuple, Iterable, Dict, Mapping, Sequence
...
class String(str):
    ...
    def in_container(self, *targets: str) -> bool:
        return _strings.in_container(self, targets)

    def trip_in_container(self, *targets: str) -> bool:
        return _strings.trip_in_container(self, targets)

    def not_in_container(self, *targets: str) -> bool:
        return _strings.not_in_container(self, targets)

    def trip_not_in_container(self, *targets: str) -> bool:
