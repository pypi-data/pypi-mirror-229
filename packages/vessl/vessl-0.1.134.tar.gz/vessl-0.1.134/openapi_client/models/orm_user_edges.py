...
class OrmUserEdges(object):
    ...
    def __init__(self, access_tokens=None, cluster_quotas=None, credit_earn_histories=None, default_organization=None, experiments=None, judged_pipeline_step_executions=None, model_service_revisions=None, model_service_rollouts=None, model_services=None, models=None, pipelines=None, policies=None, project_dashboards=None, reset_password_tokens=None, run_executions=None, starred_dashboards=None, subjects=None, triggered_pipeline_executions=None, user_groups=None, user_history_as_transferer=None, user_organization=None, withdraw_history_organizations=None, withdraw_history_workloads=None, workspaces=None, local_vars_configuration=None):  # noqa: E501
