...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <pyroplus.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <pyroplus.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <pyroplus.raw.base.InlineBotWebView>`, *optional*):
            N/A
