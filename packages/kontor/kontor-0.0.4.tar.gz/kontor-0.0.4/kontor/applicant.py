...
class BureauApplicant:
    ...
    def __authenticate(self, username: str, password: str):
        ...
        response_json_data = wait_for_response(self.__connection)
    ...
    def __wait_and_receive_result_file(self, file_path: str, overwrite_file: bool):
        ...
        request_json_data = wait_for_response(self.__connection)
        ...
        with open(corrected_file_path, "wb") as processed_file:
            ...
            while not file_received_fully:
                data = self.__connection.recv(chunk_size_bytes)
                if len(data) == 0:
                    break
                ...
                received_percents = int(
                    100 / procedure_receipt.file_size_bytes * received_bytes
                )
                ...
                if (
                    ...
                    logging.info(
                        f"Receiving file from server, {received_percents}% ({received_bytes} / {procedure_receipt.file_size_bytes})."
                    )
