...
class JoinGroupCall(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <pyroplus.raw.base.InputGroupCall>`):
            N/A

        join_as (:obj:`InputPeer <pyroplus.raw.base.InputPeer>`):
            N/A

        params (:obj:`DataJSON <pyroplus.raw.base.DataJSON>`):
            N/A
