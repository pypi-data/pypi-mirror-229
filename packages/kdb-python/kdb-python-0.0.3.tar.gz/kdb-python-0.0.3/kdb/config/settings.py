...
class IESettings:
    ...
    DRIVER_PATH = generate_driver_path(DRIVER_NAME)
    IE_LOG_FILE = os.path.join(LOG_DIR, 'ielogclient.txt')
...
class EncryptionSettings:
    HOST = 'dev-enc'
    KEY = 'GusDKdfTdGTfwWwsGgrZrZMdNF'
...
class MobileSettings:
    ...
    mobile.queue.host=mtl1-w-mc-02409.mgcorp.co
    mobile.queue.port=22
    mobile.queue.username=svc_mtl1_qa
    mobile.queue.password=tBlUW-iLW5guZrgRbC8TDg3wk1X2MeAwkvgkZ8fQBUHpKKpWUKDiMKfw7EhvH6BDVdTVJS3xcwSJHr_a3w8SRA
    """
