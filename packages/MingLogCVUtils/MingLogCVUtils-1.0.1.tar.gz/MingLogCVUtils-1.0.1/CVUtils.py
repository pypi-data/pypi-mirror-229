...
# 主要用于在jupyter notebook中嵌入图像使用，配合%matplitlib inline使用效果更好
...
# 车牌还原
def get_plate_dict():
    with open('files/Province.txt', 'r', encoding='utf-8') as f, open('files/WordAndNum.txt', 'r', encoding='utf-8') as g:
