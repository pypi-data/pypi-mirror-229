...
# 校验身份证
def checkidcard(IDCARD='210303198906252513'):
    count = 0
    for idx, item in enumerate(IDCARD):
        # print(idx, item,  [7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2, 0][idx])
        count = count + int(item) * [7, 9, 10, 5, 8, 4, 2, 1, 6, 3, 7, 9, 10, 5, 8, 4, 2, 0][idx]
        # print(count)
...
class zystr(unittest.TestCase):
    ...
    def test_unicodeencode(self):
        ...
        self.assertEqual(unicodeencode('青春百战', encoding='utf8'),  b'\xe9\x9d\x92\xe6\x98\xa5\xe7\x99\xbe\xe6\x88\x98')
        self.assertEqual(unicodeencode('青春百战', encoding='gbk'),  b'\xc7\xe0\xb4\xba\xb0\xd9\xd5\xbd')
