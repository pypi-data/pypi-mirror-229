...
@jsii.data_type(
    jsii_type="@gcix/gcix.linux.InstallPackageProps",
    jsii_struct_bases=[],
    name_mapping={"packages": "packages", "sudo": "sudo"},
)
class InstallPackageProps:
    def __init__(
        self,
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__4f6c119c6141daa14c83c40c1bb93bc4b5c2c5db8519767ded47b5491185b170)
    ...
    def __repr__(self) -> str:
        return "InstallPackageProps(%s)" % ", ".join(
...
class LinuxScripts(metaclass=jsii.JSIIMeta, jsii_type="@gcix/gcix.linux.LinuxScripts"):
    ...
    def install_packages(
        ...
        *,
        ...
        '''
        props = InstallPackageProps(packages=packages, sudo=sudo)
...
def _typecheckingstub__4f6c119c6141daa14c83c40c1bb93bc4b5c2c5db8519767ded47b5491185b170(
    *,
    packages: typing.Sequence[builtins.str],
    sudo: typing.Optional[builtins.bool] = None,
) -> None:
