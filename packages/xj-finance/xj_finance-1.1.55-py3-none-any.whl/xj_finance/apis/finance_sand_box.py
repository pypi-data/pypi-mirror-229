...
from ..services.finance_sand_box_service import FinanceSandBoxService
...
class FinanceSandBox(generics.UpdateAPIView):  # 或继承(APIView)
    ...
    def get(self, request, *args, **kwargs):
        return Response({
            'err': 0,
            'msg': 'OK',
            'data': FinanceSandBoxService.get()
        })
    ...
    def post(self, request, *args, **kwargs):
        ...
        data, err_txt = FinanceSandBoxService.post(params=params)
        if err_txt is None:
