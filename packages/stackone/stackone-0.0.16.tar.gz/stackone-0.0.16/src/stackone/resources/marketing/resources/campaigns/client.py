...
from ...types.campaign_result import CampaignResult
from ...types.campaigns_paginated import CampaignsPaginated
...
class CampaignsClient:
    ...
    def marketing_campaigns_list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "unified/marketing/campaigns"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(CampaignsPaginated, _response.json())  # type: ignore
    ...
    def marketing_campaigns_get(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"unified/marketing/campaigns/{id}"),
            params=remove_none_from_dict(
                {
                    "page": page,
                    "page_size": page_size,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(CampaignResult, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
        if _response.status_code == 403:
            raise ForbiddenError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
