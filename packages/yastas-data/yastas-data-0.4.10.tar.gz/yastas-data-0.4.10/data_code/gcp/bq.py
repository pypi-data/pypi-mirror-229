...
def create_or_evaluate_bq_table(table_id:str,trn_parquet:str, delete_columns:str)->dict:
        ...
        try:
            ...
            response = subprocess.run(["bq","load","--autodetect", "--source_format=PARQUET", table_id, trn_parquet], stdout=subprocess.PIPE, stderr=subprocess.PIPE, capture_output=True, text=True, shell=True)
