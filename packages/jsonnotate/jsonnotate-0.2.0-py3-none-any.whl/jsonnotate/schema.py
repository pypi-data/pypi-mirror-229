...
def create_builder(found_fields: List[Tuple[FieldType, JSON]]) -> Callable[[Type[C], Dict[str, Any]], C]:
    def from_json(cls: Type[C], data: Dict[str, Any]) -> C:
        kwargs: Dict[str, Any] = {
...
class JsonSchema:
    ...
    def __init_subclass__(
        ...
        setattr(datacls, "from_json", classmethod(create_builder(found_fields)))
        setattr(datacls, "to_json", create_writer(found_fields))
