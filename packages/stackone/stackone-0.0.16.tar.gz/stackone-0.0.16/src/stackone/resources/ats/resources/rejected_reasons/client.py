...
from ...types.rejected_reason_result import RejectedReasonResult
from ...types.rejected_reasons_paginated import RejectedReasonsPaginated


class RejectedReasonsClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._client_wrapper = client_wrapper

    def ats_rejected_reasons_list(
        self,
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "unified/ats/rejected_reasons"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(RejectedReasonsPaginated, _response.json())  # type: ignore
    ...
    def ats_rejected_reasons_get(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"unified/ats/rejected_reasons/{id}"),
            params=remove_none_from_dict(
                {
                    "page": page,
                    "page_size": page_size,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(RejectedReasonResult, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
        if _response.status_code == 403:
            raise ForbiddenError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
...
class AsyncRejectedReasonsClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper

    async def ats_rejected_reasons_list(
        self,
        *,
        page: typing.Optional[str] = None,
        page_size: typing.Optional[str] = None,
    ...
    async def ats_rejected_reasons_get(
        self,
        id: str,
        *,
        page: typing.Optional[str] = None,
