...
class KernelServerNodeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.start = channel.unary_unary(
                '/octopus_proto.KernelServerNode/start',
        ...
        self.stop = channel.unary_unary(
                '/octopus_proto.KernelServerNode/stop',
        ...
        self.execute = channel.unary_unary(
                '/octopus_proto.KernelServerNode/execute',
        ...
        self.get_status = channel.unary_unary(
                '/octopus_proto.KernelServerNode/get_status',
...
def add_KernelServerNodeServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'octopus_proto.KernelServerNode', rpc_method_handlers)
...
class KernelServerNode(object):
    ...
    def start(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/octopus_proto.KernelServerNode/start',
    ...
    def stop(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/octopus_proto.KernelServerNode/stop',
    ...
    def execute(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/octopus_proto.KernelServerNode/execute',
    ...
    def get_status(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/octopus_proto.KernelServerNode/get_status',
