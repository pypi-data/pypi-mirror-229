...
class WSDecomposer(XMLWSBase):
    ...
    @semistaticmethod
    def parse_snapshots(self, ws:"ROOT.RooWorkspace",
        ...
        for snapshot_name in snapshot_names:
            ...
            if not snapshot:
                self.stdout.warning(f'No snapshot named "{snapshot_name}"')
                continue
    ...
    def create_decomposed_workspace(self, infile:str, outfile:str,
        ...
        with Timer() as t:
            ...
            category_map = model.get_category_map()
            ...
            for category in categories:
                ...
                if rebuild_nuis:
                    nuis_cat = ROOT.RFUtils.SelectConstantArgs(param_cat, False)
