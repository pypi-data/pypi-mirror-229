...
static int import_breezy__bzr___simple_set_pyx(void) {
  ...
  if (!module) goto bad;
  if (__Pyx_ImportFunction(module, "SimpleSet_New", (void (**)(void))&__pyx_api_f_6breezy_3bzr_15_simple_set_pyx_SimpleSet_New, "struct SimpleSetObject *(void)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "SimpleSet_Add", (void (**)(void))&__pyx_api_f_6breezy_3bzr_15_simple_set_pyx_SimpleSet_Add, "PyObject *(PyObject *, PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "SimpleSet_Contains", (void (**)(void))&__pyx_api_f_6breezy_3bzr_15_simple_set_pyx_SimpleSet_Contains, "int (PyObject *, PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "SimpleSet_Discard", (void (**)(void))&__pyx_api_f_6breezy_3bzr_15_simple_set_pyx_SimpleSet_Discard, "int (PyObject *, PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "SimpleSet_Get", (void (**)(void))&__pyx_api_f_6breezy_3bzr_15_simple_set_pyx_SimpleSet_Get, "PyObject *(struct SimpleSetObject *, PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "SimpleSet_Size", (void (**)(void))&__pyx_api_f_6breezy_3bzr_15_simple_set_pyx_SimpleSet_Size, "Py_ssize_t (PyObject *)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "SimpleSet_Next", (void (**)(void))&__pyx_api_f_6breezy_3bzr_15_simple_set_pyx_SimpleSet_Next, "int (PyObject *, Py_ssize_t *, PyObject **)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "_SimpleSet_Lookup", (void (**)(void))&__pyx_api_f_6breezy_3bzr_15_simple_set_pyx__SimpleSet_Lookup, "PyObject **(PyObject *, PyObject *)") < 0) goto bad;
  __pyx_ptype_6breezy_3bzr_15_simple_set_pyx_SimpleSet = __Pyx_ImportType(module, "breezy.bzr._simple_set_pyx", "SimpleSet", sizeof(struct SimpleSetObject), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6breezy_3bzr_15_simple_set_pyx_SimpleSet) goto bad;
