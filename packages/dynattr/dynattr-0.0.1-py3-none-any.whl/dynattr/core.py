...
class DynamicAttributesMixin:
    ...
    def check_dynattr_err(self, attr: StrQ = None) -> None:
        ...
        '''
        name = getattr(self, (attr or ''), None)
        if name is None and type(self).raisedynerr:
            raise DynamicAttributeError(type(self), attr)

    def get_dynattr_name(self, attr: str) -> StrQ:
        '''
        ...
        name : str, None
            The name of the dynamic attribute.
        '''
        self.check_dynattr_err(attr)
        return getattr(self, attr, None)
    
    def getdynattr(self, attr: str, default: AnyQ = None) -> StrQ:
        '''get dynamic attribute'''
        dattr = self.get_dynattr_name(attr)
        return getattr(self, dattr, default) if dattr else default

    def setdynattr(self, attr: str, val: AnyQ = None):
        '''set dynamic attribute'''
        dattr = self.getdynattr(attr)
        if dattr is None: return
        setattr(self, dattr, val)
