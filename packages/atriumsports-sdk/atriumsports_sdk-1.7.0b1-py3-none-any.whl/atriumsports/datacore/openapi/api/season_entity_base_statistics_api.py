...
class SeasonEntityBaseStatisticsApi(object):
    ...
    def sebs_list(
        ...
        **kwargs
        ...
        >>> thread = api.sebs_list(organization_id, season_id, sport, added, competitor_type, entity_id, external, fields, fixture_type, hide_null, include, limit, offset, updated, async_req=True)
        >>> result = thread.get()
