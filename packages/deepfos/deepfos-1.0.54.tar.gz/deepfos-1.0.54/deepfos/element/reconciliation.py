...
class ReconciliationEngine(ElementBase):
    """对账引擎-数据集"""

    api_class = ReconcilationAPI
    api: ReconcilationAPI
    ...
    def extract_data(
        ...
        """
        return self.api.data_get.get_column_data(QueryColumnDataItem(
    ...
    def confirm(self, *ids: str) -> Any:
        ...
        """
        return self.api.data_get.confirm_ds_batch(ConfirmItem(
            dsIds=','.join(ids),
    ...
    def cancel(self, *ids: str) -> Any:
        ...
        """
        return self.api.data_get.cancel_ds(CancelItem(
            dsIds=','.join(ids),
            elementBaseInfoParamData=self._base_info
        ))
    ...
    def delete(self, *ids: str) -> Any:
        ...
        """
        return self.api.data_get.delete_ds_batch(DeleteDsItem(
            dsIds=','.join(ids),
            elementBaseInfoParamData=self._base_info
        ))


class ReconciliationMsEngine(ElementBase):
    """对账引擎_数据集"""

    api_class = ReconcilationmsAPI
    api: ReconcilationmsAPI
    ...
    def execute(
        ...
        """
        return self.api.reconcil.reconciliation(ReconciliationExecDto(
    ...
    def create_task(
        ...
        """
        return self.api.reconcil.create_task(ReconciliationExecCreate(
    ...
    def exec_task(
        ...
        """
        return self.api.reconcil.exec_task(ReconciliationExecDto(
            elementBaseInfoParam=self._base_info,
            params=params or [],
            povParams=pov,
            rcTaskId=task_id,
    ...
    def close_task(self, *task_ids: str) -> Any:
        ...
        """
        return self.api.reconcil.off_task(OffTaskItem(
    ...
    def open_task(self, task_id: str) -> Any:
        ...
        """
        return self.api.reconcil.on_task(OnTaskItem(
            rcTaskId=task_id,
            reconElement=self._base_info
        ))
    ...
    def delete_task(self, *task_ids: str) -> Any:
        ...
        """
        return self.api.reconcil.delete_task(DeleteTaskItem(
            rcTaskIds=list(task_ids),
            reconElement=self._base_info
        ))
    ...
    def mark_by_hand(
        ...
        """
        return self.api.balance.mark_by_hand(ReconSignByHand(
    ...
    def cancel_by_hand(
        ...
        """
        return self.api.balance.cancel_by_hand(CancelSignByHand(
            baseDataIds=base_data_ids or [],
            cprDataIds=cpr_data_ids or [],
            rcTaskId=task_id,
            reconElement=self._base_info,
    ...
    def cancel_matched(
        ...
        """
        return self.api.balance.cancel_recon_match(CancelReconMatch(
            matchIds=match_ids,
            rcTaskId=task_id,
            reconElement=self._base_info
        ))
