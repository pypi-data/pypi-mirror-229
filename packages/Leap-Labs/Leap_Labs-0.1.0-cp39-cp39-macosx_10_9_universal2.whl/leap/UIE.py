...
from leap.config_handler import Config
...
def generate(
    ...
    if mode == "tf":
        ...
        import leap.transforms_tf as tran
        import leap.objectives_tf as obj
        import leap.saliency_tf as sal
        from leap.generation_tf import generator

    elif mode == "pt":
        print("Pytorch mode enabled.")
        import leap.transforms as tran
        import leap.objectives as obj
        import leap.saliency as sal
        from leap.generation import generator
