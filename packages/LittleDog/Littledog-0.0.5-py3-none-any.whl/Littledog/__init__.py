...
#Shrinking an Image
def img_modify_SHRINK(image_path:str,window_name:str = 'Shrinked Image'):
    print('Task has started')
    print('Press any key to cancel')
    img = cv.imread(image_path)
...
#Enlarging an Image
def img_modify_ENLARGE(image_path):
    print('Task has started')
    print('Press any key to cancel')
    img = cv.imread(image_path)
...
#Cropping an image
def img_modify_CROP(image_path):
    print('Task has started')
    print('Press any key to cancel')
    img = cv.imread(image_path, 0)
...
def img_modify_SHEAR_X(image_path):
    print('Task has started')
    print('Press any key to cancel')
    img = cv.imread(image_path, 0)
    rows, cols = img.shape
...
def img_modify_SHEAR_Y(image_path):
    print('Task has started')
    print('Press any key to cancel')
    img = cv.imread(image_path, 0)
    rows, cols = img.shape
...
def img_modify_BLUR_2DKconv(image_path):
    print('Task has started')
    print('Press any key to cancel')
    # Reading the image
    image = cv.imread(image_path)
...
def img_modify_BLUR_Avg(image_path):
    print('Task has started')
    print('Press any key to cancel')
    image = cv.imread(image_path)
    # Applying the filter
...
def img_modify_BLUR_Gaus(image_path):
    print('Task has started')
    print('Press any key to cancel')
    image = cv.imread(image_path)
    # Applying the filter
...
def img_modify_BLUR_Mead(image_path):
    print('Task has started')
    print('Press any key to cancel')
    # Reading the image
    image = cv.imread(image_path)
...
def img_modify_BLUR_Bilat(image_path):
    print('Task has started')
    print('Press any key to cancel')
    # Reading the image
    image = cv.imread(image_path)
...
def img_split_COLORSPACES(image_path:str, window_name:str):
    print('Task has started')
    print('Press any key to cancel')
    image = cv.imread(image_path)
...
def img_modify_MASK_CIRCLE(image_path):
    print('Task has started')
    print('Press any key to cancel')
    img = cv.imread(image_path) 
...
def img_modify_BLEND_ALPHABLEND(image1_path: str, image2_path: str):
    print('Task has started')
    print('Press any key to cancel') 
...
def img_show_PLOT_GRAPH_COLOR_HISTOGRAM(image_path:str):
    print('Task has started')
