...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~melvan.types.InputMediaPhoto`, :obj:`~melvan.types.InputMediaVideo`, :obj:`~melvan.types.InputMediaAudio` and :obj:`~melvan.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~melvan.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from melvan.types import InputMediaPhoto, InputMediaVideo
