...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <pyroplus.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <pyroplus.raw.base.PopularContact>`):
            N/A
