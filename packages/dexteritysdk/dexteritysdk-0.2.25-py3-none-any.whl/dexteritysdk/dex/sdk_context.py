...
class SDKTrader:
    ...
    def connect(
        ...
        staker_state_key, _ = PublicKey.find_program_address(
            seeds=[
                bytes(keypair.public_key),
...
class SDKContext:
    ...
    def connect(client: Client,
                ...
                staking_program_id: PublicKey = pids.STAKING_PROGRAM_ID,
                stake_pool: PublicKey = PublicKey("9zdpqAgENj4734TQvqjczMg2ekvvuGsxwJC6f7F1QWp4"),
