...
class ResponseRunExecution(object):
    ...
    def __init__(self, arguments=None, artifact_volume_info_list=None, create_dt=None, created_by=None, endpoints=None, id=None, interactive_end_dt=None, message=None, pipeline_step_execution=None, progress_percent=None, run_spec=None, status=None, status_last_updated=None, volume_info_list=None, workload=None, local_vars_configuration=None):  # noqa: E501
