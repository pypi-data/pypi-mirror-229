...
def isarray(x):
    """
    Returns True if x is an array (numpy.ndarray [#numpy_ndarray]_ or list), False otherwise.
    """
    # references :
    ...
    return type(x) == np.ndarray or type(x) == list
