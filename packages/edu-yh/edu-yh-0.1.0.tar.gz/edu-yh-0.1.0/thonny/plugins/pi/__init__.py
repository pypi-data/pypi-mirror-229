...
def load_plugin():
    ...
    if get_workbench().get_ui_mode() == "simple" and get_workbench().winfo_screenwidth() >= 1280:
        images = {
            ...
            "video": "video48.png",
            "ac": "ac48.png",
            "ac-manager": "ac-manager48.png",
            "ac-submit": "ac-submit48.png",
            "ac-homework": "ac-homework48.png",
        }
    else:
        images = {
            ...
            "video": "video.png",
            "ac": "ac.png",
            "ac-manager": "ac-manager.png",
            "ac-submit": "ac-submit.png",
            "ac-homework": "ac-homework.png",
        }
