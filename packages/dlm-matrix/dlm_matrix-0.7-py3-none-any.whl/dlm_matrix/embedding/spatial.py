...
class SpatialSimilarity:
    def __init__(
        ...
        if api_key:
            self.semantic_similarity = SemanticSimilarity(api_key=api_key, batch_size=batch_size)
    ...
    def generate_embeddings(
        ...
        # Encode the message texts to obtain their embeddings
            embeddings = self.semantic_similarity._embed_text_batch(message_texts_flattened)
        else:
