...
class evaql_parserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by evaql_parser#explainableStatement.
    def visitExplainableStatement(self, ctx:evaql_parser.ExplainableStatementContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by evaql_parser#fileFormat.
    ...
    # Visit a parse tree produced by evaql_parser#groupbyClause.
    ...
    # Visit a parse tree produced by evaql_parser#explainStatement.
    ...
    # Visit a parse tree produced by evaql_parser#aggregateFunctionName.
