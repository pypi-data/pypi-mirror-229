...
def read_slab(model_path='SlabResults.out',verbose=True,short_format=False,overlap_model=False):
    """
    ...
    if overlap_model: return(read_overlap_spectra(path=model_path,verbose=verbose))
