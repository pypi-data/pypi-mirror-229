...
from pyroplus.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pyroplus.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pyroplus.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pyroplus.handlers.MessageHandler` the *update* argument will be a :obj:`~pyroplus.types.Message`; in a :obj:`~pyroplus.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pyroplus.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pyroplus.filters.command` or :meth:`~pyroplus.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pyroplus.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pyroplus.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pyroplus.types.Message`.
    ...
    async def func(flt, client: pyroplus.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pyroplus.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pyroplus.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pyroplus.types.InlineQuery`: The filter will match ``query``.
