...
def initialize_llm(documents, temperature=0.7,
    ...
    gpt4 = ChatOpenAI(model='gpt-4', temperature=temperature, openAIApiKey=openai_api_key)
    claude = ChatAnthropic(model="claude-2", temperature=temperature, anthropicApiKey=anthropic_api_key)
