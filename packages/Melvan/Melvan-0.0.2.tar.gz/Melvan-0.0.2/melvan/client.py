...
import melvan
from melvan import __version__, __license__
from melvan import enums
from melvan import raw
from melvan import utils
from melvan.crypto import aes
from melvan.errors import CDNFileHashMismatch
from melvan.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    AuthBytesInvalid, BadRequest, ListenerCanceled
)
from melvan.handlers.handler import Handler
from melvan.methods import Methods
from melvan.session import Auth, Session
from melvan.storage import FileStorage, MemoryStorage
from melvan.types import User, TermsOfService
from melvan.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~melvan.Client.export_session_string` before stopping the client to get a session string you can
    ...
    APP_VERSION = f"Melvan {__version__}"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to Melvan (version {__version__})")
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~melvan.enums.ParseMode`):
        ...
        try:
            ...
            if isinstance(r, raw.types.upload.File):
                ...
                try:
                    ...
                    raise e
        except melvan.StopTransmission:
            raise
        except Exception as e:
            log.error(e, exc_info=True)
