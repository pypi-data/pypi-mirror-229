...
class ReadFile:
    ...
    def _obrain_file_path_list(self) -> list[str]:
        if self.source_type == "wos":
            file_name_list = [
                i for i in os.listdir(self.folder_path) if i.startswith("savedrecs")
            ]
        elif self.source_type == "cssci":
            file_name_list = [
                i for i in os.listdir(self.folder_path) if i.startswith("LY_")
            ]
        elif self.source_type == "scopus":
            file_name_list = [
                i for i in os.listdir(self.folder_path) if i.startswith("scopus")
            ]
        else:
            raise ValueError("Invalid source type")
        file_name_list.sort()
        return [
            os.path.join(self.folder_path, file_name) for file_name in file_name_list
        ]
