...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <pyroplus.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <pyroplus.raw.base.Peer>`):
            N/A
