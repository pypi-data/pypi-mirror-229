...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~pyroplus.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroplus.Client):
                self.add_handler(pyroplus.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroplus.handlers.DeletedMessagesHandler(func, self),
