...
# (device_name, user input value, should results command, out-of-range value)
devices_u = [
    ...
    ("PNC 100000-6pos 375214277", 100000, "VOLT 100.000000", 101000),
]
...
def test_heinzinger_set_voltage(start_heinzinger_device, device_data):
    ...
    with pytest.raises(ValueError):
        ...
        heinzinger.voltage = device_data[3]
...
# (device_name, user input value, should results command, out-of-range value)
devices_i = [
    ("PNC 600-3000pos 375214277", 3, "CURR 3.000000", 10),
    ("PNChp 1500-40 ump. 375214277", 0.039, "CURR 39.000000", 0.041),
    ("PNChp 60000-1neg 354211082", 0.001, "CURR 1.000000", 0.002),
...
def test_heinzinger_set_current(start_heinzinger_device, device_data):
    ...
    with pytest.raises(ValueError):
        com.put_text(str(device_data[3]))
        heinzinger.current = device_data[3]
    with pytest.raises(HeinzingerSetValueError):
        com.put_text("2.0")
        heinzinger.current = device_data[1]
