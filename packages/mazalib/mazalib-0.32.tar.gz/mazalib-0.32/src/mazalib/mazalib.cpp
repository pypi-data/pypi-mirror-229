...
// DL_EXPORT(void) inithello(void) { Py_InitModule("mazalib", module_methods); }
...
static PyObject *kriging(PyObject *self, PyObject *args, PyObject *keywds) {
  ...
  KrigingProcessor<int, std::vector<int>, labels_count> freddy_kriger(
      labels_count);
...
static PyObject *cac(PyObject *self, PyObject *args, PyObject *keywds) {
  ...
  NewCACSegmentation<int, int, float, 2> cac_segmenter;
...
static PyObject *rgs(PyObject *self, PyObject *args, PyObject *keywds) {
  ...
  RegionGrowthSegmentation<int, std::vector<int>, 3> rgs_segmenter(
      labels_count);
...
//   int *denoised_data = nlm_denoise(input_data.data(), shape, nlm_iters_count,
//                                    nlm_radius, verbose);
...
static PyObject *unsharp(PyObject *self, PyObject *args, PyObject *keywds) {
  ...
  LatticeModel<int, std::vector<int>, 3> data_processor(2);
...
// PyMODINIT_FUNC initmazalib(void) {
//   (void)Py_InitModule("mazalib", module_methods);
//   import_array();
// }