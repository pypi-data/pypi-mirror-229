...
class Note(Document):
    ...
    notes = models.ManyToManyField('self', blank=True, symmetrical=True)
...
class Product(Thing):
    ...
    notes = models.ManyToManyField(Note, blank=True, related_name='%(class)s_notes')
