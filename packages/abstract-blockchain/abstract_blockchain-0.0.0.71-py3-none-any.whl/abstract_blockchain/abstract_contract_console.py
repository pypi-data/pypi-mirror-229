...
from abstract_blockchain.abstract_rpcs import get_default_rpc_list,rpc_win_while,get_rpc_layout,get_rpc_js,RPCData
from abstract_blockchain.abstract_abis import ABIBridge,default_rpc
...
def win_while(event: str):
    ...
    if event == "-GET_ABI-":
        ...
        rpc = {
            ...
            "ChainID": "43113",
            "Symbol": "AVAX",
            "Block_Explorer": "https://api-testnet.snowtrace.io/",
            "Network_Name": "Avalanche Testnet C-Chain"
        }
        new_bridge_global["abi_manager"] = ABIBridge(contract_address=contract_address, rpc=rpc)
        function_js = {}
