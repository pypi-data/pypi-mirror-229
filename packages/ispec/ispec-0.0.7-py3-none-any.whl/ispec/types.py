...
__all__ = ['AttrLvl', 'AttrSpec', 'ArgsTuple', 'AttrSrcs', 'AttrSrcsQ', 'AttrPrefQ', 'isp', 'iscls', 'isint', 'isstr', 'islist',
           'isdict', 'istuple', 'islistordict', 'isiter', 'isallstr', 'isdundstr', 'isself', 'ispself', 'ispcls',
           'isempty', 'ispempty', 'iskwotype', 'iskwonly', 'ispkwonly', 'isargvalnil', 'isdefarg']
...
from typing import Any, Type, List, Dict, Tuple, Union, Literal, Optional, TypeAlias, TypeGuard, Iterable
