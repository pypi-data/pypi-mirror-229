...
class DataCmd:
    ...
    def read_train_test_text_file(self, train_path, test_path, train_delimiter, test_delimiter):
        ...
        # np.savetxt('/Users/m.mansouryuva.nl/Research/FairDynamicRec/data/lastfm/test_matrix', test_data)
        # np.savetxt('/Users/m.mansouryuva.nl/Research/FairDynamicRec/data/lastfm/train_matrix', train_data)
