...
class CoordinateRepresentation(Representation):
    ...
    def tetra_dict_to_tree(
        ...
        json_filepath: str = "coordinate_tree.json",
        **kwargs: Dict[str, Any],
    ) -> "CoordinateTree":
        """
        ...
        def build_tree(node_id: str, node: CoordinateTree, depth: int):
            # Process the children of the current node and update related data structures
            ...
            for child_id in child_ids:
                ...
                node.coordinates[child_id] = (x, y, z, t, n_parts)
        ...
        # Convert the CoordinateTree to a JSON-serializable9 dictionary
