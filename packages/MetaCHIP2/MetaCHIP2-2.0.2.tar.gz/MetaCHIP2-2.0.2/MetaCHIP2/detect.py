...
def detect(args):
    ...
    use_mmseqs              = args['m']
    skip_end_break_check    = args['e']
    skip_plot_flk_region    = args['v']
...
/usr/local/bin/python3.7 /Users/songweizhi/PycharmProjects/MetaCHIP2/MetaCHIP2/detect.py -p demo_v2 -i gbk_files -x gbk -g gnm_clade_v2.txt -s rooted.treefile -t 10 -f -m -e -b blastn_results -k
