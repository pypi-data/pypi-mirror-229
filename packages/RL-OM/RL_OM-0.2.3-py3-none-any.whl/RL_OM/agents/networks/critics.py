...
class CriticNetworkStateActionRNN(nn.Module):
    ...
    def __init__(self, input_shape, output_shape, input_shape_RNN, input_shape_MLP, n_features, input_processor = None, squeeze_output = False, device = "cpu", **kwargs):
...
class CriticNetworkStateActionRNN_MLP_hybrid(nn.Module):
    ...
    def __init__(self, input_shape, output_shape, input_shape_RNN, input_shape_MLP, n_features, input_processor = None, squeeze_output = False, **kwargs):
