...
class Parallelize:
    ...
    Libraries:
    ----------
        - mutiprocessing: https://docs.python.org/3/library/mp.html
    ...
    def compute(self, chunksize:int=1, progressbar_desc:Optional[str]=None) -> Generator:
        """
        The compute method applies a function to an iterable object in parallel using the multiprocessing module yielding the results.
