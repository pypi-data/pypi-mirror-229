...
async def test_not_ok(hacky_url):
    with pytest.raises(SSRFProtectionError):
        await SecuritySSRFProtection().check_url(hacky_url)
...
def test_not_ok_sync_call(hacky_url):
    with pytest.raises(SSRFProtectionError):
        SecuritySSRFProtection().sync_check_url(hacky_url)
