...
def run_ffmpeg(directory_name, uniq_code):
    ...
    os.system(f"ffmpeg -y -framerate 60 -i {directory_name}/frame_%d.jpg -i {audio_path} -c:v libx264 -crf 18 -pix_fmt yuv420p -r 60 -c:a aac -strict experimental -shortest outputs/output{uniq_code}.mp4")
