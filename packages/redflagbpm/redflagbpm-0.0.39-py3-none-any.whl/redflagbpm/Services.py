...
class ReportService:
    ...
    def renderReport(self, options: dict, reportData: dict):
        return self.bpm.call("EBHBPMReportService.renderReport", body={"options": dict, "reportData": dict})

    def renderReports(self, options: dict, reports: dict):
        return self.bpm.call("EBHBPMReportService.renderReports", body={"options": dict, "reports": dict})
