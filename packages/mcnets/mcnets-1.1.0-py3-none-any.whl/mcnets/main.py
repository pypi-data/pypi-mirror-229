...
class AdvNet:
    ...
    def __init__(self, inputCount: int, hiddenCounts: list, outputCount: int, activations):
        ...
        4 - activations
        - Possible Values: "lin", "elu", "atan", "relu", "rnd", "sig", "resu", "resu2"
    ...
    def Train(self, XData, YData, Ieta:int = 5, Gamma:float = 1, Beta:int = 20,
    ...
    def FastTrain(self, xArr:np.ndarray, yArr:np.ndarray, Ieta:int = 5, 
                  Beta:int = 50, Gamma:int = 1, ScoreFunction = None,
                  Verbose:bool = True, useFast:bool = True):
        """
        Returns a train version of the net object to the relative to the given X & Y data
...
def netMetrics(net:AdvNet, xArr:np.ndarray, yArr:np.ndarray, returnAll:bool = False, 
    ...
    method:
        ...
        - 'aae' returns the average-ansolute error
