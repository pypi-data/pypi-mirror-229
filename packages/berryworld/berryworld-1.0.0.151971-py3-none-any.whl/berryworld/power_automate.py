...
class PowerAutomate:
    def __init__(self, organisation_id, environment_id, business_unit, delegated=True, credentials=None):
        ...
        self.base_flow_url = f'https://api.flow.microsoft.com/providers/Microsoft.ProcessSimple/environments/' \
                             f'{environment_id}'
    ...
    def list_flow_owners(self, flow_id):
        flow_url = f'{self.base_flow_url}/flows/{flow_id}/owners?api-version=2016-11-01'
    ...
    def enrich_run_history(self, flows_df):
        ...
        for i, flow in flows_df.iterrows():
            flow_url = f'{self.base_flow_url}/flows/{flow["name"]}/runs?api-version=2016-11-01'
    ...
    def enrich_connections(self, flows_df):
        ...
        for i, flow in flows_df.iterrows():
            flow_url = f'{self.base_flow_url}/flows/{flow["name"]}/connections?api-version=2016-11-01'
    ...
    def list_flows(self, enrich=False, enrich_info=False, enrich_owners=False, enrich_run_history=False,
        ...
        flow_url = f'{self.base_flow_url}/flows?api-version=2016-11-01'
    ...
    def update_flow(self, flow_id, payload):
        flow_url = f'{self.base_flow_url}/flows/{flow_id}?api-version=2016-11-01'
