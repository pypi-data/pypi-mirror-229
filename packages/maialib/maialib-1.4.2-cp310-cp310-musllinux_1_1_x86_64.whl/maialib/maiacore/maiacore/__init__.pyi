...
class Chord():
    ...
    def getSetharesDissonance(self, numPartials: int = 6, useMinModel: bool = True, amplCallback: typing.Callable[[typing.List[float]], typing.List[float]] = None, dissCallback: typing.Callable[[typing.List[float]], float] = None) -> float: ...
    def getSetharesPartialsDataFrame(self, numPartials: int = 6, useMinModel: bool = True, amplCallback: typing.Callable[[typing.List[float]], typing.List[float]] = None) -> object: ...
