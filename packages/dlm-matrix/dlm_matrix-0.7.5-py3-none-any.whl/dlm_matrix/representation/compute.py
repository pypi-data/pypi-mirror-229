    ...
    def tetra_dict_to_tree(
        ...
        **kwargs: Dict[str, Any],
        ...
        root = CoordinateTree(
            ...
            t=t,
            n_parts=n_parts,
            create_time=message_dict.get(root_id, {}).message.create_time,
            message_info=self.get_message_content(root_id),
        ...
        def build_tree(node_id: str, node: CoordinateTree, depth: int):
            ...
            for child_id in child_ids:
                ...
                child = CoordinateTree(
                    ...
                    t=t,
                    n_parts=n_parts,
                    create_time=message_dict.get(child_id, {}).message.create_time,
                    message_info=self.get_message_content(child_id),
        ...
        with open('tree.json', 'w') as f:
            json.dump(root.dict(), f, indent=4)
        return root
