...
from traversers import TTraverser

def spanning_forest(g: UndirectedGraph[TVertex], traverser: TTraverser) -> Iterator[UndirectedGraph]:
...
if __name__ == '__main__':
    from traversers import traverser_bf, traverser_df
    ...
    print("Breath first:")
    graphs_bf = list(spanning_forest(my_graph, traverser_bf))
    for g in graphs_bf:
        print(g)

    print("Depth first:")
    graphs_df = list(spanning_forest(my_graph, traverser_df))
    for g in graphs_df:
        print(g)
