...
def report_f_vnd(symbol,types,year_f,timely):
    ...
    if timely=='YEAR' or timely=='NAM':
        url_y=f'https://finfo-api.vndirect.com.vn/v4/financial_statements?q=code:{symbol}reportType:ANNUAL~modelType:{modelType}~fiscalDate:{year_f-1}-12-31,{year_f-2}-12-31,{year_f-3}-12-31,{year_f-4}-12-31,{year_f-5}-12-31&sort=fiscalDate&size=2000'        
