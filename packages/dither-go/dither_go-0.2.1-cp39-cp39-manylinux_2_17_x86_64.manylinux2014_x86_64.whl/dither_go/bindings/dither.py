...
# gopy build -no-make -dynamic-link=True -symbols=False -output /project/build/lib.linux-x86_64-cpython-39/dither_go/bindings -vm /tmp/build-env-c_f4kcvs/bin/python ./dither_go github.com/tfuxu/dither-gopy
