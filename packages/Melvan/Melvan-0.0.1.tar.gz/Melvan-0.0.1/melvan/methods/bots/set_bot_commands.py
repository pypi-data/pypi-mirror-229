...
class SetBotCommands:
    async def set_bot_commands(
        ...
        Parameters:
            commands (List of :obj:`~melvan.types.BotCommand`):
                A list of bot commands.
                At most 100 commands can be specified.

            scope (:obj:`~melvan.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~melvan.types.BotCommandScopeDefault`.
        ...
        Example:
            .. code-block:: python
                ...
                from melvan.types import BotCommand
