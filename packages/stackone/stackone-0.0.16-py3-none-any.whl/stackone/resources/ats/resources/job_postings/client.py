...
from ...types.job_posting_result import JobPostingResult
from ...types.job_postings_paginated import JobPostingsPaginated
...
class JobPostingsClient:
    ...
    def ats_job_postings_list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "unified/ats/job_postings"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(JobPostingsPaginated, _response.json())  # type: ignore
    ...
    def ats_job_postings_get(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"unified/ats/job_postings/{id}"),
            params=remove_none_from_dict(
                {
                    "page": page,
                    "page_size": page_size,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(JobPostingResult, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
        if _response.status_code == 403:
            raise ForbiddenError(pydantic.parse_obj_as(typing.Any, _response.json()))  # type: ignore
...
class AsyncJobPostingsClient:
    ...
    async def ats_job_postings_list(
        self,
        *,
        page: typing.Optional[str] = None,
        page_size: typing.Optional[str] = None,
    ...
    async def ats_job_postings_get(
        self,
        id: str,
        *,
        page: typing.Optional[str] = None,
