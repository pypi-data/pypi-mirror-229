...
import pyroplus
from pyroplus import raw, types
...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~pyroplus.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~pyroplus.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~pyroplus.types.BotCommand`: On success, the list of bot commands is returned.
