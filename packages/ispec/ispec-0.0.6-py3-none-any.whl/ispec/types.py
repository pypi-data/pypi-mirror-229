...
# %% auto 0
__all__ = ['AttrLvl', 'ArgsTuple', 'AttrSrcs', 'AttrSrcsQ', 'AttrPrefQ', 'isp', 'iscls', 'isint', 'isstr', 'islist', 'isdict',
           'istuple', 'islistordict', 'isdundstr', 'isself', 'ispself', 'ispcls', 'isempty', 'ispempty', 'iskwotype',
           'iskwonly', 'ispkwonly', 'isargvalnil', 'isdefarg']
...
from typing import Any, Type, Tuple, Union, Literal, TypeAlias, TypeGuard
