...
# Project Imports
import hrfparser as parser

# INPUTS
SOURCE = Filepath(fr"hrfparser\tests\config.yaml")

# OUTPUTS
TEST_YAML   = Filepath(fr"hrfparser\tests\test.yaml")
TEST_JSON   = Filepath(fr"hrfparser\tests\test.json")
