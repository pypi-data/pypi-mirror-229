...
# %% ../nbs/00_core.ipynb 5
from atyp import AnyQ, BoolQ, FloatQ, StrLikeQ, ClsStrQ, ClsBool, ClsFloat
...
class nymstr(fuzstr):   
    ...
    def __new__(
        ...
        *args, **kwargs
        ...
        # kws, sup = aggopt(cls, **kwargs), clssupkws(cls)
        # opt = aggoptadd(cls, **kwargs)
        obj = super().__new__(cls, name, *args, **kwargs)
        return obj
