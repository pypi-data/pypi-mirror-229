...
class OAuth2(mixins.VerifierMixin):
    ...
    def get_authorization_url(self, scope: str = "read", code_challenge: str = None, next_page: str = None):
        """인증 URL"""
    ...
    def _get_authorization_code(self, code: str, code_challenge: str):
        ...
        data = {
            ...
            "code": unquote(code),
            "redirect_uri": self.redirect_uri,
            "code_verifier": unquote(code_challenge).replace("=", ""),
        }
        resp = requests.post(
            url,
            data=data,
    ...
    def get_token(
        ...
        if grant_type == GrantType.CLIENT_CREDENTIALS:
            ...
            return self._get_authorization_code(code, code_challenge)
