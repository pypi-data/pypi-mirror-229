...
class Functions:
    ...
    def create_function(self, function_name, compute_type: str, dependencies=[], persistence: bool = False,
                        blocking: bool = False,
        ...
        return FunctionCreator(host_url=self.host_url, headers=self.headers, compute_type=compute_type,
                               ...
                               script=script, dependencies=dependencies, persistence=persistence, blocking=blocking,
