...
def transfer_param(parent, sequencer, inherited_name, inherited_dict: Mapping[str, Tuple[str, str]]):
...
class RNNCell(Sequencer):
    ...
    @classmethod
    def _from_torchmodule(cls, parent, toplevel=None, inherited_name="", inherited_dict: SubstDict = dict()):
...
class LSTM(MultiLayerRNN):
    ...
    @classmethod
    def _from_torchmodule(cls, parent: torch.nn.LSTM, toplevel=None, inherited_name="",
