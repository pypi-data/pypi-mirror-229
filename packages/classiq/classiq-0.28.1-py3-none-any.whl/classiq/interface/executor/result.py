...
class ExecutionDetails(VersionedModel, QmodPyObject):
    ...
    parsed_counts: ParsedCounts = pydantic.Field(
        default_factory=list, description="Number of counts per parsed state"
    )
    ...
    def _clean_spaces_from_counts_keys(cls, v: Counts):
