...
TTraverser = Callable[[IGraph[TVertex], TVertex], Iterator[TEdge]]

def traverser_bf(graph: IGraph[TVertex],
...
def traverser_df(graph: IGraph[TVertex],
                 v_initial: TVertex,
...
def traverser_dijkstra_dict(g: IGraph[TVertex],
...
def traverser_dijkstra_heapmap(g: IGraph[TVertex],
                               d: WeightingFunction[TVertex],
                               v_initial: TVertex) -> Iterator[TEdge]:
...
def traverser_dijkstra_metric_dict(g: IGraph[TVertex],
                                   d: WeightingFunction[TVertex],
...
if __name__ == '__main__':
    ...
    print('traverser_bg', list(traverser_bf(my_graph, initial_vertex)))
    print('traverser_df', list(traverser_df(my_graph, initial_vertex)))

    # ---------------

    from algoritmia.data.iberia import iberia, km, coords2d
    print('traverser_dijkstra_dict', list(traverser_dijkstra_dict(iberia, km, 'Madrid')))
    ...
    print('traverser_dijkstra_metric_dict', list(traverser_dijkstra_metric_dict(iberia, km, dist,'Madrid', 'Bilbao')))
