...
class CreateIntegrationAppRequest(_message.Message):
    __slots__ = ["name", "type", "metabase_hostname", "metabase_username", "metabase_password", "linked_db_user_id"]
    ...
    def __init__(self, name: _Optional[str] = ..., type: _Optional[str] = ..., metabase_hostname: _Optional[str] = ..., metabase_username: _Optional[str] = ..., metabase_password: _Optional[str] = ..., linked_db_user_id: _Optional[str] = ...) -> None: ...
