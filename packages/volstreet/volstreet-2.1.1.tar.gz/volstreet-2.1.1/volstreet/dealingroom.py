...
class Option:
    ...
    def simulate_price(
        ...
        original_iv = self.fetch_iv(t=original_time_to_expiry)

        if time_delta_minutes is None and time_delta is None:
            raise ValueError("Either time_delta or time_delta_minutes must be provided")
...
class Strangle:
    ...
    def simulate_price(
        ...
        call_simulated_price = self.call_option.simulate_price(
            sim_spot, time_delta, time_delta_minutes, effective_iv
        )
...
class Index:
    ...
    def intraday_strangle(
        ...
        def justify_stop_loss(info_dict, side):
            ...
            try:
                estimated_movement = bs.target_movement(
                    ...
                    backup_movement=0.0022
                    if side == "call"
                    else -0.0022,  # Remove hard coded number
                )
            except Exception as e:
                estimated_movement = (
        ...
        exit_message = (
            ...
            f"Trend catcher points: {shared_info_dict['trend_catcher_points_captured']}\n"
        )
        # Exit dict
        exit_dict = {
