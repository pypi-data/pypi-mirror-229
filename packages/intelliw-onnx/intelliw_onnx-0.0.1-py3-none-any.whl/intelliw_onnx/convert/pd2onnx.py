...
def convert_pd_dynamic2onnx(model_path, output, op_set, input_shape_list,
    ...
    for input_shape in input_shape_list:
        ...
        logger.info('convert_pd_dynamic2onnx, got shape: {}'.format(input_shape))
        input_shape_list_.append(input_shape)

    logger.info('convert_pd_dynamic2onnx, got input_shape_list: {}'.format(input_shape_list_))
    ...
    logger.info('convert_pd_dynamic2onnx, got input_shape_list_int: {}'.format(input_shape_list_int))
