...
Output:
```py
<generator object batchmaker at 0x78a55e3e20>
...
Output:
```py
<generator object chunck_array at 0x78ad160940>
...
Output:
```py
2023-09-10 07:05:32.214761+07:00
2023-09-10 00:05:32.216802+00:00
2023-09-09 17:05:32.222968-07:00
```
...
Output:
```py
<generator object filter_empty at 0x78a558a110>
```
...
Output:
```py
<generator object get_class_method at 0x78a558a4d0>
```
...
(['Home', 'Emas 1 Gram', 'History', 'Trend', 'Perak 1 Gram', 'Pluang'],
 [['Harga Emas Hari Ini - Minggu, 10 September 2023'],
  ...
  ['LM Antam (Jual)↑1.069.000 (+1.000) / gr',
   'LM Antam (Beli)↑951.000 (+1.000) / gr']],
 [['Harga Emas Hari Ini'],
  ...
  ['0.5',
   ...
   '1.208.000 (+8.000)',
   '604.000 (+4.000)'],
  ['Update harga LM Antam :09 September 2023, pukul 08:21Harga pembelian '
   'kembali :Rp. 951.000/gram (+1.000)',
 ...
 [['Spot Harga Emas Hari Ini (Market Close)'],
  ...
  ['Update harga emas :10 September 2023, pukul 07:05Update kurs :13 Febuari '
   '2023, pukul 09:10']],
 [['Gram', 'UBS Gold 99.99%'],
  ['Jual', 'Beli'],
...
(['Home', 'Emas 1 Gram', 'History', 'Trend', 'Perak 1 Gram', 'Pluang'],
 [[''],
  ...
  ['KURS', '15.381,70↓', '%'],
  ['IDR', '949.078,33↓', '%'],
  ['Minggu, 10 September 2023 07:05']],
 [[''],
...
8
['mana', 'aja']
[<Element a at 0x78a53358b0>, <Element a at 0x78a5335630>, <Element a at 0x78a5335900>, <Element a at 0x78a5335950>, <Element a at 0x78a53359a0>, <Element a at 0x78a53359f0>, <Element a at 0x78a5335a40>, <Element a at 0x78a5335a90>, <Element a at 0x78a5335ae0>, <Element a at 0x78a5335b30>, <Element a at 0x78a5335b80>, <Element a at 0x78a5335bd0>, <Element a at 0x78a5335c20>, <Element a at 0x78a5335c70>, <Element a at 0x78a5335cc0>, <Element a at 0x78a5335d10>, <Element a at 0x78a5335d60>, <Element a at 0x78a5335db0>]
False
```
...
Output:
```py
<generator object irange at 0x78a54a3780>
<generator object irange at 0x78a54a3780>
['a', 'k', 'u']
[1, 2, 3, 4, 5, 6, 7]
[10, 9, 8, 7, 6, 5]
...
Output:
```py
<generator object iscandir at 0x78a53e2040>
[PosixPath('venv'), PosixPath('.vscode'), PosixPath('.git'), PosixPath('pypipr')]
```
    ...
    __subclasshook__ : NotImplemented
      _cached_cparts : ['https:', 'www.google.com']
             _cparts : ['https:', 'www.google.com']
                _drv : 
            _flavour : <pathlib._PosixFlavour object at 0x78ad44a290>
               _hash : 1411621207619836967
     ...
     is_block_device : False
      is_char_device : False
         ...
         is_reserved : False
           is_socket : False
          is_symlink : False
             iterdir : <generator object Path.iterdir at 0x78a5478ac0>
...
Output:
```py
<Timer(Thread-7, started 518148615424)>
...
Output:
```py
<generator object sets_ordered at 0x78a5672f60>
...
Output:
```py
{'a': <generator object ExampleComparePerformance.a.<locals>.<genexpr> at 0x78a5672cf0>,
