...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <pyroplus.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <pyroplus.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <pyroplus.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <pyroplus.raw.base.updates.State>`):
            N/A
