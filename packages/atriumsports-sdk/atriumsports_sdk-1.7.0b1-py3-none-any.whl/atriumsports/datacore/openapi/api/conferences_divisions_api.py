...
class ConferencesDivisionsApi(object):
    ...
    def conference_list(
        ...
        **kwargs
        ...
        >>> thread = api.conference_list(organization_id, sport, added, external, fields, hide_null, include, limit, offset, updated, async_req=True)
        >>> result = thread.get()
    ...
    def division_list(
        ...
        **kwargs
        ...
        >>> thread = api.division_list(conference_id, organization_id, sport, added, external, fields, hide_null, include, limit, offset, updated, async_req=True)
        >>> result = thread.get()
