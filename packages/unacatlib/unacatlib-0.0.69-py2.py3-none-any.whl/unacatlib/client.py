...
from unacatlib.unacast.operator.v1 import ListAddressComponentRequest, ListDimensionRequest, MapOperatorServiceStub, AddressComponentOperatorServiceStub, \
    MetricOperatorServiceStub, DimensionOperatorServiceStub, IndexJobOperatorServiceStub, IndexMetricResponse, ListLayerSeriesRequest
...
class Client(object):
    ...
    def get_layer_series(self, layer_series_id: str) -> LayerSeries:
        return sync(self.map_operator_service.get_layer_series(MapLayerSeries(layer_series_id=layer_series_id,)))
