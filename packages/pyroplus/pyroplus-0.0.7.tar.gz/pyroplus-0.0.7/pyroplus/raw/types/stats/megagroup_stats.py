...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        period (:obj:`StatsDateRangeDays <pyroplus.raw.base.StatsDateRangeDays>`):
            N/A

        members (:obj:`StatsAbsValueAndPrev <pyroplus.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <pyroplus.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <pyroplus.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <pyroplus.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <pyroplus.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <pyroplus.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <pyroplus.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <pyroplus.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <pyroplus.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <pyroplus.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <pyroplus.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <pyroplus.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <pyroplus.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <pyroplus.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <pyroplus.raw.base.StatsGroupTopInviter>`):
            N/A

        users (List of :obj:`User <pyroplus.raw.base.User>`):
            N/A
