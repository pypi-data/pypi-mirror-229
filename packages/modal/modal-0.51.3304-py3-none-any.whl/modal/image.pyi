...
class _Image(modal.object._Object):
    ...
    @staticmethod
    def from_registry(tag: str, setup_dockerfile_commands: typing.List[str] = [], force_build: bool = False, **kwargs) -> _Image:
        ...
...
class Image(modal.object.Object):
    ...
    @staticmethod
    def from_registry(tag: str, setup_dockerfile_commands: typing.List[str] = [], force_build: bool = False, **kwargs) -> Image:
        ...
