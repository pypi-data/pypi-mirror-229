...
class LocationsClient:
    ...
    def ats_locations_list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "unified/ats/locations"),
    ...
    def ats_locations_get(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"unified/ats/locations/{id}"),
            params=remove_none_from_dict(
                {
                    "page": page,
                    "page_size": page_size,
