...
def get_docstring_arg_type(t: str):
    if t in CORE_TYPES:
        ...
        return "Any function from :obj:`~melvan.raw.functions`"
...
def start(format: bool = False):
    ...
    for qualtype in types_to_constructors:
        ...
        docstring += f"\n\n    Constructors:\n" \
                     ...
                     f"        .. currentmodule:: melvan.raw.types\n\n" \
                     f"        .. autosummary::\n" \
                     f"            :nosignatures:\n\n" \
                     f"            {items}"
        ...
        if references:
            docstring += f"\n\n    Functions:\n        This object can be returned by " \
                         ...
                         f"        .. currentmodule:: melvan.raw.functions\n\n" \
                         f"        .. autosummary::\n" \
                         f"            :nosignatures:\n\n" \
                         f"            " + references
    ...
    for c in combinators:
        ...
        if c.section == "types":
            ...
            docstring += f"\n    Constructor of :obj:`~melvan.raw.base.{c.qualtype}`."
        else:
