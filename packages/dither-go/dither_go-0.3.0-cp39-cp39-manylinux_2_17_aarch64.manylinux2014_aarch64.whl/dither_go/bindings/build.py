...
# gopy build -no-make -dynamic-link=True -symbols=False -output /project/build/lib.linux-aarch64-cpython-39/dither_go/bindings -vm /tmp/build-env-5c_tx479/bin/python ./dither_go github.com/tfuxu/dither-gopy
