...
class AILog:
    ...
    def send_email_info(self, smtp_host: str, email_subject: str, receiver: list[str]):
        msg = f"""
                INFORME VISIÓN:
        ...
        if self.prediction is not None:
            msg += f"Predicción de la visión: {self.prediction} \n"
        if self.img_name is not None:
            msg += f"Nombre de la imagen: {self.img_name} \n"
