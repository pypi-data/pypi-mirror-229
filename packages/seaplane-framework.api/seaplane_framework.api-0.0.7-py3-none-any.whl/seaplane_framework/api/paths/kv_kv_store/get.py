...
class KvStoreSchema(schemas.StrSchema):
    class MetaOapg:
        regex = [
            {
                "pattern": r"^[a-z0-9]([-_a-z0-9]){0,62}$",  # noqa: E501
            }
        ]
...
class SchemaFor200ResponseBodyApplicationJson(schemas.DictSchema):
    ...
    @typing.overload
    def __getitem__(
        self, name: typing_extensions.Literal["keys"]
    ...
    def __getitem__(
        self,
        name: typing.Union[
            typing_extensions.Literal["config"],
            typing_extensions.Literal["keys"],
        ],
    ):
    ...
    def get_item_oapg(
        self, name: typing_extensions.Literal["keys"]
    ) -> typing.Union[MetaOapg.properties.keys, schemas.Unset]:
        ...
    ...
    def __new__(
        ...
        *_args: typing.Union[
        ...
        keys: typing.Union[
            MetaOapg.properties.keys, list, tuple, schemas.Unset
        ] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
