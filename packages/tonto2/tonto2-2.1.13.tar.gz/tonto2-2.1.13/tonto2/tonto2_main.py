...
class ItmDateTime(Itm):
    ...
    def __init__(self, tag=None):
        super().__init__(tag)
        self.fmt_disp = "%a %b %e %H:%M:%S %Y"  # locale.nl_langinfo(locale.D_T_FMT)
...
class ItmDate(ItmDateTime):
    ...
    def __init__(self, tag=None):
        super().__init__(tag)
        self.fmt_disp = "%m/%d/%y"  # locale.nl_langinfo(locale.D_FMT)
...
class ItmTime(ItmDateTime):
    ...
    def __init__(self, tag=None):
        super().__init__(tag)
        self.fmt_disp = "%H:%M:%S"  # locale.nl_langinfo(locale.T_FMT)
