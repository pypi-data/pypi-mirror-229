...
from pov.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "pov.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~pov.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~pov.handlers.MessageHandler` the *update* argument will be a :obj:`~pov.types.Message`; in a :obj:`~pov.handlers.CallbackQueryHandler` the *update* will be a :obj:`~pov.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~pov.filters.command` or :meth:`~pov.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~pov.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Document` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Game` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Video` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~pov.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Location` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~pov.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~pov.types.Message`.
    ...
    async def func(flt, client: pov.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~pov.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~pov.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~pov.types.InlineQuery`: The filter will match ``query``.
