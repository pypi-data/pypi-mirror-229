...
RelationshipDict = Dict[str, Dict[str, List[str]]]
...
class CoordinateRepresentation(Representation):
    ...
    def get_chain_document_parameters(
        ...
        return {**base_document, "children": children_dicts}
    ...
    def tetra_dict_to_tree(
        ...
        def build_tree(node_id: str, node: CoordinateTree):
    ...
    def _create_coordinates_graph(
        ...
        """
        Creates a coordinates graph for representing messages and their relationships.

        Args:
            use_graph (bool): Whether to use a graph representation. Default is False.
            kwargs (Dict): Additional keyword arguments.

        Returns:
            Dict[str, np.ndarray]: Dictionary containing the coordinates, relationships, and coordinate tree.
        """
        try:
            (
                relationships,
            ...
            coordinate_tree = CoordinateRepresentation.tetra_dict_to_tree(
                root_id, tetra_dict, relationships, self.message_dict
            )
    ...
    def _procces_coordnates(
        ...
        **kwargs: Dict[str, Union[str, float]],
        ...
        if local_embedding:
            ...
            return updated_tree_doc, embeddings, coordinate_tree
        else:
            return tetra_dict, coordinate_tree
