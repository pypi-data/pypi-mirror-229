...
def is_deprecated_key_present(
    ...
    Args:
        ...
        attr_name: The name of the value to use in warn.
    ...
    """
    if not is_non_empty_dict(obj, attr_name, warn):
        return False
    if depkey in obj:
        if warn:
            warnings.warn(f"{depkey} is deprecated. Use {actkey} instead ",DeprecationWarning)
