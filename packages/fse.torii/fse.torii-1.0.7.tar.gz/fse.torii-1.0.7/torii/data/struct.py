...
class Struct(object):
    ...
    def from_json(self, json, transient_entries=None, wipe=True):
        ...
        try:
            ...
            raise ToriiException('Failed convert struct from Json on key \'{0}\''.format(key)).with_traceback(sys.exc_info()[2])
    ...
    def to_json(self, ref=False, transient_entries=None):
        ...
        try:
            ...
            raise ToriiException('Failed convert struct to Json on key \'{0}\''.format(key)).with_traceback(sys.exc_info()[2])
