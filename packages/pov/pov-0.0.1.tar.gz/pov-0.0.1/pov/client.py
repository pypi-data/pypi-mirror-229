...
import pov
from pov import __version__, __license__
from pov import enums
from pov import raw
from pov import utils
from pov.crypto import aes
from pov.errors import CDNFileHashMismatch
from pov.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from pov.handlers.handler import Handler
from pov.methods import Methods
from pov.session import Auth, Session
from pov.storage import FileStorage, MemoryStorage
from pov.types import User, TermsOfService
from pov.utils import ainput
...
class Client(Methods):
    """pov Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~pov.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where pov will store the session files.
    ...
    APP_VERSION = f"pov {__version__}"
    DEVICE_MODEL = f"IndomieBot"
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to pov (version {__version__})")
        print(f"pov is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~pov.enums.ParseMode`):
