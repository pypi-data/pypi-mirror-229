...
from algoritmia.algorithms.traversers import traverser_dijkstra_dict, traverser_dijkstra_metric_dict
...
if __name__ == '__main__':
    v_initial = 'Madrid'
    v_final = 'Bilbao'
    edges = traverser_dijkstra_dict(iberia, km, v_initial)
    #edges = traverser_dijkstra_metric_dict(iberia, km, dist,v_initial, v_final)
    colors = {}
    for (c1, c2) in edges:
        c1_pos = coords2d[c1]
        c2_pos = coords2d[c2]
