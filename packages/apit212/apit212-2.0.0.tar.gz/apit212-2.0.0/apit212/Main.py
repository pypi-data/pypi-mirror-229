...
class Apit212:
    ...
    def beta_token_setup(self, api_token: str, acoount_type: str, mode: str = "demo") -> None:
        """
        Connect to the trading212 platform using a generated API token. 
        This will limit the function that can be executed

        :param api_token:
        """
        url = f"https//{mode}.trading212.com/api/v0/{acoount_type}/metadata/exchanges"
    ...
    def setup(self, username: str, password: str, _beauty: bool = True, mode: str = "demo") -> None:
        """
        Login into the trading212 platform using selenium (slower than api_token_setup)
        :param username:
        :param password:
        """
        self.mode = mode
