...
class DataDnsimpleCertificate(
    ...
    def __init__(
        ...
        *,
        ...
        :param certificate_id: Certificate ID. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.2.0/docs/data-sources/certificate#certificate_id DataDnsimpleCertificate#certificate_id}
        :param domain: Domain name. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/dnsimple/dnsimple/1.2.0/docs/data-sources/certificate#domain DataDnsimpleCertificate#domain}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
