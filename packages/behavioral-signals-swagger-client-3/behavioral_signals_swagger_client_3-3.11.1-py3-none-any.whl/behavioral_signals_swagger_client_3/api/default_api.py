...
class DefaultApi(object):
    ...
    def send_process_audio_with_http_info(self, cid, channels, calldirection, file, **kwargs):  # noqa: E501
        ...
        all_params = ['cid', 'channels', 'calldirection', 'file', 'name', 'customer_id', 'customer_ind', 'agent_team', 'agent_id', 'campaign_id', 'calltype', 'ani', 'calltime', 'timezone', 'speakers', 'storedata', 'tag', 'meta', 'predictionmode', 'data']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def send_process_url_with_http_info(self, cid, url, channels, calldirection, **kwargs):  # noqa: E501
        ...
        all_params = ['cid', 'url', 'channels', 'calldirection', 'name', 'customer_id', 'customer_ind', 'agent_team', 'agent_id', 'campaign_id', 'calltype', 'ani', 'calltime', 'timezone', 'speakers', 'storedata', 'tag', 'meta', 'predictionmode', 'data']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
