...
T = TypeVar("T", bound="AssaysListResponse200ItemWindow")


@attr.s(auto_attribs=True)
class AssaysListResponse200ItemWindow:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        assays_list_response_200_item_window = cls(
            pipeline=pipeline,
            model=model,
            width=width,
            start=start,
        ...
        assays_list_response_200_item_window.additional_properties = d
        return assays_list_response_200_item_window
