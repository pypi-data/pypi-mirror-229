...
class zylog(unittest.TestCase):
    ...
    def test_console(self):
        ...
        console('测试消息33', position='c:/0000/47python/ziyulibs/ziyulibs/function/zylog.py:224')
        console('测试消息44', label=LOGTYPE.请求, position='c:/0000/47python/ziyulibs/ziyulibs/function/zylog.py:225')
        try:
