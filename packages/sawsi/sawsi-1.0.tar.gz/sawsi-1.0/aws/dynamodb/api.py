...
import json
import time
from aws.dynamodb import util, wrapper, config
from aws import shared
...
class DynamoFDBAPI:
    ...
    """
    def __init__(self, table_name, credentials=None):
        """
        ...
        self.dynamoFDB = wrapper.DynamoFDB(self.boto3_session, table_name)
    ...
    def fdb_create_partition(self, partition, pk_field, sk_field=None, uk_fields=None, can_overwrite=False):
        """
