...
class TokenSamplerHft(TokenSamplerBase):
    """
    HuggingFace Transformer(HFT) Sampler like TokenSampler

    HuggingFaceのTransformerで採用されているオーソドックスなサンプラー寄せ実装
    ...
    def __init__(self):
        ...
        sampler.append("top_k_sampling")  # 4: top_k サンプラー
        sampler.append("top_p_sampling")  # 5: top_p サンプラー
