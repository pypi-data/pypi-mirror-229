...
from promptflow.runtime.utils._utils import get_value_by_key_path
...
def _execute(
    ...
    #     from ._utils._token_utils import get_default_credential
    ...
    run_mode = LegacyRunMode.BulkTest if batch_request.get("bulk_test_id") else LegacyRunMode.Flow
