...
class FluentSqlBuilder:
    ...
    def CreateTable(self, tableName: str, ignoreIfExists: bool = True):
        """
    ...
    def Column(self, column_name: str, attributes: str, foreignKeyReference: Optional[str] = None):
        ...
        :param attributes: Any column attributes, e.g., "INTEGER PRIMARY KEY".
    ...
    def Insert(self, tableName: str, *key_value_pairs: dict):
        '''
        ...
        :param key_value_pairs: An dict of column names and their corresponding values.
        ...
        if not tableName or not key_value_pairs:
        ...
        sql = f"INSERT INTO {tableName} ({column_names}) VALUES {value_placeholders}"
        self.Append(sql)
        return self
    ...
    def InnerJoin(self, tableName, onCondition:str):
        self.Append("INNER")
        self.Join(tableName=tableName, onCondition=onCondition)
