...
sotrans_roles[Roles.carrier_director] = Role(ancestors = [sotrans_roles[Roles.carrier_logistician]])

sotrans_roles[Roles.company_logistician] = Role()
sotrans_roles[Roles.company_manager] = Role(ancestors = [sotrans_roles[Roles.company_logistician]])
sotrans_roles[Roles.company_director] = Role(ancestors = [
    sotrans_roles[Roles.company_manager], sotrans_roles[Roles.carrier_director]
])
