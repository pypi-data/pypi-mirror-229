...
from pipeline.schema.inputs import generatedClassInputs
from pipeline.schema.outputs import generatedClassOutputs
...
def predict(body: generatedClassInputs, request: Request) -> List[generatedClassOutputs]:
    '''
    predict api
    '''
    data = body.dict()
    ...
    # call model here
    try:
        output: generatedClassOutputs = pipeline.execute(**data)
...
def parse(body: generatedClassInputs, request: Request) -> List[generatedClassOutputs]:
    '''
    parse api
    '''
    data = body.dict()
...
async def chat(body: generatedClassInputs, request: Request) -> StreamingResponse:
    '''
    parse api
    '''
    data = body.dict()
