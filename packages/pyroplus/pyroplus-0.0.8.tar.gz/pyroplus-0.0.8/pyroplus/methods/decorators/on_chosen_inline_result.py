...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~pyroplus.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroplus.Client):
                self.add_handler(pyroplus.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroplus.handlers.ChosenInlineResultHandler(func, self),
