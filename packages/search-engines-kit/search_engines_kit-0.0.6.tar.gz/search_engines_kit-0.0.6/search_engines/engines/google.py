...
class Google(SearchEngine):
    '''Searches google.com'''
    def __init__(self, proxy=PROXY, timeout=TIMEOUT, username: str or None = None, password: str or None = None, language="ES"):
        super(Google, self).__init__(proxy, timeout, language)
