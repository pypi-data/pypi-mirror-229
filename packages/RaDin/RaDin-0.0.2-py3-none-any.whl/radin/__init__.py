...
setup(name="RaDin",
      version="0.0.1",
      description="This is a School's Database Modifier, That is written by RaDin",
      long_description="This is a School's Database Modifier, That is written by RaDin. They can insert, check, update, remove, add, or subtract.",
      author="RaDin",
      packages=['package'],
      install_requires=['sqlite3', 'datetime', 'calendar'],
      )