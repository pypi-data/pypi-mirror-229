...
class Renderer:
  ...
  def __init__(self, base_path, template_filename):
    ...
    The template file will be automatically retrieved from the 'self.base_path' directory and should not be an absolute path but just the name of the file itself.
    """
