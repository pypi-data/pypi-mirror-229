...
class Web3Provider(NodeDataProvider):
    ...
    def get_block(self, block_number: int, chain_id: Optional[str] = None) -> W3Block:
        ...
        block = W3Block(
            chain_id=chain_id or self.default_chain,
            difficulty=raw_block.difficulty if hasattr(raw_block, "difficulty") else 0,
            ...
            sha3Uncles=raw_block.sha3Uncles if hasattr(raw_block, "sha3Uncles") else 0,
            size=raw_block.size,
            ...
            uncles=raw_block.uncles if hasattr(raw_block, "uncles") else [],
        )
    ...
    def get_calls(self, tx_hash: str, chain_id: Optional[str] = None) -> W3CallTree:
        ...
        resp = self._create_call_from_debug_trace_tx(
