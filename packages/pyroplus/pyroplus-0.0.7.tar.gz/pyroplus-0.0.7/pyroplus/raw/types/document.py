...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <pyroplus.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <pyroplus.raw.base.VideoSize>`, *optional*):
            N/A
