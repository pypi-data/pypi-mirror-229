...
- Vector de precio de renta fija:
  - Extracción de datos de vector de preción por fecha de procesamiento desde la SBS.
  - Extracción de emisores disponibles del vector de precio.
  - Extracción de datos historicos de precios del asset por isin.
...
La función `get_curva_cupon_cero` permite acceder a los datos de bonos cupón cero de la SBS:
...
### get_precios_by_isin
La función  `get_precios_by_isin` permite acceder a los datos historicos de precios para un determinado código isin.
