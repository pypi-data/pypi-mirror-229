...
class NodeBase:
    ...
    """
    def __init__(self, inputs: Dict[str, VariableBase], outputs: List[VariableBase], 
        opname: str, constants: Dict[str, Any]=None, name: str=None,
        repr_settings: NodeReprSettings=None, opcounter: OpCounter=None):
        
        assert isinstance(inputs, dict)
        assert all(isinstance(v, VariableBase) for v in inputs.values())
        self.inputs = inputs
    ...
    def opcount(self, st_ld_pessimism: float=None) -> OpCount:
        ...
        if self.opcounter is None:
            ...
            return self.opcounter(self.inputs, self.outputs, self.constants, st_ld_pessimism)
