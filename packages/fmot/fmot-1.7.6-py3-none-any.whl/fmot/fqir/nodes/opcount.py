...
class OpCount:
    ...
    def _mul(self, other):
        ...
        if isinstance(other, (int, float)):
            ...
            raise ValueError(f'Opcount cannot be multiplied by type: {type(other)}' +
                f'other: {other}')
    ...
    def total_ops(self):
        return self.macs + self.additions + self.multiplies + self.luts + self.other_logic

    def total_eops(self):
        return self.emacs + self.additions + self.multiplies + self.luts + self.other_logic
