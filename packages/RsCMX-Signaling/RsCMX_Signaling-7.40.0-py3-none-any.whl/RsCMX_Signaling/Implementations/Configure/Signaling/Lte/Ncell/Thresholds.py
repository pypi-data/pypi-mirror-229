...
class ThresholdsCls:
	...
	def set(self, cell_name: str, ncell_name: str, threshold_low: float, threshold_high: float) -> None:
		...
		Snippet: driver.configure.signaling.lte.ncell.thresholds.set(cell_name = '1', ncell_name = '1', threshold_low = 1.0, threshold_high = 1.0) \n
	...
	def get(self, cell_name: str, ncell_name: str) -> GetStruct:
		"""SCPI: [CONFigure]:SIGNaling:LTE:NCELl:THResholds \n
		Snippet: value: GetStruct = driver.configure.signaling.lte.ncell.thresholds.get(cell_name = '1', ncell_name = '1') \n
		No command help available \n
			:param cell_name: No help available
			:param ncell_name: No help available
