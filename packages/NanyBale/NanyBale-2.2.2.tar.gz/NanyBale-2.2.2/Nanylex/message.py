class Message:
    ...
    @property
    def author_replyed_id(self):
        if self.reply_data:
            return self.reply_data["chat"]["id"]
        else:
            return False
        
    @property
    def author_replyed_name(self):
        if self.reply_data:
            return self.reply_data["chat"]["first_name"]
        else:
            return None
        
    @property
    def author_replyed_username(self):
        if "username" in self.reply_data:
            return self.reply_data["chat"]["username"]
        else:
            return None
