...
class ScenarioCls:
	...
	def get_activate(self) -> enums.Scenario:
		...
		Snippet: value: enums.Scenario = driver.configure.lteMeas.scenario.get_activate() \n
	...
	def set_activate(self, scenario: enums.Scenario) -> None:
		"""SCPI: CONFigure:LTE:MEASurement<Instance>:SCENario:ACTivate \n
		Snippet: driver.configure.lteMeas.scenario.set_activate(scenario = enums.Scenario.CSPath) \n
		No command help available \n
