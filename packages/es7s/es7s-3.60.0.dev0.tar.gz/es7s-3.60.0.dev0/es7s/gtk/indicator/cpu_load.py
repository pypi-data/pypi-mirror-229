...
from ._base import CheckMenuItemConfig, RadioMenuItemConfig, _BaseIndicator, _BoolState
...
class IndicatorCpuLoad(_BaseIndicator[CpuInfo]):
    ...
    def _render(self, msg: SocketMessage[CpuInfo]):
        self._update_title(f"{'CPU':8s}\t{msg.data.core_count} cores, {msg.data.thread_count} threads")
