...
class ContextClient(KluClientBase):
    ...
    async def create(
        ...
        Args:
            ...
            filter (Optional[str]): The filter to be used on a Context
            loader (Optional[str]): The loader to be used on a Context.
                Can be one of: [gmail, notion, intercom, github, redis, crawler, database, elastic, zendesk, file, api]
                If missing, the API will use 'api' as the default loader
