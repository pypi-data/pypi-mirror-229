...
class SEDAAgentAbstract(SEDAAnyEntity):
    __regid__ = "SEDAAgentAbstract"
    fetch_attrs, cw_fetch_order = fetch_config(["user_cardinality"])
    value_attr = None
...
class SEDAAltAgentAbstractCorpname(SEDAAnyEntity):
    __regid__ = "SEDAAltAgentAbstractCorpname"
    fetch_attrs, cw_fetch_order = fetch_config([])
    value_attr = None
...
class SEDASeqAltAgentAbstractCorpnameFirstName(SEDAAnyEntity):
    __regid__ = "SEDASeqAltAgentAbstractCorpnameFirstName"
    fetch_attrs, cw_fetch_order = fetch_config([])
    value_attr = None
...
class SEDABirthDate(SEDAAnyEntity):
    ...
    fetch_attrs, cw_fetch_order = fetch_config(
        ["user_cardinality", "birth_date", "user_annotation"]
    )
    value_attr = "birth_date"
...
class SEDADeathDate(SEDAAnyEntity):
    ...
    fetch_attrs, cw_fetch_order = fetch_config(
        ["user_cardinality", "death_date", "user_annotation"]
    )
    value_attr = "death_date"
...
CHOICE_RTYPE = {
    ...
    "SEDAAltAgentAbstractCorpname": [
        ...
        ["seda_seq_alt_agent_abstract_corpname_first_name", "subject"],
    ],
