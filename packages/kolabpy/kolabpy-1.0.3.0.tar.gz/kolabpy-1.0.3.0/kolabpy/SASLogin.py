...
def SASLogin(id, pw, sys='viya',server="Asia Pacific Home Region 1") :
  ...
  if (sys == 'oda' and server == "US Home Region 2") :
  ...
  if (sys == 'oda' and server == "European Home Region 1") :
  ...
  if (sys == 'oda' and server == "Asia Pacific Home Region 1") :
  ...
  if (sys == 'oda' and server == "Asia Pacific Home Region 2") :
