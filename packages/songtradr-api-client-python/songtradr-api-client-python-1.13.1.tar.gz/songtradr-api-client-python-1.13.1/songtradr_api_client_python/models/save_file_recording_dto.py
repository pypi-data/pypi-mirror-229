...
class SaveFileRecordingDTO(BaseModel):
    ...
    def level2_genre_validate_enum(cls, value):
        ...
        if value not in ('Electro Pop', 'Indie Pop', 'Indie Rock', 'Electroclash', 'Adult Contemporary', 'Easy Listening', 'Comedy Music', 'New Age', 'Chanson', 'Singer/Songwriter', 'Schlager', 'Volksmusik', 'Rock'n'Roll', 'Rockabilly', 'Psychobilly', 'Surf', 'Doo Wop', 'Mainstream Rock', 'Mersey Beat', 'Glamrock', 'Latin Rock', 'Melodic Rock', 'Progressive Rock', 'Psychedelic Rock', 'Hard Rock', 'Krautrock', 'Power Metal', 'Nu Metal', 'Grind Core', 'Gothic Metal', 'Death Metal', 'Melodic Death Metal', 'Thrash Metal', 'Folk Metal', 'Heavy Metal', 'Doom Metal', 'Black Metal', 'Glam Metal', 'Sleaze Metal', 'Metalcore', 'Progressive Metal', 'Screamo', 'Symphonic Metal', 'Swing', 'Ragtime', 'Dixieland', 'Boogie Woogie', 'Bebop', 'Cool Jazz', 'Free Jazz', 'Fusion', 'Smooth Jazz', 'Acid Jazz', 'Bossa Nova', 'Latin Jazz', 'Nu-Jazz', 'Tango', 'Samba', 'Salsa', 'Axé', 'Sertanejo', 'Forró', 'Choro', 'Fado', 'Flamenco', 'Blasmusik', 'American Folk', 'Irish Folk', 'Folk Rock', 'Folk Pop', 'Medieval Folk', 'Americana', 'Bluegrass', 'Red Dirt', 'Outlaw Country', 'Country Pop', 'Nashville', 'Honkytonk', 'Production Music', 'Soundtrack', 'Musical', 'Medieval', 'Renaissance', 'Baroque', 'Classical Period', 'Romanticism', 'Neue Musik', 'Minimal Music', 'Neoklassik', 'Contemporary Classical', 'Postmoderne Musik', 'Punk', 'Noise Rock', 'Garage', 'Grunge', 'Industrial', 'New Wave', 'Post Punk', 'Gothic Rock', 'Stoner Rock', 'Pop Punk', 'Post Hardcore', 'Post Rock', 'Post Metal', 'Post-Grunge', 'Britpop', 'Ska Punk', 'Math Rock', 'Dreampop', 'Shoegaze', 'Contemporary R&B', 'Rhythm And Blues', 'Disco', 'Chicago Soul', 'Detroit Soul', 'Urban', 'Nu R&B', 'Old School Soul', 'Neo Soul', 'Early Funk', 'Contemprary Funk', 'Funk Rock', 'Folk Blues', 'Classics Blues', 'Contemporary Blues', 'Blues Rock', 'Trap Music', 'Electro-hop', 'Hardcore Rap', 'Old School Hip Hop', 'British Hip Hop', 'Alternative Hip Hop', 'Pop Rap', 'Miami Bass & Bounce', 'Dirty South Rap', 'Turntablism', 'West Coast Gangsta Rap', 'East Coast Gangsta Rap', 'Roots-Reggae', 'Dub', 'Raggamuffin', 'Ska', 'Dancehall', 'House music', 'Drum and Bass', 'Techno', 'Chiptune', 'Hard Dance', 'Experimental Electronic', 'Chicago House', 'Ambient House', 'Deep House', 'Tech House', 'Acid House', 'Dutch House', 'Progressive House', 'Funky House', 'Nu Disco', 'Minimal Techno', 'Hardcore Techno', 'IDM', 'Trance', 'Psytrance', 'Progressive Trance', 'Grime', 'Big Beat', 'Dub Step', 'Liquid Funk', 'Hard Step', 'Old School Jungle', 'Trip Hop', 'Gospel', 'Dancepop', 'Indietronica', 'Nu Rave', 'Emo-Rock', 'Soft-Rock', 'Post-Punk Revival', 'Nu Prog', 'Indie Folk', 'Audiobook', 'Audioplay', 'Relaxation', 'Acapella', 'Latin Hip Hop', 'Reggaeton'):
