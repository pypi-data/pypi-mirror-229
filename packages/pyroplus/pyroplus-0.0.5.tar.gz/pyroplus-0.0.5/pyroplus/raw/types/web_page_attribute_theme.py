...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <pyroplus.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <pyroplus.raw.base.ThemeSettings>`, *optional*):
            N/A
