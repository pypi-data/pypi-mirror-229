...
##################################################
from ziyulibs.function.zysqlite import (
    createdb,
    insertdb1,
    query,
    querydb,
...
from ziyulibs.function.zyfile import readfileauto, writefile
import unittest
import time
import re

# from ziyulibs.function.zylog import console, consoleErr, LOGTYPE
...
"""
        ...
        print("ziyulibs->updatedescribe异常:" + str(ex))
        raise ex
...
class zycommon(unittest.TestCase):
    # def setUp(self) -> None:
    #     # print('构建')
    #     # console(label=LOGTYPE.调试, value=True, position='C:\0000\47python\ziyulibs\ziyulibs\function\zycommon.py:138')
    #     # console(label=LOGTYPE.链接, value=True, position='C:\0000\47python\ziyulibs\ziyulibs\function\zycommon.py:139')
    #     # console(label=LOGTYPE.配置, value=True, position='C:\0000\47python\ziyulibs\ziyulibs\function\zycommon.py:140')
    #     # console(label=LOGTYPE.请求, value=True, position='C:\0000\47python\ziyulibs\ziyulibs\function\zycommon.py:141')
    #     # console(label=LOGTYPE.语句, value=True, position='C:\0000\47python\ziyulibs\ziyulibs\function\zycommon.py:142')
    #     # console(label=LOGTYPE.异常, value=True, position='C:\0000\47python\ziyulibs\ziyulibs\function\zycommon.py:143')
    #     # console(111111111111111, label=LOGTYPE.调试, value=True,, position='C:\0000\47python\ziyulibs\ziyulibs\function\zycommon.py:144')
    #     # console(json.dump({}), label=LOGTYPE.调试, value=True, position='C:\0000\47python\ziyulibs\ziyulibs\function\zycommon.py:145')
    #     return super().setUp()
