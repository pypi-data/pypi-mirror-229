...
project = u"black_body"
copyright = u"2022, black_body"
...
htmlhelp_basename = "black_bodydoc"
...
# [howto/manual]).
latex_documents = [
    (u"index", u"black_body.tex",
     u"black\_body Documentation",
     u"revesansparole",
     u"manual"),
]
...
man_pages = [
    (u"index", u"black_body",
     u"black_body Documentation",
     [u"revesansparole"], 1)
]
...
texinfo_documents = [
    (u"index", u"black_body",
     ...
     u"revesansparole",
     u"black_body",
     u"Set of formalisms around black bodies",
     u"Miscellaneous"),
]
