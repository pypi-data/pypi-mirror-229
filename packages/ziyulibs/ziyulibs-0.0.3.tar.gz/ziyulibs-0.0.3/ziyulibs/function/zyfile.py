...
import shutil
import qrcode
from ziyulibs.base.zystr import cut_text
from ziyulibs.base.zybyte import tostr, tobyte
...
class zyfile(unittest.TestCase):
    testfile = r'C:\0000\47python\ziyulibs\README.md'
    exportpath = os.getcwd()+'/imgs/code1/'

    def test_getenv(self):
        self.assertEqual(getenv(__file__), ('c:/0000/47python/ziyulibs/ziyulibs/function', 'zyfile', '.py'))
    ...
    def test_getfilepath(self):
        self.assertEqual(getfilepath(self.testfile), 'C:\\0000\\47python\\ziyulibs')
        self.assertEqual(getfilepath('/laydate/need/laydate.css'), '/laydate/need')

    def test_filetostr(self):
        result1 = filetostr(r'C:\0000\47python\ziyulibs\imgs\A.png', exportpath=r'C:\0000\47python\ziyulibs\imgs\A\\')  # ,
        self.assertGreater(len(result1), 0)
        result2 = filetostr(r'C:\0000\47python\ziyulibs\imgs\A.png', iszip=True)
        self.assertGreater(len(result2), 0)

        writeFilebyte(result1, r'C:\0000\47python\ziyulibs\imgs\AA.txt')
        writeFilebyte(result2, r'C:\0000\47python\ziyulibs\imgs\BB.txt')

    def test_strtofile(self):
        result1 = strtofile(readfile(r'C:\0000\47python\ziyulibs\imgs\AA.txt'),
                            exportpath=r'C:\0000\47python\ziyulibs\imgs\AA.png')
        # self.assertEqual(len(result1), 84094)
        result2 = strtofile(readfileauto(r'C:\0000\47python\ziyulibs\imgs\BB.txt'),
                            exportpath=r'C:\0000\47python\ziyulibs\imgs\BB.png', iszip=True)
