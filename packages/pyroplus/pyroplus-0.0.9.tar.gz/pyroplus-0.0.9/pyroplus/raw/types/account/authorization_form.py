...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <pyroplus.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <pyroplus.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <pyroplus.raw.base.SecureValueError>`):
            N/A
