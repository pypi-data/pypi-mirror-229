...
class MLFunctionClassifier:
    def __init__(self):
        ...
        # # Load the model
        # self.dl_model = keras.models.load_model(f"{script_dir}/dl_gpt_model.keras")
    ...
    # def predict_function_dl(self, func_call, docstring):
    ...
    #     predicted_probabilities = self.dl_model.predict([preprocessed_docstring])
    #     predicted_label = (predicted_probabilities > 0.4).astype(int)
    #     labels = [
    #         "[UNK]",
    #         "Data Preparation and Exploration",
    #         "Model Building and Training",
    ...
    #         "Visualization",
    #     ]
    #     indices = np.where(np.array(predicted_label) == 1)[1]
    #     predicted_classes = [labels[i] for i in indices]
