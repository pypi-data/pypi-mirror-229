...
class IdentityVerification:
    ...
    def find_bright_areas(self, image, brightness_threshold=210):
    ...
    def check_image_quality(self, id_card, brightness_threshold=240, blur_threshold=150):
        id_card = self.image_conversion(id_card)
        id_card = np.array(id_card)
        bright_result = self.find_bright_areas(id_card, brightness_threshold=210)
    ...
    def extract_ocr_info(self,selfie,video,country,front_id,back_id):
        self.check_image_quality(selfie)
        self.check_image_quality(front_id)
        self.check_image_quality(back_id)
