...
def add_modules_to_root_structure(structure: dict, module_names: list[str]):
    ...
    for module_name in module_names:
        add_module_to_base_structure(structure[constants.SOURCE_DIR], module_structure, module_name)
        add_module_to_base_structure(structure[constants.TESTS_DIR], test_module_structure, module_name)
    add_init_files_to_structure(structure[constants.SOURCE_DIR])
