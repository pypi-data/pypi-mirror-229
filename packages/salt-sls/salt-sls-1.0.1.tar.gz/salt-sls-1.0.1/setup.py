...
NAME = "salt_sls"
DESC = "Run single a Salt SLS file agentless locally."

# Version info -- read without importing
_locals = {}
with pathlib.Path("salt_sls", "version.py").open() as fp:
...
setup(
    ...
    url="https://gitlab.com/vmware/pop/salt-sls",
    version=VERSION,
    ...
    entry_points={"console_scripts": ["sls = salt_sls.scripts:start"]},
