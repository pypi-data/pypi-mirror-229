...
from kdb import SCREENSHOTS_REPORT_DIR
...
def take_screen_shot(driver, file_name=None, element_locator="xpath=//body", extra_time=None):
    ...
    if not os.path.exists(SCREENSHOTS_REPORT_DIR):
        os.makedirs(SCREENSHOTS_REPORT_DIR)
    path = os.path.join(SCREENSHOTS_REPORT_DIR, image_name)
