...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~pyroplus.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroplus.Client):
                self.add_handler(pyroplus.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroplus.handlers.CallbackQueryHandler(func, self),
