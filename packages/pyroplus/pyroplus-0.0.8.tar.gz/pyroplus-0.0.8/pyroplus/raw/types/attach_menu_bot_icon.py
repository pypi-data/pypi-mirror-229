...
class AttachMenuBotIcon(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~pyroplus.raw.base.AttachMenuBotIcon`.
    ...
    Parameters:
        ...
        icon (:obj:`Document <pyroplus.raw.base.Document>`):
            N/A

        colors (List of :obj:`AttachMenuBotIconColor <pyroplus.raw.base.AttachMenuBotIconColor>`, *optional*):
            N/A
