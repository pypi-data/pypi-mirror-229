...
class File(Entity, CompanyLinker, CustomerLinker, FolderLinker, ProjectLinker,
           StaffLinker, TaskLinker, TaskTemplateLinker, NoteLinker, TagLinker):
    """
    ...
    _links_reverse = [CompanyLinker, CustomerLinker, FolderLinker, ProjectLinker,
                      StaffLinker, TaskLinker, TaskTemplateLinker]
