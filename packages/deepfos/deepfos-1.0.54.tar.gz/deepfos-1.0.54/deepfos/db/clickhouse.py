...
class ClickHouseConvertor(MySQLConvertor):
    ...
    def build_sql(
        ...
        **opts
        ...
        return MySQLConvertor.build_sql(columns, values_in_line, tablename, updatecol, **opts)
...
class DirectAccessClient:
    ...
    async def exec_sqls(
        ...
        return self.connector.execute_many(parsed_sql)
    ...
    async def query_dfs(
        ...
        if isinstance(sqls, str):
            ...
            return self.connector.query_dataframe(sql_list[0])
        else:
