...
from palmera_ethtx.models.semantics_model import (
    FunctionSemantics,
    ParameterSemantics,
    Signature,
    SignatureArg,
)
from palmera_ethtx.providers.semantic_providers import SemanticsRepository
from palmera_ethtx.providers.signature_provider import SignatureProvider, FourByteProvider
