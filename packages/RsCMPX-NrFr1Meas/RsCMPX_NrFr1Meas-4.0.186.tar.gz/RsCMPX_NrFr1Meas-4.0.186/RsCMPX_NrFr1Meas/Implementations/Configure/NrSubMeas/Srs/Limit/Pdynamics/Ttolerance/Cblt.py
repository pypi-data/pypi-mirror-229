...
class CbltCls:
	...
	def set(self, tt_power_less_3_g: float, tt_power_great_3_g: float) -> None:
		"""SCPI: CONFigure:NRSub:MEASurement<Instance>:SRS:LIMit:PDYNamics:TTOLerance:CBLT \n
		Snippet: driver.configure.nrSubMeas.srs.limit.pdynamics.ttolerance.cblt.set(tt_power_less_3_g = 1.0, tt_power_great_3_g = 1.0) \n
		Defines test tolerances for power dynamics limits, for channel BW up to 40 MHz. \n
			:param tt_power_less_3_g: For carrier center frequencies up to 3 GHz.
			:param tt_power_great_3_g: For carrier center frequencies 3 GHz.
		"""
		...
		self._core.io.write(f'CONFigure:NRSub:MEASurement<Instance>:SRS:LIMit:PDYNamics:TTOLerance:CBLT {param}'.rstrip())
	...
	def get(self) -> CbltStruct:
		"""SCPI: CONFigure:NRSub:MEASurement<Instance>:SRS:LIMit:PDYNamics:TTOLerance:CBLT \n
		Snippet: value: CbltStruct = driver.configure.nrSubMeas.srs.limit.pdynamics.ttolerance.cblt.get() \n
		Defines test tolerances for power dynamics limits, for channel BW up to 40 MHz. \n
			:return: structure: for return value, see the help for CbltStruct structure arguments."""
		return self._core.io.query_struct(f'CONFigure:NRSub:MEASurement<Instance>:SRS:LIMit:PDYNamics:TTOLerance:CBLT?', self.__class__.CbltStruct())
