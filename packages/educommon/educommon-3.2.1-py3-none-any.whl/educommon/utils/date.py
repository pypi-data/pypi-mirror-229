...
class DatesSplitter:
    ...
    Разбивку по дням можно настроить: задать параметр split_by_days_count (по умолчанию 1) - кол-во дней, на которое нужно разбить период.
    """
    ...
    def __init__(
        ...
        split_by_days_count: int = 1,
    ):
        """Инициализация."""
        self.split_by = split_by
        self.split_mode = split_mode
        self.split_by_days_count = split_by_days_count
    ...
    def _split_by_day(
        ...
        return self.calculate_dates_range(
            ...
            relativedelta_param=dict(days=self.split_by_days_count),
        )
    ...
    def _split_by_week(
        ...
        return self.calculate_dates_range(
            ...
            relativedelta_param=dict(weeks=1),
        )
    ...
    def _split_by_month(
        ...
        return self.calculate_dates_range(
            ...
            period_ended_at=period_ended_at,
            start_date=start_date_map[self.split_mode],
            relativedelta_param=dict(months=1),
        )
    ...
    def _split_by_year(
        ...
        return self.calculate_dates_range(
            ...
            period_ended_at=period_ended_at,
            start_date=start_date_map[self.split_mode],
            relativedelta_param=dict(years=1),
        )
