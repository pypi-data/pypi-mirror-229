...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~pov.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~pov.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~pov.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~pov.types.CallbackGame`, *optional*):
