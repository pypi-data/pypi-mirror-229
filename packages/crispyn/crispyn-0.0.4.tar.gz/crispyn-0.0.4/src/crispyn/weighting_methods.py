...
def swara_weighting(criteria_indexes, s):
    ...
    -------------
        criteria_indexes : ndarray
            Vector with indexes of criteria in accordance with given decision problem from C1 to Cn ordered
        ...
        s : ndarray
            The s vector starting from the second criterion generated in following way: Make the respondent express the relative importance of the criterion j
            in relation to the previous (j-1) criterion, and do this for each particular criterion
...
def lbwa_weighting(criteria_indexes, criteria_values_I):
    ...
    Parameters
    -------------
        criteria_indexes : list with nested sublists
            List with nested sublists including oryginal indexes of criteria in given decision problem from C1 to Cn

        criteria_values_I : list with nested sublists
            List with nested sublists including influence values of criteria within each subset provided in order beginning from most significant
...
def sapevo_weighting(criteria_matrix):
        """
        Calculate criteria weights using SAPEVO-M subjective weighting method
