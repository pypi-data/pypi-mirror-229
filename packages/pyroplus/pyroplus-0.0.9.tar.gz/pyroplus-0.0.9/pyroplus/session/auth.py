...
from pyroplus.connection import Connection
from pyroplus.crypto import aes, rsa, prime
from pyroplus.errors import SecurityCheckMismatch
from pyroplus.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "pyroplus.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
