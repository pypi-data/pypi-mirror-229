...
class TestBuilderFiQuS(unittest.TestCase):
    ...
    def test_BuilderFiQuS_attributes(self):
        # arrange
        magnet_names = ['CCT_COSIM_1', 'HTS1', 'MQXA', 'MCBRD']
        ...
        for magnet_name in magnet_names:
            ...
            self.assertTrue(bF.data_FiQuS.magnet.type in ['multipole', 'CCT_straight', 'CWS', 'Pancake3D'])      # check if magnet type has been set_up to one of the currently supported types
