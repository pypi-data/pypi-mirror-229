...
def tool_set_by_id(
    ...
    ''' Set the tool by name (for keymaps) :File: `startup/bl_operators/wm.py\:2299 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py#L2299>`__
...
def tool_set_by_index(
        ...
        *,
        ...
        as_fallback: typing.Optional[typing.Union[bool, typing.Any]] = False,
        space_type: typing.Optional[typing.Any] = 'EMPTY'):
    ''' Set the tool by index (for keymaps) :File: `startup/bl_operators/wm.py\:2351 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/wm.py#L2351>`__
