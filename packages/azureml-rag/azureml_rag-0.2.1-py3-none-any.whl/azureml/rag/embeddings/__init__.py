...
class EmbeddingsContainer:
    ...
    def _get_embeddings_internal(self, input_documents: Union[Iterator[Document], BaseLoader, DocumentChunksIterator]) -> OrderedDict:
        ...
        if (
            hasattr(input_documents, "__module__") and
            "langchain" in input_documents.__module__ and
            "document_loaders" in input_documents.__module__
        ):
        ...
        for document in input_documents:
            if (
                hasattr(document, "__module__") and
                "langchain" in document.__module__ and
                ".Document" in str(document.__class__)
            ):
