...
class AudienceSegmentsHandler:
    ...
    def __init__(self, application_name, env_tag, gcp_key, version="v202308") -> None:
        self.version = version
        self.network = Network(application_name=application_name, env_tag=env_tag, gcp_key=gcp_key)
