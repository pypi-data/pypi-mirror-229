...
class RooRealVar:
    ...
    @semistaticmethod
    def get_binning(self, obj:"ROOT.RooRealVar"):
        ...
        result = {
            'bin_low_edge': bin_low_edge,
            'bin_center': bin_edge_to_bin_center(bin_low_edge),
            'bin_width': bin_edge_to_bin_width(bin_low_edge)
        }
        return result