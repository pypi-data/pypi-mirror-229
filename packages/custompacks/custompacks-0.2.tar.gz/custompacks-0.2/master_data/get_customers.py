import pandas as pd
from custompacks import ExcelParser, TxtParser
import numpy as np
...
if __name__ == '__main__':
    parse_data = GetCustomers(filepath=r'V:\Findep\Incoming\test\DevOps\References\KNA 14072023.txt',
                              value='KUNNR')

    print(parse_data.further_process())
