...
from heaserver.service.testcase.dockermongo import DockerMongoManager, S3WithDockerMongoManager
...
HEASERVER_BUCKETS_IMAGE = 'registry.gitlab.com/huntsman-cancer-institute/risr/hea/heaserver-buckets:1.0.0a17'
