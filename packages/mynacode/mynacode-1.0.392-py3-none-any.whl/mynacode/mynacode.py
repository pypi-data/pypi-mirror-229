...
def torch_data(train_dataloader=None, val_dataloader=None, test_dataloader=None, dataset_name="", label_index=1,
  ...
  if len(str(dataset_name)) == 0:
      dataset_name = "RunID_"+str(run_id_global)+"_dataset"
  else:
      dataset_name = "RunID_"+str(run_id_global)+"_"+dataset_name
  ...
  if save_new_data_flag == 1:
      ...
      temp = "RunID_"+str(run_id_global)+"_"+dataset_name+"_" + ''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase + string.digits) for _ in range(6))
      while os.path.exists(current_dir+'/data/'+temp):
          temp = "RunID_"+str(run_id_global)+"_"+dataset_name+"_" + ''.join(random.choice(string.ascii_uppercase + string.ascii_lowercase + string.digits) for _ in range(6))
