...
class PlaywrightUtils:
    ...
    def close_popup_banner(self):
        ...
        :return: None
        """
        dialog_button = self.page.locator('button[id^="pendo-button"]')
        if dialog_button.is_visible():
            dialog_button.click()
        else:
            dialog_button = self.page.locator('button[id^="pendo-close"]')
            if dialog_button.is_visible():
                dialog_button.click()
    ...
    def close_pendo_banners(self):
        ...
        dialog_buttons = self.page.locator('button[id^="pendo-close-guide"]')
        Logger.info(type(dialog_buttons))
