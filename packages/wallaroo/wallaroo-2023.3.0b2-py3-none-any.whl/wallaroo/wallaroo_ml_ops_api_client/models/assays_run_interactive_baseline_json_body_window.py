...
T = TypeVar("T", bound="AssaysRunInteractiveBaselineJsonBodyWindow")


@attr.s(auto_attribs=True)
class AssaysRunInteractiveBaselineJsonBodyWindow:
    """  Assay window.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        assays_run_interactive_baseline_json_body_window = cls(
            pipeline=pipeline,
            model=model,
            width=width,
            start=start,
        ...
        assays_run_interactive_baseline_json_body_window.additional_properties = d
        return assays_run_interactive_baseline_json_body_window
