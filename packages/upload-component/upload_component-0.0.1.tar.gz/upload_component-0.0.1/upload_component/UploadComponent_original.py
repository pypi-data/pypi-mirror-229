...
class UploadComponent_original(Component):
    """An UploadComponent_original component.
...
- value (string; optional):
    ...
    _type = 'UploadComponent_original'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, label=Component.REQUIRED, value=Component.UNDEFINED, **kwargs):
        ...
        super(UploadComponent_original, self).__init__(**args)
