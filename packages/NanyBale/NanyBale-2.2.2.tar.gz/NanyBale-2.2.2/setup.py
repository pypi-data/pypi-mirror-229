...
requires = ["pycryptodome==3.16.0","aiohttp==3.8.3","asyncio==3.4.3", "requests==2.31.0", "NanyRubika", "NanyEitaa", "Nanylibrary", "Nanybot", "NanyBale"]
_long_description = """
...
<p align="center">
    <img src="https://s2.uupload.ir/files/img_20230208_141501_035_f545.jpg" alt="Author: Nanymous" width="128">
    <br>
...
### How to import the Bale's library

``` bash
from Nanylex import Bale
```

### How to import the Async class
``` bash
from Nanylex.Async import Bot
```

### How to install the library

``` bash
pip3 install NanyBale==2.2.2
```
...
for Message in bot.getChatUpdate():

    bot.sendMessage(Message.chat_id, "NanyBale Library")
```
