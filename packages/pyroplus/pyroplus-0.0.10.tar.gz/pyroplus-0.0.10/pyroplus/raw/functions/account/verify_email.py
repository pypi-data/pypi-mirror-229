...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <pyroplus.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <pyroplus.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <pyroplus.raw.base.account.EmailVerified>`
    """
