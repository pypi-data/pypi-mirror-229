...
class FixturePLAYBYPLAYApi(object):
    ...
    def fixture_pbp_event_add(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the fixture_pbp_event_add_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        try:
    ...
    def fixture_pbp_event_delete(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the fixture_pbp_event_delete_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        try:
    ...
    def fixture_pbp_event_update(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the fixture_pbp_event_update_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        try:
    ...
    def fixture_pbp_insert_update(
        ...
        **kwargs
        ...
        >>> thread = api.fixture_pbp_insert_update(fixture_id, organization_id, sport, fixture_pbp_post_body, external, fields, hide_null, include, async_req=True)
        >>> result = thread.get()
