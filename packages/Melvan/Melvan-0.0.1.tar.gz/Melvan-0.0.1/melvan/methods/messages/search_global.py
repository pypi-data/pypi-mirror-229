...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~melvan.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~melvan.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~melvan.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "melvan". Get the first 50 results
                async for message in app.search_global("melvan", limit=50):
                    print(message.text)
