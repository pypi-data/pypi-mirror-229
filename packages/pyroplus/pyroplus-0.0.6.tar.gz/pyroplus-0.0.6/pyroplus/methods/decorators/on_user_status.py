...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~pyroplus.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, pyroplus.Client):
                self.add_handler(pyroplus.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        pyroplus.handlers.UserStatusHandler(func, self),
