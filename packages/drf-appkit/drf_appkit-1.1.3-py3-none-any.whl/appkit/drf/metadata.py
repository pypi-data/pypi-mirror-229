...
class DRFMetadata(AutoMetadata):
    def determine_metadata(self, request, view):
        ...
        # ------------------------------------------------------------------------------------------
        # TODO: Revise this logic to not depend on an instance of FieldDictClass, since
        # the field_dict constructor now fails with a 'cached_property' error of some sort. :/
