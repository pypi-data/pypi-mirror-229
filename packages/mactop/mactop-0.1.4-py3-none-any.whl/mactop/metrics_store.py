...
class PowerMetrics:
    ...
    battery: PowerMetricsBattery = PowerMetricsBattery()
    smc: Smc = Smc()

    tasks: List[dict] | None = None
    processor_intel: ProcessorIntel = ProcessorIntel()
...
class AppleSmartBattery:
    ...
    adapter_details: AdapterDetails = AdapterDetails()
...
@dataclass
class IORegMetrics:
    apple_smart_battery: AppleSmartBattery = AppleSmartBattery()
...
class PsutilMetrics:
    ...
    cpu_percent: CPUTimesPercent = CPUTimesPercent()
