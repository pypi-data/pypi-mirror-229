...
class DevOps:
    ...
    def list_repository_items(self, project_name, repo_id, path=None, branch=None):
        repo_items_url = f"{self.base_url}/{project_name}/_apis/git/repositories/{repo_id}/itemsbatch?api-version=7.0"
    ...
    def create_repo_files(self, project_name, repo_id, environment_name, payload):
        commits_url = f"{self.base_url}/{project_name}/_apis/git/repositories/{repo_id}/" \
                      f"commits?api-version=7.0"
        ...
        repo_pushes_url = f"{self.base_url}/{project_name}/_apis/git/repositories/{repo_id}/pushes?api-version=7.0"
