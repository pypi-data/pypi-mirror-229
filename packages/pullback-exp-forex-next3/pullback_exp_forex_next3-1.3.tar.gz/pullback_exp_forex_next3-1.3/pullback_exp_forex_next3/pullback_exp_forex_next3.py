                         ...
                         if point_high == cal_point and type == "Two_TOP" and chek == "false":
                                 ...
                                 if status_trade == True:
                                     ...
                                     if execution == 'Request executed':
                                            ...
                                            print("ticket:" , ticket)
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(High:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' + " _ " + "(execution:" + f'{execution})' 
                                 ...
                                 if status_trade == True:
                                     ...
                                     if execution == 'Request executed':
                                            ...
                                            print("rec_pos:" , rec_pos)
                                            print("ticket:" , ticket)
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(telo_add_high:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' + " _ " + "(execution:" + f'{execution})' 
                                 ...
                                 if status_trade == True:
                                     ...
                                     if execution == 'Request executed':
                                            ...
                                            print("rec_pos:" , rec_pos)
                                            print("ticket:" , ticket)
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(telo_sub_high:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' + " _ " + "(execution:" + f'{execution})' 
                                 ...
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(Sub:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' + " _ " + "(execution:" + f'{execution})' 
                                 ...
                                 if status_trade == True:
                                     ...
                                     if execution == 'Request executed':
                                            ...
                                            print("rec_pos:" , rec_pos)
                                            print("ticket:" , ticket)
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(telo_sub_low:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' + " _ " + "(execution:" + f'{execution})' 
                                 ...
                                 if status_trade == True:
                                     ...
                                     if execution == 'Request executed':
                                            ...
                                            print("rec_pos:" , rec_pos)
                                            print("ticket:" , ticket)
                                 command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{1})'+ " _ " + "(Point5:" + f'{point_high})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(telo_add_low:" + f'{tel})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' + " _ " + "(execution:" + f'{execution})' 
                                                 ...
                                                 if close_plan2 == cal_point and (candel_state_plan2 == "green" or  candel_state_plan2 == "doji") and close_plan2 > left_candel_plan2 and close_plan2 > right_candel_plan2 and type == "Two_TOP":
                                                            ...
                                                            if status_trade == True:
                                                                 ...
                                                                 if execution == 'Request executed':
                                                                        ...
                                                                        print("rec_pos:" , rec_pos)
                                                                        print("ticket:" , ticket)
                                                            command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{2})'+ " _ " + "(Point5:" + f'{close_plan2})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'+ " _ " + "(execution:" + f'{execution})' 
                                                            ...
                                                            if status_trade == True:
                                                                 ...
                                                                 if execution == 'Request executed':
                                                                        ...
                                                                        print("rec_pos:" , rec_pos)
                                                                        print("ticket:" , ticket)
                                                            command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{2})'+ " _ " + "(Point5:" + f'{telo_add_close_high})' + " _ " + "(Time:" + f'{time_command})'+ " _ " + "(telo_high:" + f'{tel})' + "_" + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' + " _ " + "(execution:" + f'{execution})' 
                                                            ...
                                                            command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{2})'+ " _ " + "(Point5:" + f'{telo_sub_close_low})' + " _ " + "(Time:" + f'{time_command})'+ " _ " + "(telo_low:" + f'{tel})' + "_" + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' + " _ " + "(execution:" + f'{execution})' 
                                                            ...
                                                            if status_trade == True:
                                                                 ...
                                                                 if execution == 'Request executed':
                                                                        ...
                                                                        print("rec_pos:" , rec_pos)
                                                                        print("ticket:" , ticket)
                                                            command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{2})'+ " _ " + "(Point5:" + f'{telo_add_close_high})' + " _ " + "(Time:" + f'{time_command})'+ " _ " + "(Telo_high-1-2:" + f'{tel})' + "_" + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' + " _ " + "(execution:" + f'{execution})' 
                                                            Database.update_table_chek(telo_sub_close_low , timestamp_pulback , command , "true" , ticket , candel_num)     
                                                            ...
                                                            if status_trade == True:
                                                                 ...
                                                                 if execution == 'Request executed':
                                                                        ...
                                                                        print("rec_pos:" , rec_pos)
                                                                        print("ticket:" , ticket)
                                                            command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{2})'+ " _ " + "(Point5:" + f'{telo_add_close_high})' + " _ " + "(Time:" + f'{time_command})'+ " _ " + "(Telo_high-2-1:" + f'{tel})' + "_" + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' + " _ " + "(execution:" + f'{execution})' 
                                                            Database.update_table_chek(telo_add_close_high , timestamp_pulback , command , "true" , ticket , candel_num)     
                                      ...
                                      if point_close_3 == cal_point and point_close_3 > left_candel and point_close_3 > right_candel and type == "Two_TOP" and chek == "false":
                                           ...
                                           if status_trade == True:
                                                ...
                                                if execution == 'Request executed':
                                                   ...
                                                   print("rec_pos:" , rec_pos)
                                                   print("ticket:" , ticket)
                                           command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{3})'+ " _ " + "(Point5:" + f'{point_close_3})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})' + " _ " + "(execution:" + f'{execution})'  
                                    ...
                                    if point_open == cal_point:
                                           ...
                                           if status_trade == True:
                                                ...
                                                if execution == 'Request executed':
                                                   ...
                                                   print("rec_pos:" , rec_pos)
                                                   print("ticket:" , ticket)
                                           command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{4})'+ " _ " + "(Point5:" + f'{point_open})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(candel_state: red)" + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'+ " _ " + "(execution:" + f'{execution})' 
                                    ...
                                    if point_open == cal_point:
                                           ...
                                           if status_trade == True:
                                                ...
                                                if execution == 'Request executed':
                                                   ...
                                                   print("rec_pos:" , rec_pos)
                                                   print("ticket:" , ticket)
                                           command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{4})'+ " _ " + "(Point5:" + f'{point_open})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(candel_state: green)" + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'+ " _ " + "(execution:" + f'{execution})'
                                           Database.update_table_chek(point_open , timestamp_pulback , command , "true" , ticket , candel_num)     
                                    ...
                                    if point_open == cal_point:
                                           ...
                                           if status_trade == True:
                                                ...
                                                if execution == 'Request executed':
                                                   ...
                                                   print("rec_pos:" , rec_pos)
                                                   print("ticket:" , ticket)
                                           command = "(Patern:" + f'{candel_num})' + " _ " + "(Type:" + f'{type})' + " _ " + "(Line:" + f'{line + 1})' + ' _ ' + "(Shakhes:" + f'{shakhes})' + " _ " + "(Pulback:" f'{4})'+ " _ " + "(Point5:" + f'{point_open})' + " _ " + "(Time:" + f'{time_command})' + " _ " + "(candel_state: doji)"  + " _ " + "(Status_trade:" + f'{status_trade})' + " _ " + "(ticket:" + f'{ticket})'+ " _ " + "(execution:" + f'{execution})'
                                           Database.update_table_chek(point_open , timestamp_pulback , command , "true" , ticket , candel_num)        
