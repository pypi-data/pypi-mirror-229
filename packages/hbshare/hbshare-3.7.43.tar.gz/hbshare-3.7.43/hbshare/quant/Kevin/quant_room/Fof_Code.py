...
def get_daily_nav_from_mysql(start_date, end_date, token):
    ...
    h1_dict = {
        "市场中性": ['卓识利民二号私募证券投资基金A', '上海宽德踏远10号私募证券投资基金', '稳博对冲18号私募证券投资基金A',
    ...
    n1_dict = {
        "市场中性": ['卓识利民二号私募证券投资基金A', '衍复中性三号私募证券投资基金', '蒙玺竞起17号私募证券投资基金A类',
        ...
        "股票多头": ['衍复1000指增一号私募证券投资基金', '乾象股票进取6号私募证券投资基金',
                   ...
                   '勤辰森裕2号私募证券投资基金C类', '睿璞投资-睿信私募证券投资基金B']
    }
    excel_writer = pd.ExcelWriter(
...
if __name__ == '__main__':
    ...
    get_daily_nav_from_mysql(
        "20221230", "20230901", "c5fc1c8f2e2d46b6b4bac89cf3ec488e")